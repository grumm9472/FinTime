...
public static class Modelriser extends ModelBase {
	...
	public custom_model() {
		...
		body2.setRotationPoint(-8.0F, 3.0F, 0.0F);
		setRotationAngle(body2, 0.0F, 0.0F, -0.7854F);
		body2.cubeList.add(new ModelBox(body2, 16, 16, -4.0F, 0.0F, -2.0F, 8, 12, 4, 0.0F, true));

		body3 = new ModelRenderer(this);
		body3.setRotationPoint(8.0F, 6.0F, 0.0F);
		setRotationAngle(body3, 0.0F, 0.0F, 0.6981F);
		body3.cubeList.add(new ModelBox(body3, 16, 16, -5.9284F, -2.2981F, -2.0F, 8, 12, 4, 0.0F, true));
	}
