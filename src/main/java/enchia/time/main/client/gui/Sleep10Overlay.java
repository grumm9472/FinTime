...
import enchia.time.main.procedures.SleepBar10Procedure;
...
public class Sleep10Overlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Pre event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
			...
			if (SleepBar10Procedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("time:textures/bedicon_3.png"));
