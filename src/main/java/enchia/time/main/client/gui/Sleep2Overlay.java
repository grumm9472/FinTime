...
import enchia.time.main.procedures.SleepBar2Procedure;
...
public class Sleep2Overlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Pre event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
			...
			if (SleepBar2Procedure.execute(entity)) {
				RenderSystem.setShaderTexture(0, new ResourceLocation("time:textures/bedicon_1.png"));
