...
public class AirEntity extends Monster {
	...
	public AirEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		this(TimeModEntities.AIR, world);
	}

	public AirEntity(EntityType<AirEntity> type, Level world) {
		super(type, world);
		xpReward = 200;
		setNoAi(false);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(TimeModItems.AIR_STONE));
	}
