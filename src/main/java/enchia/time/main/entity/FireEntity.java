...
import enchia.time.main.procedures.FirePlayerCollidesWithThisEntityProcedure;
...
public class FireEntity extends Monster {
	...
	public FireEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		this(TimeModEntities.FIRE, world);
	}

	public FireEntity(EntityType<FireEntity> type, Level world) {
		super(type, world);
		xpReward = 200;
		setNoAi(false);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(TimeModItems.FIRE_STONE));
	}
	...
	public void playerTouch(Player sourceentity) {
		...
		FirePlayerCollidesWithThisEntityProcedure.execute(entity);
	}
