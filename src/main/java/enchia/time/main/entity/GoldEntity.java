...
public class GoldEntity extends Monster {
	...
	public GoldEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		this(TimeModEntities.GOLD, world);
	}

	public GoldEntity(EntityType<GoldEntity> type, Level world) {
		super(type, world);
		xpReward = 200;
		setNoAi(false);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(TimeModItems.GOLD_STONE));
	}
