...
public class HumanEntity extends Monster {
	public HumanEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		this(TimeModEntities.HUMAN, world);
	}
	...
	public HumanEntity(EntityType<HumanEntity> type, Level world) {
		...
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(TimeModItems.WHITEDIAMOND_SWORD));
	}
