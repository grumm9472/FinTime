...
public class MummyKingEntity extends Monster {
	...
	public MummyKingEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		this(TimeModEntities.MUMMY_KING, world);
	}

	public MummyKingEntity(EntityType<MummyKingEntity> type, Level world) {
		super(type, world);
		xpReward = 500;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(TimeModItems.MUMMY_HEART));
	}
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.ATTACK_KNOCKBACK, 6.3999999999999995);
		return builder;
	}
}
