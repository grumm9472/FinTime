...
import enchia.time.main.procedures.AncientpowertwinsOnPotionActiveTickProcedure;

import com.mojang.blaze3d.vertex.PoseStack;

public class AncientpowertwinsMobEffect extends MobEffect {
	public AncientpowertwinsMobEffect() {
	...
	public String getDescriptionId() {
		return "effect.time.ancientpowertwins_potion_item";
	}
	...
	public void applyEffectTick(LivingEntity entity, int amplifier) {
		...
		AncientpowertwinsOnPotionActiveTickProcedure.execute(entity);
	}
