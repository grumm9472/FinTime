...
import enchia.time.main.procedures.TimeChaosOnPotionActiveTickProcedure;

import com.mojang.blaze3d.vertex.PoseStack;

public class TimeChaosMobEffect extends MobEffect {
	public TimeChaosMobEffect() {
	...
	public String getDescriptionId() {
		return "effect.time.time_chaos_potion_item";
	}
	...
	public void applyEffectTick(LivingEntity entity, int amplifier) {
		...
		TimeChaosOnPotionActiveTickProcedure.execute(world, x, y, z);
	}
