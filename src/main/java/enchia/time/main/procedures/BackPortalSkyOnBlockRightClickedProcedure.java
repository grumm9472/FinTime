...
public class BackPortalSkyOnBlockRightClickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		world.setBlock(new BlockPos((int) x, (int) (y + 1), (int) z), Blocks.CAVE_AIR.defaultBlockState(), 3);
		world.setBlock(new BlockPos((int) x, (int) (y + 0), (int) z), Blocks.CAVE_AIR.defaultBlockState(), 3);
		world.setBlock(new BlockPos((int) x, (int) (y - 1), (int) z), Blocks.CAVE_AIR.defaultBlockState(), 3);
	}
}
