...
import enchia.time.main.world.features.treedecorators.BetaplainsTrunkDecorator;
import enchia.time.main.world.features.treedecorators.BetaplainsLeaveDecorator;
import enchia.time.main.world.features.treedecorators.BetaplainsFruitDecorator;
...
public class BetaplainsBiome {
	private static final ConfiguredSurfaceBuilder<?> SURFACE_BUILDER = SurfaceBuilder.DEFAULT
			.configured(new SurfaceBuilderBaseConfiguration(TimeModBlocks.CLASSIC_GRASS.defaultBlockState(),
					TimeModBlocks.CLASSIC_DIRT.defaultBlockState(), TimeModBlocks.CLASSIC_DIRT.defaultBlockState()));
	...
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, register("trees", Feature.TREE
				.configured((new TreeConfiguration.TreeConfigurationBuilder(new SimpleStateProvider(TimeModBlocks.CLASSIC_LOG.defaultBlockState()),
						new StraightTrunkPlacer(7, 2, 0), new SimpleStateProvider(TimeModBlocks.BETALEAVES.defaultBlockState()),
						new SimpleStateProvider(Blocks.OAK_SAPLING.defaultBlockState()),
						new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 3), new TwoLayersFeatureSize(1, 0, 1)))
								.decorators(ImmutableList.of(BetaplainsLeaveDecorator.INSTANCE, BetaplainsTrunkDecorator.INSTANCE,
										BetaplainsFruitDecorator.INSTANCE))
								.build())
	...
	public static void init() {
		Registry.register(BuiltinRegistries.CONFIGURED_SURFACE_BUILDER, new ResourceLocation(TimeMod.MODID, "betaplains"), SURFACE_BUILDER);
	...
	private static ConfiguredFeature<?, ?> register(String name, ConfiguredFeature<?, ?> configuredFeature) {
		CONFIGURED_FEATURES.put(new ResourceLocation(TimeMod.MODID, name + "_betaplains"), configuredFeature);
