...
import enchia.time.main.world.features.treedecorators.HavenForestTrunkDecorator;
import enchia.time.main.world.features.treedecorators.HavenForestLeaveDecorator;
import enchia.time.main.world.features.treedecorators.HavenForestFruitDecorator;
import enchia.time.main.init.TimeModBlocks;
import enchia.time.main.TimeMod;

import com.google.common.collect.ImmutableList;

public class HavenForestBiome {
	private static final ConfiguredSurfaceBuilder<?> SURFACE_BUILDER = SurfaceBuilder.DEFAULT
			.configured(new SurfaceBuilderBaseConfiguration(TimeModBlocks.SWEET_GRASS.defaultBlockState(),
					TimeModBlocks.STRAWBERRY_BLOCK.defaultBlockState(), TimeModBlocks.STRAWBERRY_BLOCK.defaultBlockState()));
	...
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, register("trees", Feature.TREE
				.configured(
						(new TreeConfiguration.TreeConfigurationBuilder(new SimpleStateProvider(TimeModBlocks.STRAWBERRY_LOG_LOG.defaultBlockState()),
								new StraightTrunkPlacer(2, 2, 0), new SimpleStateProvider(TimeModBlocks.STRAWBERRY_LOG_LEAVES.defaultBlockState()),
								new SimpleStateProvider(Blocks.OAK_SAPLING.defaultBlockState()),
								new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 3), new TwoLayersFeatureSize(1, 0, 1)))
										.decorators(ImmutableList.of(HavenForestLeaveDecorator.INSTANCE, HavenForestTrunkDecorator.INSTANCE,
												HavenForestFruitDecorator.INSTANCE))
										.build())
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				register("flower", Feature.FLOWER.configured(Features.Configs.DEFAULT_FLOWER_CONFIG).decorated(Features.Decorators.ADD_32)
						.decorated(Features.Decorators.HEIGHTMAP_SQUARE).count(30)));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
	...
	public static void init() {
		Registry.register(BuiltinRegistries.CONFIGURED_SURFACE_BUILDER, new ResourceLocation(TimeMod.MODID, "haven_forest"), SURFACE_BUILDER);
	...
	private static ConfiguredFeature<?, ?> register(String name, ConfiguredFeature<?, ?> configuredFeature) {
		CONFIGURED_FEATURES.put(new ResourceLocation(TimeMod.MODID, name + "_haven_forest"), configuredFeature);
