...
import enchia.time.main.world.features.treedecorators.MCY0FORESTTrunkDecorator;
import enchia.time.main.world.features.treedecorators.MCY0FORESTLeaveDecorator;
import enchia.time.main.world.features.treedecorators.MCY0FORESTFruitDecorator;
import enchia.time.main.init.TimeModBlocks;
import enchia.time.main.TimeMod;

import com.google.common.collect.ImmutableList;

public class MCY0FORESTBiome {
	private static final ConfiguredSurfaceBuilder<?> SURFACE_BUILDER = SurfaceBuilder.DEFAULT
			.configured(new SurfaceBuilderBaseConfiguration(TimeModBlocks.FIRE_COBBLE_STONE.defaultBlockState(),
					TimeModBlocks.FIRE_COBBLE_STONE.defaultBlockState(), TimeModBlocks.FIRE_COBBLE_STONE.defaultBlockState()));
	...
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, register("trees", Feature.TREE
				.configured((new TreeConfiguration.TreeConfigurationBuilder(new SimpleStateProvider(TimeModBlocks.HELL_LOG.defaultBlockState()),
						new MegaJungleTrunkPlacer(18, 2, 19), new SimpleStateProvider(Blocks.AIR.defaultBlockState()),
						new SimpleStateProvider(Blocks.OAK_SAPLING.defaultBlockState()),
						new MegaJungleFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 2), new TwoLayersFeatureSize(1, 1, 2)))
								.decorators(ImmutableList.of(MCY0FORESTLeaveDecorator.INSTANCE, MCY0FORESTTrunkDecorator.INSTANCE,
										MCY0FORESTFruitDecorator.INSTANCE))
								.build())
	...
	public static void init() {
		Registry.register(BuiltinRegistries.CONFIGURED_SURFACE_BUILDER, new ResourceLocation(TimeMod.MODID, "mcy_0_forest"), SURFACE_BUILDER);
	...
	private static ConfiguredFeature<?, ?> register(String name, ConfiguredFeature<?, ?> configuredFeature) {
		CONFIGURED_FEATURES.put(new ResourceLocation(TimeMod.MODID, name + "_mcy_0_forest"), configuredFeature);
