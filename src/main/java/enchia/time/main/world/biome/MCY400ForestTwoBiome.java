...
import enchia.time.main.world.features.treedecorators.MCY400ForestTwoTrunkDecorator;
import enchia.time.main.world.features.treedecorators.MCY400ForestTwoLeaveDecorator;
import enchia.time.main.world.features.treedecorators.MCY400ForestTwoFruitDecorator;
import enchia.time.main.init.TimeModBlocks;
import enchia.time.main.TimeMod;

import com.google.common.collect.ImmutableList;

public class MCY400ForestTwoBiome {
	...
	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(-5916161).waterColor(-14329397).waterFogColor(-14329397)
				.skyColor(-5916161).foliageColorOverride(-10512895).grassColorOverride(-10512895)
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, register("trees", Feature.TREE
				.configured((new TreeConfiguration.TreeConfigurationBuilder(new SimpleStateProvider(TimeModBlocks.MCY_400LOG.defaultBlockState()),
						new StraightTrunkPlacer(8, 2, 0), new SimpleStateProvider(TimeModBlocks.MCY_400_LEAVES.defaultBlockState()),
						new SimpleStateProvider(Blocks.OAK_SAPLING.defaultBlockState()),
						new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 3), new TwoLayersFeatureSize(1, 0, 1)))
								.decorators(ImmutableList.of(MCY400ForestTwoLeaveDecorator.INSTANCE, MCY400ForestTwoTrunkDecorator.INSTANCE,
										MCY400ForestTwoFruitDecorator.INSTANCE))
								.build())
	...
	public static void init() {
		Registry.register(BuiltinRegistries.CONFIGURED_SURFACE_BUILDER, new ResourceLocation(TimeMod.MODID, "mcy_400_forest_two"), SURFACE_BUILDER);
	...
	private static ConfiguredFeature<?, ?> register(String name, ConfiguredFeature<?, ?> configuredFeature) {
		CONFIGURED_FEATURES.put(new ResourceLocation(TimeMod.MODID, name + "_mcy_400_forest_two"), configuredFeature);
