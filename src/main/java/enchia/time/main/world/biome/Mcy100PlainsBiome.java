...
import enchia.time.main.world.features.treedecorators.Mcy100PlainsTrunkDecorator;
import enchia.time.main.world.features.treedecorators.Mcy100PlainsLeaveDecorator;
import enchia.time.main.world.features.treedecorators.Mcy100PlainsFruitDecorator;
import enchia.time.main.init.TimeModBlocks;
import enchia.time.main.TimeMod;

import com.google.common.collect.ImmutableList;

public class Mcy100PlainsBiome {
	...
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, register("trees", Feature.TREE
				.configured((new TreeConfiguration.TreeConfigurationBuilder(new SimpleStateProvider(TimeModBlocks.MCY_100_LOG.defaultBlockState()),
						new ForkingTrunkPlacer(6, 2, 2), new SimpleStateProvider(TimeModBlocks.MINECRAFTYEARS_100LEAVES.defaultBlockState()),
						...
						new AcaciaFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0)), new TwoLayersFeatureSize(1, 0, 2)))
								.decorators(ImmutableList.of(Mcy100PlainsLeaveDecorator.INSTANCE, Mcy100PlainsTrunkDecorator.INSTANCE,
										Mcy100PlainsFruitDecorator.INSTANCE))
								.build())
	...
	public static void init() {
		Registry.register(BuiltinRegistries.CONFIGURED_SURFACE_BUILDER, new ResourceLocation(TimeMod.MODID, "mcy_100_plains"), SURFACE_BUILDER);
	...
	private static ConfiguredFeature<?, ?> register(String name, ConfiguredFeature<?, ?> configuredFeature) {
		CONFIGURED_FEATURES.put(new ResourceLocation(TimeMod.MODID, name + "_mcy_100_plains"), configuredFeature);
