...
import enchia.time.main.world.features.treedecorators.MoonSharpForestTrunkDecorator;
import enchia.time.main.world.features.treedecorators.MoonSharpForestLeaveDecorator;
import enchia.time.main.world.features.treedecorators.MoonSharpForestFruitDecorator;
import enchia.time.main.init.TimeModBlocks;
import enchia.time.main.TimeMod;

import com.google.common.collect.ImmutableList;

public class MoonSharpForestBiome {
	...
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, register("trees", Feature.TREE
				.configured((new TreeConfiguration.TreeConfigurationBuilder(new SimpleStateProvider(TimeModBlocks.MOON_WARP_LOG.defaultBlockState()),
						new MegaJungleTrunkPlacer(8, 2, 19), new SimpleStateProvider(TimeModBlocks.MOON_WARP_LEAVES.defaultBlockState()),
						new SimpleStateProvider(Blocks.OAK_SAPLING.defaultBlockState()),
						new MegaJungleFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 2), new TwoLayersFeatureSize(1, 1, 2)))
								.decorators(ImmutableList.of(MoonSharpForestLeaveDecorator.INSTANCE, MoonSharpForestTrunkDecorator.INSTANCE,
										MoonSharpForestFruitDecorator.INSTANCE))
								.build())
	...
	public static void init() {
		Registry.register(BuiltinRegistries.CONFIGURED_SURFACE_BUILDER, new ResourceLocation(TimeMod.MODID, "moon_sharp_forest"), SURFACE_BUILDER);
	...
	private static ConfiguredFeature<?, ?> register(String name, ConfiguredFeature<?, ?> configuredFeature) {
		CONFIGURED_FEATURES.put(new ResourceLocation(TimeMod.MODID, name + "_moon_sharp_forest"), configuredFeature);
