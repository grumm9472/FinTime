...
import enchia.time.main.world.features.treedecorators.SakuraForestTrunkDecorator;
import enchia.time.main.world.features.treedecorators.SakuraForestLeaveDecorator;
import enchia.time.main.world.features.treedecorators.SakuraForestFruitDecorator;
...
public class SakuraForestBiome {
	...
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, register("trees", Feature.TREE
				.configured((new TreeConfiguration.TreeConfigurationBuilder(new SimpleStateProvider(TimeModBlocks.SAKURA_LOG.defaultBlockState()),
						new MegaJungleTrunkPlacer(7, 2, 19), new SimpleStateProvider(TimeModBlocks.SAKURA_LEAVES.defaultBlockState()),
						new SimpleStateProvider(Blocks.OAK_SAPLING.defaultBlockState()),
						new MegaJungleFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 2), new TwoLayersFeatureSize(1, 1, 2)))
								.decorators(ImmutableList.of(SakuraForestLeaveDecorator.INSTANCE, SakuraForestTrunkDecorator.INSTANCE,
										SakuraForestFruitDecorator.INSTANCE))
								.build())
	...
	public static void init() {
		Registry.register(BuiltinRegistries.CONFIGURED_SURFACE_BUILDER, new ResourceLocation(TimeMod.MODID, "sakura_forest"), SURFACE_BUILDER);
	...
	private static ConfiguredFeature<?, ?> register(String name, ConfiguredFeature<?, ?> configuredFeature) {
		CONFIGURED_FEATURES.put(new ResourceLocation(TimeMod.MODID, name + "_sakura_forest"), configuredFeature);
