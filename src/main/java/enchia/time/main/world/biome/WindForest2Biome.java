...
import enchia.time.main.world.features.treedecorators.WindForest2TrunkDecorator;
import enchia.time.main.world.features.treedecorators.WindForest2LeaveDecorator;
import enchia.time.main.world.features.treedecorators.WindForest2FruitDecorator;
import enchia.time.main.init.TimeModBlocks;
import enchia.time.main.TimeMod;

import com.google.common.collect.ImmutableList;

public class WindForest2Biome {
	...
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, register("trees", Feature.TREE
				.configured((new TreeConfiguration.TreeConfigurationBuilder(
						new SimpleStateProvider(TimeModBlocks.MINECRAFT_YEARS_100_LOG.defaultBlockState()), new MegaJungleTrunkPlacer(21, 2, 19),
						...
						new MegaJungleFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 2), new TwoLayersFeatureSize(1, 1, 2)))
								.decorators(ImmutableList.of(WindForest2LeaveDecorator.INSTANCE, WindForest2TrunkDecorator.INSTANCE,
										WindForest2FruitDecorator.INSTANCE))
								.build())
	...
	public static void init() {
		Registry.register(BuiltinRegistries.CONFIGURED_SURFACE_BUILDER, new ResourceLocation(TimeMod.MODID, "wind_forest_2"), SURFACE_BUILDER);
	...
	private static ConfiguredFeature<?, ?> register(String name, ConfiguredFeature<?, ?> configuredFeature) {
		CONFIGURED_FEATURES.put(new ResourceLocation(TimeMod.MODID, name + "_wind_forest_2"), configuredFeature);
