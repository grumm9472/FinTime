...
public class AwdFeature extends Feature<NoneFeatureConfiguration> {
	public static final AwdFeature FEATURE = (AwdFeature) new AwdFeature().setRegistryName("time:awd");
