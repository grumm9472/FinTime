...
public class Ball1Feature extends Feature<NoneFeatureConfiguration> {
	public static final Ball1Feature FEATURE = (Ball1Feature) new Ball1Feature().setRegistryName("time:ball_1");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("time", "102400ball1ghoul"));
		if (template == null)
			return false;
