...
public class Ball2Feature extends Feature<NoneFeatureConfiguration> {
	public static final Ball2Feature FEATURE = (Ball2Feature) new Ball2Feature().setRegistryName("time:ball_2");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("time", "102400ball1ghoulplus"));
		if (template == null)
			return false;
