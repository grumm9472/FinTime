...
public class Ball3Feature extends Feature<NoneFeatureConfiguration> {
	public static final Ball3Feature FEATURE = (Ball3Feature) new Ball3Feature().setRegistryName("time:ball_3");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("time", "201400ball2ghoul"));
		if (template == null)
			return false;
