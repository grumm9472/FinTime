...
public class Ball5Feature extends Feature<NoneFeatureConfiguration> {
	public static final Ball5Feature FEATURE = (Ball5Feature) new Ball5Feature().setRegistryName("time:ball_5");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("time", "409600ball4ghoul"));
		if (template == null)
			return false;
