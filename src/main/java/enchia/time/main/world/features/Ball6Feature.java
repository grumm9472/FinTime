...
public class Ball6Feature extends Feature<NoneFeatureConfiguration> {
	public static final Ball6Feature FEATURE = (Ball6Feature) new Ball6Feature().setRegistryName("time:ball_6");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("time", "409600ball4ghoulplus"));
		if (template == null)
			return false;
