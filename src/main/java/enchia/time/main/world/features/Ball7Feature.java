...
public class Ball7Feature extends Feature<NoneFeatureConfiguration> {
	public static final Ball7Feature FEATURE = (Ball7Feature) new Ball7Feature().setRegistryName("time:ball_7");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("time", "409600ball4main"));
		if (template == null)
			return false;
