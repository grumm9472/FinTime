...
public class Ball8Feature extends Feature<NoneFeatureConfiguration> {
	public static final Ball8Feature FEATURE = (Ball8Feature) new Ball8Feature().setRegistryName("time:ball_8");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("time", "409600ball8small1"));
		if (template == null)
			return false;
