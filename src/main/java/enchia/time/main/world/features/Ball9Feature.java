...
public class Ball9Feature extends Feature<NoneFeatureConfiguration> {
	public static final Ball9Feature FEATURE = (Ball9Feature) new Ball9Feature().setRegistryName("time:ball_9");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("time", "409600ball8small2"));
		if (template == null)
			return false;
