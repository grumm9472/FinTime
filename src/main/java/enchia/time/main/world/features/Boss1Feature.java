...
public class Boss1Feature extends Feature<NoneFeatureConfiguration> {
	public static final Boss1Feature FEATURE = (Boss1Feature) new Boss1Feature().setRegistryName("time:boss_1");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("time", "102400_boss"));
		if (template == null)
			return false;
