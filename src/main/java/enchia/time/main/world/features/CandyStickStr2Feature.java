...
public class CandyStickStr2Feature extends Feature<NoneFeatureConfiguration> {
	public static final CandyStickStr2Feature FEATURE = (CandyStickStr2Feature) new CandyStickStr2Feature().setRegistryName("time:candy_stick_str_2");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public CandyStickStr2Feature() {
