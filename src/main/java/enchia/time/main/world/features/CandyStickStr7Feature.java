...
public class CandyStickStr7Feature extends Feature<NoneFeatureConfiguration> {
	public static final CandyStickStr7Feature FEATURE = (CandyStickStr7Feature) new CandyStickStr7Feature().setRegistryName("time:candy_stick_str_7");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public CandyStickStr7Feature() {
