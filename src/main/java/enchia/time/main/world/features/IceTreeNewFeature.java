...
public class IceTreeNewFeature extends Feature<NoneFeatureConfiguration> {
	public static final IceTreeNewFeature FEATURE = (IceTreeNewFeature) new IceTreeNewFeature().setRegistryName("time:ice_tree_new");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("time", "icetreenew"));
		if (template == null)
			return false;
