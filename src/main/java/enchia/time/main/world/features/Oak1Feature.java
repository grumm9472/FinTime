...
public class Oak1Feature extends Feature<NoneFeatureConfiguration> {
	public static final Oak1Feature FEATURE = (Oak1Feature) new Oak1Feature().setRegistryName("time:oak_1");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("time", "treeoak2b6"));
		if (template == null)
			return false;
