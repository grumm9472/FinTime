...
public class Oak2Feature extends Feature<NoneFeatureConfiguration> {
	public static final Oak2Feature FEATURE = (Oak2Feature) new Oak2Feature().setRegistryName("time:oak_2");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("time", "treeoakcicadab7"));
		if (template == null)
			return false;
