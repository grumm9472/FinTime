...
public class PhantomTreeNormal1Feature extends Feature<NoneFeatureConfiguration> {
	public static final PhantomTreeNormal1Feature FEATURE = (PhantomTreeNormal1Feature) new PhantomTreeNormal1Feature()
			.setRegistryName("time:phantom_tree_normal_1");
	...
	public PhantomTreeNormal1Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("time", "phantomtreenormal1"));
		if (template == null)
			return false;
