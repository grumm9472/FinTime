...
public class PhantomTreeNormal2Feature extends Feature<NoneFeatureConfiguration> {
	public static final PhantomTreeNormal2Feature FEATURE = (PhantomTreeNormal2Feature) new PhantomTreeNormal2Feature()
			.setRegistryName("time:phantom_tree_normal_2");
	...
	public PhantomTreeNormal2Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("time", "phantomtreenormal2"));
		if (template == null)
			return false;
