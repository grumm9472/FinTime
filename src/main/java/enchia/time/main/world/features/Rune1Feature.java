...
public class Rune1Feature extends Feature<NoneFeatureConfiguration> {
	public static final Rune1Feature FEATURE = (Rune1Feature) new Rune1Feature().setRegistryName("time:rune_1");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("time", "ruine1"));
		if (template == null)
			return false;
