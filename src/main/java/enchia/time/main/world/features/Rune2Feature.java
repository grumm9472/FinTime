...
public class Rune2Feature extends Feature<NoneFeatureConfiguration> {
	public static final Rune2Feature FEATURE = (Rune2Feature) new Rune2Feature().setRegistryName("time:rune_2");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("time", "ruine2"));
		if (template == null)
			return false;
