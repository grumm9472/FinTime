...
public class Rune4Feature extends Feature<NoneFeatureConfiguration> {
	public static final Rune4Feature FEATURE = (Rune4Feature) new Rune4Feature().setRegistryName("time:rune_4");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("time", "ruine4"));
		if (template == null)
			return false;
