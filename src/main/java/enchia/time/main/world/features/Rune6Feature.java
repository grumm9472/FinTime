...
public class Rune6Feature extends Feature<NoneFeatureConfiguration> {
	public static final Rune6Feature FEATURE = (Rune6Feature) new Rune6Feature().setRegistryName("time:rune_6");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("time", "ruine6"));
		if (template == null)
			return false;
