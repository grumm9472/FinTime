...
public class Rune7Feature extends Feature<NoneFeatureConfiguration> {
	public static final Rune7Feature FEATURE = (Rune7Feature) new Rune7Feature().setRegistryName("time:rune_7");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("time", "ruine7"));
		if (template == null)
			return false;
