...
public class Sea4096004Feature extends Feature<NoneFeatureConfiguration> {
	public static final Sea4096004Feature FEATURE = (Sea4096004Feature) new Sea4096004Feature().setRegistryName("time:sea_4096004");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public Sea4096004Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("time", "end1_13x25_island4"));
		if (template == null)
			return false;
