...
public class Sea4096005Feature extends Feature<NoneFeatureConfiguration> {
	public static final Sea4096005Feature FEATURE = (Sea4096005Feature) new Sea4096005Feature().setRegistryName("time:sea_4096005");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public Sea4096005Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("time", "end1_13x25_island5"));
		if (template == null)
			return false;
