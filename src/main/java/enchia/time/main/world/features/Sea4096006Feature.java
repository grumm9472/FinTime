...
public class Sea4096006Feature extends Feature<NoneFeatureConfiguration> {
	public static final Sea4096006Feature FEATURE = (Sea4096006Feature) new Sea4096006Feature().setRegistryName("time:sea_4096006");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public Sea4096006Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("time", "end1_13x25_island6"));
		if (template == null)
			return false;
