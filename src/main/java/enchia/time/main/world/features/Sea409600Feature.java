...
public class Sea409600Feature extends Feature<NoneFeatureConfiguration> {
	public static final Sea409600Feature FEATURE = (Sea409600Feature) new Sea409600Feature().setRegistryName("time:sea_409600");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public Sea409600Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("time", "end1_13x25_island1"));
		if (template == null)
			return false;
