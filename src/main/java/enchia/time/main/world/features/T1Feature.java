...
public class T1Feature extends Feature<NoneFeatureConfiguration> {
	public static final T1Feature FEATURE = (T1Feature) new T1Feature().setRegistryName("time:t_1");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("time", "magic1"));
		if (template == null)
			return false;
