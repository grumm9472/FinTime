...
public class Tree1Feature extends Feature<NoneFeatureConfiguration> {
	public static final Tree1Feature FEATURE = (Tree1Feature) new Tree1Feature().setRegistryName("time:tree_1");
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("time", "jungle_tree"));
		if (template == null)
			return false;
