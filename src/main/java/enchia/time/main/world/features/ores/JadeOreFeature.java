...
public class JadeOreFeature extends OreFeature {
	public static final JadeOreFeature FEATURE = (JadeOreFeature) new JadeOreFeature().setRegistryName("time:jade_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new OreConfiguration(JadeOreFeatureRuleTest.INSTANCE, TimeModBlocks.JADE_ORE.defaultBlockState(), 7))
	...
	private static class JadeOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<JadeOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("time:jade_ore_match"), () -> codec);
