...
public class TinOreFeature extends OreFeature {
	public static final TinOreFeature FEATURE = (TinOreFeature) new TinOreFeature().setRegistryName("time:tin_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new OreConfiguration(TinOreFeatureRuleTest.INSTANCE, TimeModBlocks.TIN_ORE.defaultBlockState(), 7))
	...
	private static class TinOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<TinOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("time:tin_ore_match"), () -> codec);
