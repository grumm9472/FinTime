...
public class AncientForestSmallFruitDecorator extends CocoaDecorator {
	public static final AncientForestSmallFruitDecorator INSTANCE = new AncientForestSmallFruitDecorator();
	public static com.mojang.serialization.Codec<AncientForestSmallFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("ancient_forest_small_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public AncientForestSmallFruitDecorator() {
		super(0.2f);
	}
