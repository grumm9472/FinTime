...
public class AncientForestSmallLeaveDecorator extends LeaveVineDecorator {
	public static final AncientForestSmallLeaveDecorator INSTANCE = new AncientForestSmallLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("ancient_forest_small_tree_leave_decorator");
