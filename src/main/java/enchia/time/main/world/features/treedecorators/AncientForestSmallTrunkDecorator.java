...
public class AncientForestSmallTrunkDecorator extends TrunkVineDecorator {
	public static final AncientForestSmallTrunkDecorator INSTANCE = new AncientForestSmallTrunkDecorator();
	public static com.mojang.serialization.Codec<AncientForestSmallTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("ancient_forest_small_tree_trunk_decorator");
