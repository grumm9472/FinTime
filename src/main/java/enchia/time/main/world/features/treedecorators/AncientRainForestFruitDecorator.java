...
public class AncientRainForestFruitDecorator extends CocoaDecorator {
	public static final AncientRainForestFruitDecorator INSTANCE = new AncientRainForestFruitDecorator();
	public static com.mojang.serialization.Codec<AncientRainForestFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("ancient_rain_forest_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public AncientRainForestFruitDecorator() {
		super(0.2f);
	}
