...
public class AncientRainForestTrunkDecorator extends TrunkVineDecorator {
	public static final AncientRainForestTrunkDecorator INSTANCE = new AncientRainForestTrunkDecorator();
	public static com.mojang.serialization.Codec<AncientRainForestTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("ancient_rain_forest_tree_trunk_decorator");
