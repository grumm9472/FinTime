...
public class BetaplainsFruitDecorator extends CocoaDecorator {
	public static final BetaplainsFruitDecorator INSTANCE = new BetaplainsFruitDecorator();
	public static com.mojang.serialization.Codec<BetaplainsFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("betaplains_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public BetaplainsFruitDecorator() {
		super(0.2f);
	}
