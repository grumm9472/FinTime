...
public class BetaplainsTrunkDecorator extends TrunkVineDecorator {
	public static final BetaplainsTrunkDecorator INSTANCE = new BetaplainsTrunkDecorator();
	public static com.mojang.serialization.Codec<BetaplainsTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("betaplains_tree_trunk_decorator");
