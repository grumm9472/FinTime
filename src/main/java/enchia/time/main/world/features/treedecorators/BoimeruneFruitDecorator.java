...
public class BoimeruneFruitDecorator extends CocoaDecorator {
	public static final BoimeruneFruitDecorator INSTANCE = new BoimeruneFruitDecorator();
	public static com.mojang.serialization.Codec<BoimeruneFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("boimerune_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public BoimeruneFruitDecorator() {
		super(0.2f);
	}
