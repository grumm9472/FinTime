...
public class BoimeruneLeaveDecorator extends LeaveVineDecorator {
	public static final BoimeruneLeaveDecorator INSTANCE = new BoimeruneLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("boimerune_tree_leave_decorator");
