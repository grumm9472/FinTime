...
public class ChocolateLandFruitDecorator extends CocoaDecorator {
	public static final ChocolateLandFruitDecorator INSTANCE = new ChocolateLandFruitDecorator();
	public static com.mojang.serialization.Codec<ChocolateLandFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("chocolate_land_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public ChocolateLandFruitDecorator() {
		super(0.2f);
	}
