...
public class ChocolateLandLeaveDecorator extends LeaveVineDecorator {
	public static final ChocolateLandLeaveDecorator INSTANCE = new ChocolateLandLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("chocolate_land_tree_leave_decorator");
