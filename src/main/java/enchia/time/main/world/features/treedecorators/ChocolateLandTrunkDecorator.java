...
public class ChocolateLandTrunkDecorator extends TrunkVineDecorator {
	public static final ChocolateLandTrunkDecorator INSTANCE = new ChocolateLandTrunkDecorator();
	public static com.mojang.serialization.Codec<ChocolateLandTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("chocolate_land_tree_trunk_decorator");
