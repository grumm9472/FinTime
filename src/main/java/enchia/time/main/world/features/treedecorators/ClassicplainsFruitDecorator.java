...
public class ClassicplainsFruitDecorator extends CocoaDecorator {
	public static final ClassicplainsFruitDecorator INSTANCE = new ClassicplainsFruitDecorator();
	public static com.mojang.serialization.Codec<ClassicplainsFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("classicplains_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public ClassicplainsFruitDecorator() {
		super(0.2f);
	}
