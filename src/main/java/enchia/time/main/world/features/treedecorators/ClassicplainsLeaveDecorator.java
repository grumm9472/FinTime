...
public class ClassicplainsLeaveDecorator extends LeaveVineDecorator {
	public static final ClassicplainsLeaveDecorator INSTANCE = new ClassicplainsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("classicplains_tree_leave_decorator");
