...
public class ClassicplainsTrunkDecorator extends TrunkVineDecorator {
	public static final ClassicplainsTrunkDecorator INSTANCE = new ClassicplainsTrunkDecorator();
	public static com.mojang.serialization.Codec<ClassicplainsTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("classicplains_tree_trunk_decorator");
