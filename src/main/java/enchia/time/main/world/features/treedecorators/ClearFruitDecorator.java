...
public class ClearFruitDecorator extends CocoaDecorator {
	public static final ClearFruitDecorator INSTANCE = new ClearFruitDecorator();
	public static com.mojang.serialization.Codec<ClearFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("clear_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public ClearFruitDecorator() {
		super(0.2f);
	}
