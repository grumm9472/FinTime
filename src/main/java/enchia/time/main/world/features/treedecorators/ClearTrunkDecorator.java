...
public class ClearTrunkDecorator extends TrunkVineDecorator {
	public static final ClearTrunkDecorator INSTANCE = new ClearTrunkDecorator();
	public static com.mojang.serialization.Codec<ClearTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("clear_tree_trunk_decorator");
