...
public class EmptyPhantomFruitDecorator extends CocoaDecorator {
	public static final EmptyPhantomFruitDecorator INSTANCE = new EmptyPhantomFruitDecorator();
	public static com.mojang.serialization.Codec<EmptyPhantomFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("empty_phantom_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public EmptyPhantomFruitDecorator() {
		super(0.2f);
	}
