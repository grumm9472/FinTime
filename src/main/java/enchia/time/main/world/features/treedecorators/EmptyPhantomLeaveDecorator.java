...
public class EmptyPhantomLeaveDecorator extends LeaveVineDecorator {
	public static final EmptyPhantomLeaveDecorator INSTANCE = new EmptyPhantomLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("empty_phantom_tree_leave_decorator");
