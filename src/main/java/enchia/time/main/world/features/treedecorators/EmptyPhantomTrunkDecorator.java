...
public class EmptyPhantomTrunkDecorator extends TrunkVineDecorator {
	public static final EmptyPhantomTrunkDecorator INSTANCE = new EmptyPhantomTrunkDecorator();
	public static com.mojang.serialization.Codec<EmptyPhantomTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("empty_phantom_tree_trunk_decorator");
