...
public class FORESTmAGICFruitDecorator extends CocoaDecorator {
	public static final FORESTmAGICFruitDecorator INSTANCE = new FORESTmAGICFruitDecorator();
	public static com.mojang.serialization.Codec<FORESTmAGICFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("fores_tm_agic_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public FORESTmAGICFruitDecorator() {
		super(0.2f);
	}
