...
public class FORESTmAGICLeaveDecorator extends LeaveVineDecorator {
	public static final FORESTmAGICLeaveDecorator INSTANCE = new FORESTmAGICLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("fores_tm_agic_tree_leave_decorator");
