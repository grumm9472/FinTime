...
public class FORESTmAGICTrunkDecorator extends TrunkVineDecorator {
	public static final FORESTmAGICTrunkDecorator INSTANCE = new FORESTmAGICTrunkDecorator();
	public static com.mojang.serialization.Codec<FORESTmAGICTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("fores_tm_agic_tree_trunk_decorator");
