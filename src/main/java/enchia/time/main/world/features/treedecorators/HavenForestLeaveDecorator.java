...
public class HavenForestLeaveDecorator extends LeaveVineDecorator {
	public static final HavenForestLeaveDecorator INSTANCE = new HavenForestLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("haven_forest_tree_leave_decorator");
