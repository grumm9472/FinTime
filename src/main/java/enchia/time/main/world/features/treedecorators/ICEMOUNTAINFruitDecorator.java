...
public class ICEMOUNTAINFruitDecorator extends CocoaDecorator {
	public static final ICEMOUNTAINFruitDecorator INSTANCE = new ICEMOUNTAINFruitDecorator();
	public static com.mojang.serialization.Codec<ICEMOUNTAINFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("icemountain_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public ICEMOUNTAINFruitDecorator() {
		super(0.2f);
	}
