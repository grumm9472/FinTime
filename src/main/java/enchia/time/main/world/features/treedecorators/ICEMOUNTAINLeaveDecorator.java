...
public class ICEMOUNTAINLeaveDecorator extends LeaveVineDecorator {
	public static final ICEMOUNTAINLeaveDecorator INSTANCE = new ICEMOUNTAINLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("icemountain_tree_leave_decorator");
