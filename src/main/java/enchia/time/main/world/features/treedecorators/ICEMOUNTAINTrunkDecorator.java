...
public class ICEMOUNTAINTrunkDecorator extends TrunkVineDecorator {
	public static final ICEMOUNTAINTrunkDecorator INSTANCE = new ICEMOUNTAINTrunkDecorator();
	public static com.mojang.serialization.Codec<ICEMOUNTAINTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("icemountain_tree_trunk_decorator");
