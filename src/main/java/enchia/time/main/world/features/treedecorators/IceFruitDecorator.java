...
public class IceFruitDecorator extends CocoaDecorator {
	public static final IceFruitDecorator INSTANCE = new IceFruitDecorator();
	public static com.mojang.serialization.Codec<IceFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("ice_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public IceFruitDecorator() {
		super(0.2f);
	}
