...
public class IcePlainsFruitDecorator extends CocoaDecorator {
	public static final IcePlainsFruitDecorator INSTANCE = new IcePlainsFruitDecorator();
	public static com.mojang.serialization.Codec<IcePlainsFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("ice_plains_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public IcePlainsFruitDecorator() {
		super(0.2f);
	}
