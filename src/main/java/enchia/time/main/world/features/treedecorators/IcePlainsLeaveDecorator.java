...
public class IcePlainsLeaveDecorator extends LeaveVineDecorator {
	public static final IcePlainsLeaveDecorator INSTANCE = new IcePlainsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("ice_plains_tree_leave_decorator");
