...
public class IcePlainsTrunkDecorator extends TrunkVineDecorator {
	public static final IcePlainsTrunkDecorator INSTANCE = new IcePlainsTrunkDecorator();
	public static com.mojang.serialization.Codec<IcePlainsTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("ice_plains_tree_trunk_decorator");
