...
public class IceTrunkDecorator extends TrunkVineDecorator {
	public static final IceTrunkDecorator INSTANCE = new IceTrunkDecorator();
	public static com.mojang.serialization.Codec<IceTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("ice_tree_trunk_decorator");
