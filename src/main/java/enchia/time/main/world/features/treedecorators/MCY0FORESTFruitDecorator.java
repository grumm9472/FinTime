...
public class MCY0FORESTFruitDecorator extends CocoaDecorator {
	public static final MCY0FORESTFruitDecorator INSTANCE = new MCY0FORESTFruitDecorator();
	public static com.mojang.serialization.Codec<MCY0FORESTFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mcy_0_forest_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public MCY0FORESTFruitDecorator() {
		super(0.2f);
	}
