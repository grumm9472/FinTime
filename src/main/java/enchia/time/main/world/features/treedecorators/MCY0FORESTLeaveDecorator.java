...
public class MCY0FORESTLeaveDecorator extends LeaveVineDecorator {
	public static final MCY0FORESTLeaveDecorator INSTANCE = new MCY0FORESTLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mcy_0_forest_tree_leave_decorator");
