...
public class MCY0FORESTTrunkDecorator extends TrunkVineDecorator {
	public static final MCY0FORESTTrunkDecorator INSTANCE = new MCY0FORESTTrunkDecorator();
	public static com.mojang.serialization.Codec<MCY0FORESTTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mcy_0_forest_tree_trunk_decorator");
