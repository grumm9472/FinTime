...
public class MCY1600PlainsFruitDecorator extends CocoaDecorator {
	public static final MCY1600PlainsFruitDecorator INSTANCE = new MCY1600PlainsFruitDecorator();
	public static com.mojang.serialization.Codec<MCY1600PlainsFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mcy_1600_plains_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public MCY1600PlainsFruitDecorator() {
		super(0.2f);
	}
