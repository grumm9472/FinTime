...
public class MCY1600PlainsLeaveDecorator extends LeaveVineDecorator {
	public static final MCY1600PlainsLeaveDecorator INSTANCE = new MCY1600PlainsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mcy_1600_plains_tree_leave_decorator");
