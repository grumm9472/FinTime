...
public class MCY1600PlainsTrunkDecorator extends TrunkVineDecorator {
	public static final MCY1600PlainsTrunkDecorator INSTANCE = new MCY1600PlainsTrunkDecorator();
	public static com.mojang.serialization.Codec<MCY1600PlainsTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mcy_1600_plains_tree_trunk_decorator");
