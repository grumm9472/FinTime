...
public class MCY25600BEACHFruitDecorator extends CocoaDecorator {
	public static final MCY25600BEACHFruitDecorator INSTANCE = new MCY25600BEACHFruitDecorator();
	public static com.mojang.serialization.Codec<MCY25600BEACHFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mcy_25600_beach_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public MCY25600BEACHFruitDecorator() {
		super(0.2f);
	}
