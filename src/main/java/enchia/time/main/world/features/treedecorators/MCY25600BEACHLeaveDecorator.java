...
public class MCY25600BEACHLeaveDecorator extends LeaveVineDecorator {
	public static final MCY25600BEACHLeaveDecorator INSTANCE = new MCY25600BEACHLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mcy_25600_beach_tree_leave_decorator");
