...
public class MCY25600BEACHTrunkDecorator extends TrunkVineDecorator {
	public static final MCY25600BEACHTrunkDecorator INSTANCE = new MCY25600BEACHTrunkDecorator();
	public static com.mojang.serialization.Codec<MCY25600BEACHTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mcy_25600_beach_tree_trunk_decorator");
