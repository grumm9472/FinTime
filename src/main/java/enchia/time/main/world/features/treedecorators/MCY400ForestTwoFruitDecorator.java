...
public class MCY400ForestTwoFruitDecorator extends CocoaDecorator {
	public static final MCY400ForestTwoFruitDecorator INSTANCE = new MCY400ForestTwoFruitDecorator();
	public static com.mojang.serialization.Codec<MCY400ForestTwoFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mcy_400_forest_two_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public MCY400ForestTwoFruitDecorator() {
		super(0.2f);
	}
