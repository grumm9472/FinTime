...
public class MCY400ForestTwoLeaveDecorator extends LeaveVineDecorator {
	public static final MCY400ForestTwoLeaveDecorator INSTANCE = new MCY400ForestTwoLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mcy_400_forest_two_tree_leave_decorator");
