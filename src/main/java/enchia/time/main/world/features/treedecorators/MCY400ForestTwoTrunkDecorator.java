...
public class MCY400ForestTwoTrunkDecorator extends TrunkVineDecorator {
	public static final MCY400ForestTwoTrunkDecorator INSTANCE = new MCY400ForestTwoTrunkDecorator();
	public static com.mojang.serialization.Codec<MCY400ForestTwoTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mcy_400_forest_two_tree_trunk_decorator");
