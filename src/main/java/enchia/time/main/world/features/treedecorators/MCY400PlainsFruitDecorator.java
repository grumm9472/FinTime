...
public class MCY400PlainsFruitDecorator extends CocoaDecorator {
	public static final MCY400PlainsFruitDecorator INSTANCE = new MCY400PlainsFruitDecorator();
	public static com.mojang.serialization.Codec<MCY400PlainsFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mcy_400_plains_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public MCY400PlainsFruitDecorator() {
		super(0.2f);
	}
