...
public class MCY400PlainsLeaveDecorator extends LeaveVineDecorator {
	public static final MCY400PlainsLeaveDecorator INSTANCE = new MCY400PlainsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mcy_400_plains_tree_leave_decorator");
