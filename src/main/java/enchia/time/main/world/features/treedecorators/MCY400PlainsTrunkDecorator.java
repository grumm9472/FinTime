...
public class MCY400PlainsTrunkDecorator extends TrunkVineDecorator {
	public static final MCY400PlainsTrunkDecorator INSTANCE = new MCY400PlainsTrunkDecorator();
	public static com.mojang.serialization.Codec<MCY400PlainsTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mcy_400_plains_tree_trunk_decorator");
