...
public class Mcy100PlainsFruitDecorator extends CocoaDecorator {
	public static final Mcy100PlainsFruitDecorator INSTANCE = new Mcy100PlainsFruitDecorator();
	public static com.mojang.serialization.Codec<Mcy100PlainsFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mcy_100_plains_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public Mcy100PlainsFruitDecorator() {
		super(0.2f);
	}
