...
public class Mcy100PlainsLeaveDecorator extends LeaveVineDecorator {
	public static final Mcy100PlainsLeaveDecorator INSTANCE = new Mcy100PlainsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mcy_100_plains_tree_leave_decorator");
