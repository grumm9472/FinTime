...
public class Mcy100PlainsTrunkDecorator extends TrunkVineDecorator {
	public static final Mcy100PlainsTrunkDecorator INSTANCE = new Mcy100PlainsTrunkDecorator();
	public static com.mojang.serialization.Codec<Mcy100PlainsTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mcy_100_plains_tree_trunk_decorator");
