...
public class Mcy100mountainFruitDecorator extends CocoaDecorator {
	public static final Mcy100mountainFruitDecorator INSTANCE = new Mcy100mountainFruitDecorator();
	public static com.mojang.serialization.Codec<Mcy100mountainFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mcy_100mountain_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public Mcy100mountainFruitDecorator() {
		super(0.2f);
	}
