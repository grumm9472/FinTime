...
public class Mcy100mountainLeaveDecorator extends LeaveVineDecorator {
	public static final Mcy100mountainLeaveDecorator INSTANCE = new Mcy100mountainLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mcy_100mountain_tree_leave_decorator");
