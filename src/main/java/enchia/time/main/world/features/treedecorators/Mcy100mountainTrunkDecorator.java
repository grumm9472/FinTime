...
public class Mcy100mountainTrunkDecorator extends TrunkVineDecorator {
	public static final Mcy100mountainTrunkDecorator INSTANCE = new Mcy100mountainTrunkDecorator();
	public static com.mojang.serialization.Codec<Mcy100mountainTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mcy_100mountain_tree_trunk_decorator");
