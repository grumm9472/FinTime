...
public class Mcy400fORESTFruitDecorator extends CocoaDecorator {
	public static final Mcy400fORESTFruitDecorator INSTANCE = new Mcy400fORESTFruitDecorator();
	public static com.mojang.serialization.Codec<Mcy400fORESTFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mcy_400f_orest_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public Mcy400fORESTFruitDecorator() {
		super(0.2f);
	}
