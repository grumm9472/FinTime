...
public class Mcy400fORESTTrunkDecorator extends TrunkVineDecorator {
	public static final Mcy400fORESTTrunkDecorator INSTANCE = new Mcy400fORESTTrunkDecorator();
	public static com.mojang.serialization.Codec<Mcy400fORESTTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mcy_400f_orest_tree_trunk_decorator");
