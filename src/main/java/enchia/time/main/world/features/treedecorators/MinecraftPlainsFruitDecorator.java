...
public class MinecraftPlainsFruitDecorator extends CocoaDecorator {
	public static final MinecraftPlainsFruitDecorator INSTANCE = new MinecraftPlainsFruitDecorator();
	public static com.mojang.serialization.Codec<MinecraftPlainsFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("minecraft_plains_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public MinecraftPlainsFruitDecorator() {
		super(0.2f);
	}
