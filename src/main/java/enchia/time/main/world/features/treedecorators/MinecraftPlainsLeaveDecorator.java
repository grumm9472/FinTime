...
public class MinecraftPlainsLeaveDecorator extends LeaveVineDecorator {
	public static final MinecraftPlainsLeaveDecorator INSTANCE = new MinecraftPlainsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("minecraft_plains_tree_leave_decorator");
