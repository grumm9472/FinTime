...
public class MinecraftPlainsTrunkDecorator extends TrunkVineDecorator {
	public static final MinecraftPlainsTrunkDecorator INSTANCE = new MinecraftPlainsTrunkDecorator();
	public static com.mojang.serialization.Codec<MinecraftPlainsTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("minecraft_plains_tree_trunk_decorator");
