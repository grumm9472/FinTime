...
public class MoonSharpForestFruitDecorator extends CocoaDecorator {
	public static final MoonSharpForestFruitDecorator INSTANCE = new MoonSharpForestFruitDecorator();
	public static com.mojang.serialization.Codec<MoonSharpForestFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("moon_sharp_forest_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public MoonSharpForestFruitDecorator() {
		super(0.2f);
	}
