...
public class MoonSharpForestLeaveDecorator extends LeaveVineDecorator {
	public static final MoonSharpForestLeaveDecorator INSTANCE = new MoonSharpForestLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("moon_sharp_forest_tree_leave_decorator");
