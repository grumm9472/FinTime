...
public class MoonSharpForestTrunkDecorator extends TrunkVineDecorator {
	public static final MoonSharpForestTrunkDecorator INSTANCE = new MoonSharpForestTrunkDecorator();
	public static com.mojang.serialization.Codec<MoonSharpForestTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("moon_sharp_forest_tree_trunk_decorator");
