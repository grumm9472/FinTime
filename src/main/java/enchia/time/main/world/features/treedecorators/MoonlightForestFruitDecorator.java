...
public class MoonlightForestFruitDecorator extends CocoaDecorator {
	public static final MoonlightForestFruitDecorator INSTANCE = new MoonlightForestFruitDecorator();
	public static com.mojang.serialization.Codec<MoonlightForestFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("moonlight_forest_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public MoonlightForestFruitDecorator() {
		super(0.2f);
	}
