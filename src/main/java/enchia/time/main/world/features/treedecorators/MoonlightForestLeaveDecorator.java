...
public class MoonlightForestLeaveDecorator extends LeaveVineDecorator {
	public static final MoonlightForestLeaveDecorator INSTANCE = new MoonlightForestLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("moonlight_forest_tree_leave_decorator");
