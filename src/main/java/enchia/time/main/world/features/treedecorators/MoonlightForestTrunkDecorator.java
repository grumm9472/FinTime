...
public class MoonlightForestTrunkDecorator extends TrunkVineDecorator {
	public static final MoonlightForestTrunkDecorator INSTANCE = new MoonlightForestTrunkDecorator();
	public static com.mojang.serialization.Codec<MoonlightForestTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("moonlight_forest_tree_trunk_decorator");
