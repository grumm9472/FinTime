...
public class MudFruitDecorator extends CocoaDecorator {
	public static final MudFruitDecorator INSTANCE = new MudFruitDecorator();
	public static com.mojang.serialization.Codec<MudFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mud_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public MudFruitDecorator() {
		super(0.2f);
	}
