...
public class MudTrunkDecorator extends TrunkVineDecorator {
	public static final MudTrunkDecorator INSTANCE = new MudTrunkDecorator();
	public static com.mojang.serialization.Codec<MudTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mud_tree_trunk_decorator");
