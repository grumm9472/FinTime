...
public class MushroommountainFruitDecorator extends CocoaDecorator {
	public static final MushroommountainFruitDecorator INSTANCE = new MushroommountainFruitDecorator();
	public static com.mojang.serialization.Codec<MushroommountainFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mushroommountain_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public MushroommountainFruitDecorator() {
		super(0.2f);
	}
