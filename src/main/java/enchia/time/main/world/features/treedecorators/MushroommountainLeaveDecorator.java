...
public class MushroommountainLeaveDecorator extends LeaveVineDecorator {
	public static final MushroommountainLeaveDecorator INSTANCE = new MushroommountainLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mushroommountain_tree_leave_decorator");
