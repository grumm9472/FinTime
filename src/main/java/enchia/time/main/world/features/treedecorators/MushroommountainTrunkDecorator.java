...
public class MushroommountainTrunkDecorator extends TrunkVineDecorator {
	public static final MushroommountainTrunkDecorator INSTANCE = new MushroommountainTrunkDecorator();
	public static com.mojang.serialization.Codec<MushroommountainTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mushroommountain_tree_trunk_decorator");
