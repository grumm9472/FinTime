...
public class NetherMCY100FruitDecorator extends CocoaDecorator {
	public static final NetherMCY100FruitDecorator INSTANCE = new NetherMCY100FruitDecorator();
	public static com.mojang.serialization.Codec<NetherMCY100FruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("nether_mcy_100_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public NetherMCY100FruitDecorator() {
		super(0.2f);
	}
