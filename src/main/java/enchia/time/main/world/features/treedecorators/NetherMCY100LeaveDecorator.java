...
public class NetherMCY100LeaveDecorator extends LeaveVineDecorator {
	public static final NetherMCY100LeaveDecorator INSTANCE = new NetherMCY100LeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("nether_mcy_100_tree_leave_decorator");
