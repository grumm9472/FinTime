...
public class NetherMCY100TrunkDecorator extends TrunkVineDecorator {
	public static final NetherMCY100TrunkDecorator INSTANCE = new NetherMCY100TrunkDecorator();
	public static com.mojang.serialization.Codec<NetherMCY100TrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("nether_mcy_100_tree_trunk_decorator");
