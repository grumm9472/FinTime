...
public class OldDesertFruitDecorator extends CocoaDecorator {
	public static final OldDesertFruitDecorator INSTANCE = new OldDesertFruitDecorator();
	public static com.mojang.serialization.Codec<OldDesertFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("old_desert_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public OldDesertFruitDecorator() {
		super(0.2f);
	}
