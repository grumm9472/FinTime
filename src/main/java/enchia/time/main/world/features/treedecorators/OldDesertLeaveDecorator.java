...
public class OldDesertLeaveDecorator extends LeaveVineDecorator {
	public static final OldDesertLeaveDecorator INSTANCE = new OldDesertLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("old_desert_tree_leave_decorator");
