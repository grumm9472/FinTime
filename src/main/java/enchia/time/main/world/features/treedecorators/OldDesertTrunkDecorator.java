...
public class OldDesertTrunkDecorator extends TrunkVineDecorator {
	public static final OldDesertTrunkDecorator INSTANCE = new OldDesertTrunkDecorator();
	public static com.mojang.serialization.Codec<OldDesertTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("old_desert_tree_trunk_decorator");
