...
public class RuneLandFruitDecorator extends CocoaDecorator {
	public static final RuneLandFruitDecorator INSTANCE = new RuneLandFruitDecorator();
	public static com.mojang.serialization.Codec<RuneLandFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("rune_land_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public RuneLandFruitDecorator() {
		super(0.2f);
	}
