...
public class RuneLandTrunkDecorator extends TrunkVineDecorator {
	public static final RuneLandTrunkDecorator INSTANCE = new RuneLandTrunkDecorator();
	public static com.mojang.serialization.Codec<RuneLandTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("rune_land_tree_trunk_decorator");
