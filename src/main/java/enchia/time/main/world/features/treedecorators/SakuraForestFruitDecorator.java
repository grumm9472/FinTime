...
public class SakuraForestFruitDecorator extends CocoaDecorator {
	public static final SakuraForestFruitDecorator INSTANCE = new SakuraForestFruitDecorator();
	public static com.mojang.serialization.Codec<SakuraForestFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("sakura_forest_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public SakuraForestFruitDecorator() {
		super(0.2f);
	}
