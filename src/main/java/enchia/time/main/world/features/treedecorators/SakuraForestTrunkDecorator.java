...
public class SakuraForestTrunkDecorator extends TrunkVineDecorator {
	public static final SakuraForestTrunkDecorator INSTANCE = new SakuraForestTrunkDecorator();
	public static com.mojang.serialization.Codec<SakuraForestTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("sakura_forest_tree_trunk_decorator");
