...
public class SecMoonSharpForestFruitDecorator extends CocoaDecorator {
	public static final SecMoonSharpForestFruitDecorator INSTANCE = new SecMoonSharpForestFruitDecorator();
	public static com.mojang.serialization.Codec<SecMoonSharpForestFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("sec_moon_sharp_forest_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public SecMoonSharpForestFruitDecorator() {
		super(0.2f);
	}
