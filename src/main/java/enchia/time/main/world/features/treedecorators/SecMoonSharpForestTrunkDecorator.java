...
public class SecMoonSharpForestTrunkDecorator extends TrunkVineDecorator {
	public static final SecMoonSharpForestTrunkDecorator INSTANCE = new SecMoonSharpForestTrunkDecorator();
	public static com.mojang.serialization.Codec<SecMoonSharpForestTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("sec_moon_sharp_forest_tree_trunk_decorator");
