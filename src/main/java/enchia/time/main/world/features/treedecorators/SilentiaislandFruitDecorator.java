...
public class SilentiaislandFruitDecorator extends CocoaDecorator {
	public static final SilentiaislandFruitDecorator INSTANCE = new SilentiaislandFruitDecorator();
	public static com.mojang.serialization.Codec<SilentiaislandFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("silentiaisland_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public SilentiaislandFruitDecorator() {
		super(0.2f);
	}
