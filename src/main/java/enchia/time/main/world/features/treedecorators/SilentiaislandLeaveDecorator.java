...
public class SilentiaislandLeaveDecorator extends LeaveVineDecorator {
	public static final SilentiaislandLeaveDecorator INSTANCE = new SilentiaislandLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("silentiaisland_tree_leave_decorator");
