...
public class SilentiaislandTrunkDecorator extends TrunkVineDecorator {
	public static final SilentiaislandTrunkDecorator INSTANCE = new SilentiaislandTrunkDecorator();
	public static com.mojang.serialization.Codec<SilentiaislandTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("silentiaisland_tree_trunk_decorator");
