...
public class SukuraPlainsFruitDecorator extends CocoaDecorator {
	public static final SukuraPlainsFruitDecorator INSTANCE = new SukuraPlainsFruitDecorator();
	public static com.mojang.serialization.Codec<SukuraPlainsFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("sukura_plains_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public SukuraPlainsFruitDecorator() {
		super(0.2f);
	}
