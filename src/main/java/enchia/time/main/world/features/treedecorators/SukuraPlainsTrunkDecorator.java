...
public class SukuraPlainsTrunkDecorator extends TrunkVineDecorator {
	public static final SukuraPlainsTrunkDecorator INSTANCE = new SukuraPlainsTrunkDecorator();
	public static com.mojang.serialization.Codec<SukuraPlainsTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("sukura_plains_tree_trunk_decorator");
