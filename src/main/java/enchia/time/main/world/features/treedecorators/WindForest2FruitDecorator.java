...
public class WindForest2FruitDecorator extends CocoaDecorator {
	public static final WindForest2FruitDecorator INSTANCE = new WindForest2FruitDecorator();
	public static com.mojang.serialization.Codec<WindForest2FruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("wind_forest_2_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public WindForest2FruitDecorator() {
		super(0.2f);
	}
