...
public class WindForest2TrunkDecorator extends TrunkVineDecorator {
	public static final WindForest2TrunkDecorator INSTANCE = new WindForest2TrunkDecorator();
	public static com.mojang.serialization.Codec<WindForest2TrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("wind_forest_2_tree_trunk_decorator");
