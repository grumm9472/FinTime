...
public class WindForestFruitDecorator extends CocoaDecorator {
	public static final WindForestFruitDecorator INSTANCE = new WindForestFruitDecorator();
	public static com.mojang.serialization.Codec<WindForestFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("wind_forest_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public WindForestFruitDecorator() {
		super(0.2f);
	}
