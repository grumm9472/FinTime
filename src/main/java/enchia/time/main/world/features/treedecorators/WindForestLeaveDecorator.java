...
public class WindForestLeaveDecorator extends LeaveVineDecorator {
	public static final WindForestLeaveDecorator INSTANCE = new WindForestLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("wind_forest_tree_leave_decorator");
