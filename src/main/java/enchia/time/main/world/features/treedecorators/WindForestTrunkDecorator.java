...
public class WindForestTrunkDecorator extends TrunkVineDecorator {
	public static final WindForestTrunkDecorator INSTANCE = new WindForestTrunkDecorator();
	public static com.mojang.serialization.Codec<WindForestTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("wind_forest_tree_trunk_decorator");
