...
package enchia.time.main.world.inventory;
...
import enchia.time.main.init.TimeModMenus;

public class CauldonGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CauldonGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TimeModMenus.CAULDON_GUI, id);
