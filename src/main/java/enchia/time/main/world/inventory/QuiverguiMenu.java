...
public class QuiverguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public QuiverguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TimeModMenus.QUIVERGUI, id);
