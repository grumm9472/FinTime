...
public class ScrollBenchGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ScrollBenchGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TimeModMenus.SCROLL_BENCH_GUI, id);
