...
public class AcidBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:acid")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("time:acid_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;

	public AcidBlock(TimeModElements instance) {
		super(instance, 510);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("time:blocks/newwater1600"), new ResourceLocation("time:blocks/newwater1600"))
						.luminosity(100).density(1000).viscosity(1000).temperature(300)
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:acid_lakes"), configuredFeature);
		}
	}
