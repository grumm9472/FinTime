...
public class AmethystBricksBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:amethyst_bricks")
	public static final Block block = null;

	public AmethystBricksBlock(TimeModElements instance) {
		super(instance, 359);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("amethyst_bricks");
		}
