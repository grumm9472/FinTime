...
public class AmethystOreBlockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:amethyst_ore_block")
	public static final Block block = null;

	public AmethystOreBlockBlock(TimeModElements instance) {
		super(instance, 384);
	}
