...
public class AppleBlockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:apple_block")
	public static final Block block = null;

	public AppleBlockBlock(TimeModElements instance) {
		super(instance, 271);
	}
