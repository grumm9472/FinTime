...
public class AquamarineOreBlockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:aquamarine_ore_block")
	public static final Block block = null;

	public AquamarineOreBlockBlock(TimeModElements instance) {
		super(instance, 387);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aquamarine_ore_block");
		}
