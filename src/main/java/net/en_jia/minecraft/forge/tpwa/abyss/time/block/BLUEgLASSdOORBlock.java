...
public class BLUEgLASSdOORBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:blu_eg_las_sd_oor")
	public static final Block block = null;

	public BLUEgLASSdOORBlock(TimeModElements instance) {
		super(instance, 696);
	}
