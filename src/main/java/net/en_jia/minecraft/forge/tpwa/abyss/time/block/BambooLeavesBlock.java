...
public class BambooLeavesBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:bamboo_leaves")
	public static final Block block = null;

	public BambooLeavesBlock(TimeModElements instance) {
		super(instance, 291);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.LEAVES).sound(SoundType.PLANT).hardnessAndResistance(0.05f, 10f).setLightLevel(s -> 0).notSolid());
