...
public class BambooLogBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:bamboo_log")
	public static final Block block = null;

	public BambooLogBlock(TimeModElements instance) {
		super(instance, 323);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(0.45f, 10f).setLightLevel(s -> 0).harvestLevel(1)
					.harvestTool(ToolType.AXE).setRequiresTool());
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("bamboo_log");
		}
