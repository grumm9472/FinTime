...
public class BambooLogFenceBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:bamboo_log_fence")
	public static final Block block = null;

	public BambooLogFenceBlock(TimeModElements instance) {
		super(instance, 524);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("bamboo_log_fence");
		}
