...
public class BambooLogFenceGateBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:bamboo_log_fence_gate")
	public static final Block block = null;

	public BambooLogFenceGateBlock(TimeModElements instance) {
		super(instance, 525);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("bamboo_log_fence_gate");
		}
