...
public class BambooLogPlanksBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:bamboo_log_planks")
	public static final Block block = null;

	public BambooLogPlanksBlock(TimeModElements instance) {
		super(instance, 632);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bamboo_log_planks");
		}
