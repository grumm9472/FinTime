...
public class BambooLogSlabBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:bamboo_log_slab")
	public static final Block block = null;

	public BambooLogSlabBlock(TimeModElements instance) {
		super(instance, 523);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("bamboo_log_slab");
		}
