...
public class BambooLogStairsBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:bamboo_log_stairs")
	public static final Block block = null;

	public BambooLogStairsBlock(TimeModElements instance) {
		super(instance, 522);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("bamboo_log_stairs");
		}
