...
public class BambooLogWoodBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:bamboo_log_wood")
	public static final Block block = null;

	public BambooLogWoodBlock(TimeModElements instance) {
		super(instance, 313);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bamboo_log_wood");
		}
