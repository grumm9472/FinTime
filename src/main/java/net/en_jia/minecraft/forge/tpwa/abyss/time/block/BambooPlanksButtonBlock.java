...
public class BambooPlanksButtonBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:bamboo_planks_button")
	public static final Block block = null;

	public BambooPlanksButtonBlock(TimeModElements instance) {
		super(instance, 829);
	}
