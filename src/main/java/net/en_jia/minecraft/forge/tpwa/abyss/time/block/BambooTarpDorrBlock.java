...
public class BambooTarpDorrBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:bamboo_tarp_dorr")
	public static final Block block = null;

	public BambooTarpDorrBlock(TimeModElements instance) {
		super(instance, 567);
	}
