...
public class BellFlowerBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:bell_flower")
	public static final Block block = null;

	public BellFlowerBlock(TimeModElements instance) {
		super(instance, 605);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("bell_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:bell_flower"), configuredFeature);
		}
	}
