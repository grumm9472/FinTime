...
public class BlackCutSandstoneBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:black_cut_sandstone")
	public static final Block block = null;

	public BlackCutSandstoneBlock(TimeModElements instance) {
		super(instance, 342);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("black_cut_sandstone");
		}
