...
public class BlackEternalRedstoneLampBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:black_eternal_redstone_lamp")
	public static final Block block = null;

	public BlackEternalRedstoneLampBlock(TimeModElements instance) {
		super(instance, 739);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("black_eternal_redstone_lamp");
		}
