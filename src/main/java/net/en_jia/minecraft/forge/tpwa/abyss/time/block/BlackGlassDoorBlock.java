...
public class BlackGlassDoorBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:black_glass_door")
	public static final Block block = null;

	public BlackGlassDoorBlock(TimeModElements instance) {
		super(instance, 703);
	}
