...
public class BlackSandBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:black_sand")
	public static final Block block = null;

	public BlackSandBlock(TimeModElements instance) {
		super(instance, 344);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("time:black_sand_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:black_sand"), configuredFeature);
		}
	}
