...
public class BlackSandStoneBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:black_sand_stone")
	public static final Block block = null;

	public BlackSandStoneBlock(TimeModElements instance) {
		super(instance, 343);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("black_sand_stone");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("time:black_sand_stone_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("black_sand_stone"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:black_sand_stone"), configuredFeature);
		}
	}
