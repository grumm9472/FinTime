...
public class BloodstoneblockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:bloodstoneblock")
	public static final Block block = null;

	public BloodstoneblockBlock(TimeModElements instance) {
		super(instance, 376);
	}
