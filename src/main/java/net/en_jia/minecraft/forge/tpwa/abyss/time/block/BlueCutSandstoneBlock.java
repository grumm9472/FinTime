...
public class BlueCutSandstoneBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:blue_cut_sandstone")
	public static final Block block = null;

	public BlueCutSandstoneBlock(TimeModElements instance) {
		super(instance, 816);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blue_cut_sandstone");
		}
