...
public class BlueSandBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:blue_sand")
	public static final Block block = null;

	public BlueSandBlock(TimeModElements instance) {
		super(instance, 814);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("time:blue_sand_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:blue_sand"), configuredFeature);
		}
	}
