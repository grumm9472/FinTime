...
public class BossbrickBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:bossbrick")
	public static final Block block = null;

	public BossbrickBlock(TimeModElements instance) {
		super(instance, 445);
	}
