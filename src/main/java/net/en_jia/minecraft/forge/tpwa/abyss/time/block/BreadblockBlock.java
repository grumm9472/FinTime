...
public class BreadblockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:breadblock")
	public static final Block block = null;

	public BreadblockBlock(TimeModElements instance) {
		super(instance, 357);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.CAKE).sound(SoundType.GROUND).hardnessAndResistance(0.5f, 10f).setLightLevel(s -> 0));
