...
public class BrownGlassDoorBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:brown_glass_door")
	public static final Block block = null;

	public BrownGlassDoorBlock(TimeModElements instance) {
		super(instance, 708);
	}
