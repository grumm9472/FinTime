...
public class Cactus2Block extends TimeModElements.ModElement {
	@ObjectHolder("time:cactus_2")
	public static final Block block = null;

	public Cactus2Block(TimeModElements instance) {
		super(instance, 600);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("cactus_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:cactus_2"), configuredFeature);
		}
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (new ResourceLocation("time:cactus_forest").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
