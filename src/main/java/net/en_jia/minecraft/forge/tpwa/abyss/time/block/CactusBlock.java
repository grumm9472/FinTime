...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.CactusMobplayerCollidesWithPlantProcedure;
...
public class CactusBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:cactus")
	public static final Block block = null;

	public CactusBlock(TimeModElements instance) {
		super(instance, 584);
	...
	public void initElements() {
		...
		elements.items.add(() -> new TallBlockItem(block, new Item.Properties().group(TIMEItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("cactus"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:cactus"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends DoublePlantBlock {
		...
		public void onEntityCollision(BlockState blockstate, World world, BlockPos pos, Entity entity) {
			...
			CactusMobplayerCollidesWithPlantProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
