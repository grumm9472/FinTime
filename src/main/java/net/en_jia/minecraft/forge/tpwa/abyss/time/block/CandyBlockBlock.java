...
import net.en_jia.minecraft.forge.tpwa.abyss.time.item.CandyItem;
...
public class CandyBlockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:candy_block")
	public static final Block block = null;

	public CandyBlockBlock(TimeModElements instance) {
		super(instance, 280);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CandyItem.block));
		}
	}
}
