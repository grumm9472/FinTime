...
public class CandyBrickBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:candy_brick")
	public static final Block block = null;

	public CandyBrickBlock(TimeModElements instance) {
		super(instance, 358);
	}
