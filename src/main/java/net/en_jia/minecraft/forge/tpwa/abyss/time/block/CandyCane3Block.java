...
import net.en_jia.minecraft.forge.tpwa.abyss.time.item.CandyCane1Item;
...
public class CandyCane3Block extends TimeModElements.ModElement {
	@ObjectHolder("time:candy_cane_3")
	public static final Block block = null;

	public CandyCane3Block(TimeModElements instance) {
		super(instance, 324);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CandyCane1Item.block, (int) (4)));
		}
	}
}
