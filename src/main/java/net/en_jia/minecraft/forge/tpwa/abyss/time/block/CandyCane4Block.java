...
import net.en_jia.minecraft.forge.tpwa.abyss.time.item.CandyCane2RelItem;
...
public class CandyCane4Block extends TimeModElements.ModElement {
	@ObjectHolder("time:candy_cane_4")
	public static final Block block = null;

	public CandyCane4Block(TimeModElements instance) {
		super(instance, 327);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CandyCane2RelItem.block, (int) (4)));
		}
	}
}
