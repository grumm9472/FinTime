...
public class CandyCane6Block extends TimeModElements.ModElement {
	@ObjectHolder("time:candy_cane_6")
	public static final Block block = null;

	public CandyCane6Block(TimeModElements instance) {
		super(instance, 328);
	}
