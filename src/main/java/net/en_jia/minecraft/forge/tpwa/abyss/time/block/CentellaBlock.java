...
public class CentellaBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:centella")
	public static final Block block = null;

	public CentellaBlock(TimeModElements instance) {
		super(instance, 576);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("centella"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:centella"), configuredFeature);
		}
	}
