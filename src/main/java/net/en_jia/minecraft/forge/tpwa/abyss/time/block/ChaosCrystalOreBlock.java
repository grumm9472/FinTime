...
public class ChaosCrystalOreBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:chaos_crystal_ore")
	public static final Block block = null;

	public ChaosCrystalOreBlock(TimeModElements instance) {
		super(instance, 216);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(ChaosCrystalItem.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("time:chaos_crystal_ore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("chaos_crystal_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:chaos_crystal_ore"), configuredFeature);
		}
	}
