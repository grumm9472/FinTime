...
public class CherryFenceBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:cherry_fence")
	public static final Block block = null;

	public CherryFenceBlock(TimeModElements instance) {
		super(instance, 544);
	}
