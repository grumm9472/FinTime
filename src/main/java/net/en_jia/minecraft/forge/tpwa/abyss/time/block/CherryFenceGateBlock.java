...
public class CherryFenceGateBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:cherry_fence_gate")
	public static final Block block = null;

	public CherryFenceGateBlock(TimeModElements instance) {
		super(instance, 545);
	}
