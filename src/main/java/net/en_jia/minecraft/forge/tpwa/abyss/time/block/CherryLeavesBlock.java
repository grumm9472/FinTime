...
public class CherryLeavesBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:cherry_leaves")
	public static final Block block = null;

	public CherryLeavesBlock(TimeModElements instance) {
		super(instance, 296);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.LEAVES).sound(SoundType.PLANT).hardnessAndResistance(0.2f, 0.2f).setLightLevel(s -> 10)
					.notSolid());
