...
public class CherryPlanksButtonBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:cherry_planks_button")
	public static final Block block = null;

	public CherryPlanksButtonBlock(TimeModElements instance) {
		super(instance, 831);
	}
