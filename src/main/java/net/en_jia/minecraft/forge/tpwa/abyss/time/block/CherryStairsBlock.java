...
public class CherryStairsBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:cherry_stairs")
	public static final Block block = null;

	public CherryStairsBlock(TimeModElements instance) {
		super(instance, 542);
	}
