...
public class ClassicCobbleStoneBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:classic_cobble_stone")
	public static final Block block = null;

	public ClassicCobbleStoneBlock(TimeModElements instance) {
		super(instance, 349);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("classic_cobble_stone");
		}
