...
public class ClassicDiamondBlockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:classic_diamond_block")
	public static final Block block = null;

	public ClassicDiamondBlockBlock(TimeModElements instance) {
		super(instance, 370);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("classic_diamond_block");
		}
