...
public class ClassicFenceBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:classic_fence")
	public static final Block block = null;

	public ClassicFenceBlock(TimeModElements instance) {
		super(instance, 528);
	}
