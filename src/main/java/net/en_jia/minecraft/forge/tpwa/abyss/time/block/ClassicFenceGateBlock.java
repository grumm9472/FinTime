...
public class ClassicFenceGateBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:classic_fence_gate")
	public static final Block block = null;

	public ClassicFenceGateBlock(TimeModElements instance) {
		super(instance, 529);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("classic_fence_gate");
		}
