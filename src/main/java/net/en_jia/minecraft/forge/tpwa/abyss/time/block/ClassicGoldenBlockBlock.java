...
public class ClassicGoldenBlockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:classic_golden_block")
	public static final Block block = null;

	public ClassicGoldenBlockBlock(TimeModElements instance) {
		super(instance, 371);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("classic_golden_block");
		}
