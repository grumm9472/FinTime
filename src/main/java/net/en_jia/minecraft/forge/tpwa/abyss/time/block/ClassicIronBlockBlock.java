...
public class ClassicIronBlockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:classic_iron_block")
	public static final Block block = null;

	public ClassicIronBlockBlock(TimeModElements instance) {
		super(instance, 372);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("classic_iron_block");
		}
