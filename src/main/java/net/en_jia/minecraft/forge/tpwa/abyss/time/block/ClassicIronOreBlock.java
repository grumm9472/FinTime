...
public class ClassicIronOreBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:classic_iron_ore")
	public static final Block block = null;

	public ClassicIronOreBlock(TimeModElements instance) {
		super(instance, 228);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("classic_iron_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("time:classic_iron_ore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("classic_iron_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:classic_iron_ore"), configuredFeature);
		}
	}
