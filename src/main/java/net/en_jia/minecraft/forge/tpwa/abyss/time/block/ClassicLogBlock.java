...
public class ClassicLogBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:classic_log")
	public static final Block block = null;

	public ClassicLogBlock(TimeModElements instance) {
		super(instance, 307);
	}
