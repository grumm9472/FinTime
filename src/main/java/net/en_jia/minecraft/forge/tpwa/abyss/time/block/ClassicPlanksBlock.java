...
public class ClassicPlanksBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:classic_planks")
	public static final Block block = null;

	public ClassicPlanksBlock(TimeModElements instance) {
		super(instance, 331);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("classic_planks");
		}
