...
public class ClassicPlanksButtonBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:classic_planks_button")
	public static final Block block = null;

	public ClassicPlanksButtonBlock(TimeModElements instance) {
		super(instance, 830);
	}
