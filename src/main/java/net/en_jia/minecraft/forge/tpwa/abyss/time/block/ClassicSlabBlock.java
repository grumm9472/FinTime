...
public class ClassicSlabBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:classic_slab")
	public static final Block block = null;

	public ClassicSlabBlock(TimeModElements instance) {
		super(instance, 527);
	}
