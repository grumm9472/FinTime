...
public class ClassicStairsBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:classic_stairs")
	public static final Block block = null;

	public ClassicStairsBlock(TimeModElements instance) {
		super(instance, 526);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("classic_stairs");
		}
