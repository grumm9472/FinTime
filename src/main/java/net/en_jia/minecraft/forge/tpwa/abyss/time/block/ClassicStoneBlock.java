...
public class ClassicStoneBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:classic_stone")
	public static final Block block = null;

	public ClassicStoneBlock(TimeModElements instance) {
		super(instance, 348);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(ClassicCobbleStoneBlock.block));
		}
	}
}
