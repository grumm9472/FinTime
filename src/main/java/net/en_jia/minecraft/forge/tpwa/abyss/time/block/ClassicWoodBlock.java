...
public class ClassicWoodBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:classic_wood")
	public static final Block block = null;

	public ClassicWoodBlock(TimeModElements instance) {
		super(instance, 308);
	}
