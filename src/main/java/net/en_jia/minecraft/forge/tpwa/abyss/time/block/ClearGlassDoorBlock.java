...
public class ClearGlassDoorBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:clear_glass_door")
	public static final Block block = null;

	public ClearGlassDoorBlock(TimeModElements instance) {
		super(instance, 704);
	}
