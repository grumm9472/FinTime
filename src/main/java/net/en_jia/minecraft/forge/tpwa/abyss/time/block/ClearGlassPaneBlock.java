...
public class ClearGlassPaneBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:clear_glass_pane")
	public static final Block block = null;

	public ClearGlassPaneBlock(TimeModElements instance) {
		super(instance, 442);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("clear_glass_pane");
		}
