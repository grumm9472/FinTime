...
public class CloudBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:cloud")
	public static final Block block = null;

	public CloudBlock(TimeModElements instance) {
		super(instance, 299);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.WATER).sound(SoundType.SNOW).hardnessAndResistance(0.1f, 10f).setLightLevel(s -> 0)
					.slipperiness(0.1f));
