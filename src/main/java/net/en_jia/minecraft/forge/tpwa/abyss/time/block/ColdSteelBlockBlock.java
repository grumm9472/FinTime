...
public class ColdSteelBlockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:cold_steel_block")
	public static final Block block = null;

	public ColdSteelBlockBlock(TimeModElements instance) {
		super(instance, 385);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cold_steel_block");
		}
