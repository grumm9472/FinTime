...
public class CompressGoldBlockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:compress_gold_block")
	public static final Block block = null;

	public CompressGoldBlockBlock(TimeModElements instance) {
		super(instance, 375);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("compress_gold_block");
		}
