...
public class ControlleroffBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:controlleroff")
	public static final Block block = null;

	public ControlleroffBlock(TimeModElements instance) {
		super(instance, 446);
	}
