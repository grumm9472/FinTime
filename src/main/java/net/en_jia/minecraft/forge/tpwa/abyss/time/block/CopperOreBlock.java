...
public class CopperOreBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:copper_ore")
	public static final Block block = null;

	public CopperOreBlock(TimeModElements instance) {
		super(instance, 203);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("time:copper_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:copper_ore"), configuredFeature);
		}
	}
