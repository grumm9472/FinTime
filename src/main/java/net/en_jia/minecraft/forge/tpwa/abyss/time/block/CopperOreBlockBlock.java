...
public class CopperOreBlockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:copper_ore_block")
	public static final Block block = null;

	public CopperOreBlockBlock(TimeModElements instance) {
		super(instance, 379);
	}
