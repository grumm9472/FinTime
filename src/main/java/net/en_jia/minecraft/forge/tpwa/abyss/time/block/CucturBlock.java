...
public class CucturBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:cuctur")
	public static final Block block = null;

	public CucturBlock(TimeModElements instance) {
		super(instance, 601);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("cuctur"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:cuctur"), configuredFeature);
		}
	}
