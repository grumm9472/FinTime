...
public class DesertDiamondOreBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:desert_diamond_ore")
	public static final Block block = null;

	public DesertDiamondOreBlock(TimeModElements instance) {
		super(instance, 207);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("desert_diamond_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("time:desert_diamond_ore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("desert_diamond_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:desert_diamond_ore"), configuredFeature);
		}
	}
