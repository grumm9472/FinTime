...
public class DesertEmeraldOreBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:desert_emerald_ore")
	public static final Block block = null;

	public DesertEmeraldOreBlock(TimeModElements instance) {
		super(instance, 206);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("desert_emerald_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("time:desert_emerald_ore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("desert_emerald_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:desert_emerald_ore"), configuredFeature);
		}
	}
