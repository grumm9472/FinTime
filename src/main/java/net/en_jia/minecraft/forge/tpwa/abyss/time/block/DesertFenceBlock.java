...
public class DesertFenceBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:desert_fence")
	public static final Block block = null;

	public DesertFenceBlock(TimeModElements instance) {
		super(instance, 516);
	}
