...
public class DesertFenceGateBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:desert_fence_gate")
	public static final Block block = null;

	public DesertFenceGateBlock(TimeModElements instance) {
		super(instance, 517);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("desert_fence_gate");
		}
