...
public class DesertLogBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:desert_log")
	public static final Block block = null;

	public DesertLogBlock(TimeModElements instance) {
		super(instance, 306);
	}
