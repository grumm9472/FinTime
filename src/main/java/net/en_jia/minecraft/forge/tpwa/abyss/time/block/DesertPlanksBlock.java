...
public class DesertPlanksBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:desert_planks")
	public static final Block block = null;

	public DesertPlanksBlock(TimeModElements instance) {
		super(instance, 630);
	}
