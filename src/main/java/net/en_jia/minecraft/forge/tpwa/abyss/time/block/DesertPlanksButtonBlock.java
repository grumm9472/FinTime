...
public class DesertPlanksButtonBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:desert_planks_button")
	public static final Block block = null;

	public DesertPlanksButtonBlock(TimeModElements instance) {
		super(instance, 833);
	}
