...
public class DesertSlabBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:desert_slab")
	public static final Block block = null;

	public DesertSlabBlock(TimeModElements instance) {
		super(instance, 515);
	}
