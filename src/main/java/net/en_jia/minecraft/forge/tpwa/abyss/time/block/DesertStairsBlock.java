...
public class DesertStairsBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:desert_stairs")
	public static final Block block = null;

	public DesertStairsBlock(TimeModElements instance) {
		super(instance, 514);
	}
