...
public class DesertWoodBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:desert_wood")
	public static final Block block = null;

	public DesertWoodBlock(TimeModElements instance) {
		super(instance, 300);
	}
