...
public class DreamGrassBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:dream_grass")
	public static final Block block = null;

	public DreamGrassBlock(TimeModElements instance) {
		super(instance, 251);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.EARTH).sound(SoundType.GROUND).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0).harvestLevel(1)
					.harvestTool(ToolType.SHOVEL).setRequiresTool().slipperiness(0.7f));
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(DreamDirtBlock.block));
		}
	}
}
