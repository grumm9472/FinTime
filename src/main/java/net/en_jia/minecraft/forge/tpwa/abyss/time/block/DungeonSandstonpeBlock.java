...
public class DungeonSandstonpeBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:dungeon_sandstonpe")
	public static final Block block = null;

	public DungeonSandstonpeBlock(TimeModElements instance) {
		super(instance, 800);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dungeon_sandstonpe");
		}
