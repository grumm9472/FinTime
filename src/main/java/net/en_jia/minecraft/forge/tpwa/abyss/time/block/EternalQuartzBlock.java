...
public class EternalQuartzBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:eternal_quartz")
	public static final Block block = null;

	public EternalQuartzBlock(TimeModElements instance) {
		super(instance, 723);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("eternal_quartz");
		}
