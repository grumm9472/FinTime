...
public class Ether2Block extends TimeModElements.ModElement {
	@ObjectHolder("time:ether_2")
	public static final Block block = null;

	public Ether2Block(TimeModElements instance) {
		super(instance, 592);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ether_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:ether_2"), configuredFeature);
		}
	}
