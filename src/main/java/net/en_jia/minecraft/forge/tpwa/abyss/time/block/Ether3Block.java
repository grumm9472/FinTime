...
public class Ether3Block extends TimeModElements.ModElement {
	@ObjectHolder("time:ether_3")
	public static final Block block = null;

	public Ether3Block(TimeModElements instance) {
		super(instance, 591);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ether_3"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:ether_3"), configuredFeature);
		}
	}
