...
public class Ether4Block extends TimeModElements.ModElement {
	@ObjectHolder("time:ether_4")
	public static final Block block = null;

	public Ether4Block(TimeModElements instance) {
		super(instance, 590);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ether_4"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:ether_4"), configuredFeature);
		}
	}
