...
public class Ether5Block extends TimeModElements.ModElement {
	@ObjectHolder("time:ether_5")
	public static final Block block = null;

	public Ether5Block(TimeModElements instance) {
		super(instance, 588);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ether_5"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:ether_5"), configuredFeature);
		}
	}
