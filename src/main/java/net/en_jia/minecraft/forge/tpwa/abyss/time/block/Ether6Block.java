...
public class Ether6Block extends TimeModElements.ModElement {
	@ObjectHolder("time:ether_6")
	public static final Block block = null;

	public Ether6Block(TimeModElements instance) {
		super(instance, 589);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ether_6"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:ether_6"), configuredFeature);
		}
	}
