...
public class FakeBedrockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:fake_bedrock")
	public static final Block block = null;

	public FakeBedrockBlock(TimeModElements instance) {
		super(instance, 351);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("time:fake_bedrock_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("fake_bedrock"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:fake_bedrock"), configuredFeature);
		}
	}
