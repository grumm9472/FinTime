...
public class FakeStoneBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:fake_stone")
	public static final Block block = null;

	public FakeStoneBlock(TimeModElements instance) {
		super(instance, 633);
	}
