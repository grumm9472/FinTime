...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.Fire2BlockDestroyedByPlayerProcedure;
...
public class Fire2Block extends TimeModElements.ModElement {
	@ObjectHolder("time:fire_2")
	public static final Block block = null;

	public Fire2Block(TimeModElements instance) {
		super(instance, 461);
	}
	...
	public static class CustomBlock extends Block {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			Fire2BlockDestroyedByPlayerProcedure.executeProcedure(Stream
