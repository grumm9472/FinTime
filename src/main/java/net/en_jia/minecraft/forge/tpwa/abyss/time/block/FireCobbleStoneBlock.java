...
public class FireCobbleStoneBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:fire_cobble_stone")
	public static final Block block = null;

	public FireCobbleStoneBlock(TimeModElements instance) {
		super(instance, 728);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("fire_cobble_stone");
		}
