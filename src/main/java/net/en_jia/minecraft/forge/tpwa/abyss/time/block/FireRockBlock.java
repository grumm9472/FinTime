...
public class FireRockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:fire_rock")
	public static final Block block = null;

	public FireRockBlock(TimeModElements instance) {
		super(instance, 727);
	}
