...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.FlintBlockOnBlockRightClickedProcedure;
...
public class FlintBlockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:flint_block")
	public static final Block block = null;

	public FlintBlockBlock(TimeModElements instance) {
		super(instance, 392);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			FlintBlockOnBlockRightClickedProcedure.executeProcedure(Stream
