...
public class FragileGhoulStoneBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:fragile_ghoul_stone")
	public static final Block block = null;

	public FragileGhoulStoneBlock(TimeModElements instance) {
		super(instance, 355);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("fragile_ghoul_stone");
		}
	...
	private static class CustomRuleTest extends RuleTest {
		...
		public boolean test(BlockState blockAt, Random random) {
			...
			if (blockAt.getBlock() == Blocks.STONE)
				blockCriteria = true;
			if (blockAt.getBlock() == GhoulStoneBlock.block)
				blockCriteria = true;
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("time:fragile_ghoul_stone_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("fragile_ghoul_stone"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:fragile_ghoul_stone"), configuredFeature);
		}
	}
