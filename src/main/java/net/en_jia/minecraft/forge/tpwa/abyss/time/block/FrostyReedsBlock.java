...
public class FrostyReedsBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:frosty_reeds")
	public static final Block block = null;

	public FrostyReedsBlock(TimeModElements instance) {
		super(instance, 586);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("frosty_reeds"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:frosty_reeds"), configuredFeature);
		}
	}
