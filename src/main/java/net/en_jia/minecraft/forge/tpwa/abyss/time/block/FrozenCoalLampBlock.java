...
public class FrozenCoalLampBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:frozen_coal_lamp")
	public static final Block block = null;

	public FrozenCoalLampBlock(TimeModElements instance) {
		super(instance, 738);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.GLASS).sound(SoundType.GLASS).hardnessAndResistance(0.3f, 10f).setLightLevel(s -> 13)
