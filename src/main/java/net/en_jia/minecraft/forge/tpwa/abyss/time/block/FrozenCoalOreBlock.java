...
public class FrozenCoalOreBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:frozen_coal_ore")
	public static final Block block = null;

	public FrozenCoalOreBlock(TimeModElements instance) {
		super(instance, 197);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("frozen_coal_ore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(FrozenCoalfuelItem.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("time:frozen_coal_ore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("frozen_coal_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:frozen_coal_ore"), configuredFeature);
		}
	}
