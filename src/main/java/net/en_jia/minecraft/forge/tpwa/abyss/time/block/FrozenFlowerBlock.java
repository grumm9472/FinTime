...
public class FrozenFlowerBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:frozen_flower")
	public static final Block block = null;

	public FrozenFlowerBlock(TimeModElements instance) {
		super(instance, 602);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("frozen_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:frozen_flower"), configuredFeature);
		}
	}
