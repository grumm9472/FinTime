...
public class GhoulItemPlant2Block extends TimeModElements.ModElement {
	@ObjectHolder("time:ghoul_item_plant_2")
	public static final Block block = null;

	public GhoulItemPlant2Block(TimeModElements instance) {
		super(instance, 593);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ghoul_item_plant_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:ghoul_item_plant_2"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("ghoul_item_plant_2");
		}
