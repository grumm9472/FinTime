...
public class GhoulLampBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:ghoul_lamp")
	public static final Block block = null;

	public GhoulLampBlock(TimeModElements instance) {
		super(instance, 746);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.GLASS).sound(SoundType.GLASS).hardnessAndResistance(1f, 10f).setLightLevel(s -> 15)
					.speedFactor(0.1f).notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("ghoul_lamp");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("time:ghoul_lamp_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("ghoul_lamp"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:ghoul_lamp"), configuredFeature);
		}
	}
