...
public class GhoulLogBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:ghoul_log")
	public static final Block block = null;

	public GhoulLogBlock(TimeModElements instance) {
		super(instance, 325);
	}
