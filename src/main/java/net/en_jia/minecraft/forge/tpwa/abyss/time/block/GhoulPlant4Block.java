...
public class GhoulPlant4Block extends TimeModElements.ModElement {
	@ObjectHolder("time:ghoul_plant_4")
	public static final Block block = null;

	public GhoulPlant4Block(TimeModElements instance) {
		super(instance, 599);
	}
