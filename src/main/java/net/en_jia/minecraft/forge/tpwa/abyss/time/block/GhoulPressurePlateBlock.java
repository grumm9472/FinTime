...
public class GhoulPressurePlateBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:ghoul_pressure_plate")
	public static final Block block = null;

	public GhoulPressurePlateBlock(TimeModElements instance) {
		super(instance, 513);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			super(Sensitivity.EVERYTHING, Block.Properties.create(Material.WOOD).sound(SoundType.WOOD)
					.hardnessAndResistance(4.4f, 6.6000000000000005f).setLightLevel(s -> 0));
			setRegistryName("ghoul_pressure_plate");
		}
