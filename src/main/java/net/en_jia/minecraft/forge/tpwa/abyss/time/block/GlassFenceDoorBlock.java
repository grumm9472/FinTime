...
public class GlassFenceDoorBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:glass_fence_door")
	public static final Block block = null;

	public GlassFenceDoorBlock(TimeModElements instance) {
		super(instance, 720);
	}
