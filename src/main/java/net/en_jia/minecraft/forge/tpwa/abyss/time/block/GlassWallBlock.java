...
public class GlassWallBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:glass_wall")
	public static final Block block = null;

	public GlassWallBlock(TimeModElements instance) {
		super(instance, 721);
	}
