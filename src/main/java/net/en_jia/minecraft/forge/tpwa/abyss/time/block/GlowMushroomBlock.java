...
public class GlowMushroomBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:glow_mushroom")
	public static final Block block = null;

	public GlowMushroomBlock(TimeModElements instance) {
		super(instance, 575);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("glow_mushroom"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:glow_mushroom"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.GROUND)
					.hardnessAndResistance(0f, 0f).setLightLevel(s -> 15));
			setRegistryName("glow_mushroom");
		}
