...
public class GlowStoneBrickBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:glow_stone_brick")
	public static final Block block = null;

	public GlowStoneBrickBlock(TimeModElements instance) {
		super(instance, 758);
	}
