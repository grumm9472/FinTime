...
public class Glowshroom2Block extends TimeModElements.ModElement {
	@ObjectHolder("time:glowshroom_2")
	public static final Block block = null;

	public Glowshroom2Block(TimeModElements instance) {
		super(instance, 579);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("glowshroom_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:glowshroom_2"), configuredFeature);
		}
	}
