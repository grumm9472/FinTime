...
public class GlowstoneBricksDoorBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:glowstone_bricks_door")
	public static final Block block = null;

	public GlowstoneBricksDoorBlock(TimeModElements instance) {
		super(instance, 566);
	}
