...
public class GoldenAppleBlockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:golden_apple_block")
	public static final Block block = null;

	public GoldenAppleBlockBlock(TimeModElements instance) {
		super(instance, 272);
	}
