...
public class GoldenCoalOreBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:golden_coal_ore")
	public static final Block block = null;

	public GoldenCoalOreBlock(TimeModElements instance) {
		super(instance, 210);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("golden_coal_ore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(GoldenCoalItem.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("time:golden_coal_ore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("golden_coal_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:golden_coal_ore"), configuredFeature);
		}
	}
