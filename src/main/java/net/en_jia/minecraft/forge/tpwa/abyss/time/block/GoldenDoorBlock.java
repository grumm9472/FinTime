...
public class GoldenDoorBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:golden_door")
	public static final Block block = null;

	public GoldenDoorBlock(TimeModElements instance) {
		super(instance, 692);
	}
