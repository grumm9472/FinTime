...
public class HardboneOreBlockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:hardbone_ore_block")
	public static final Block block = null;

	public HardboneOreBlockBlock(TimeModElements instance) {
		super(instance, 380);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("hardbone_ore_block");
		}
