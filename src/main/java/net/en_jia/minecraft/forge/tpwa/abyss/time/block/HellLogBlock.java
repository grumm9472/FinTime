...
public class HellLogBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:hell_log")
	public static final Block block = null;

	public HellLogBlock(TimeModElements instance) {
		super(instance, 302);
	}
