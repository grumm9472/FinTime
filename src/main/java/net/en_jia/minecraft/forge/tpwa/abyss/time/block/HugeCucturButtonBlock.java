...
public class HugeCucturButtonBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:huge_cuctur_button")
	public static final Block block = null;

	public HugeCucturButtonBlock(TimeModElements instance) {
		super(instance, 824);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("huge_cuctur_button");
		}
