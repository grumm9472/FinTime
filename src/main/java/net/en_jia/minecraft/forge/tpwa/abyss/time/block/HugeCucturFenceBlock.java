...
public class HugeCucturFenceBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:huge_cuctur_fence")
	public static final Block block = null;

	public HugeCucturFenceBlock(TimeModElements instance) {
		super(instance, 533);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("huge_cuctur_fence");
		}
