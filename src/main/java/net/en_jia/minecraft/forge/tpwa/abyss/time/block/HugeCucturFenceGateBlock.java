...
public class HugeCucturFenceGateBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:huge_cuctur_fence_gate")
	public static final Block block = null;

	public HugeCucturFenceGateBlock(TimeModElements instance) {
		super(instance, 534);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("huge_cuctur_fence_gate");
		}
