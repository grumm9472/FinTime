...
public class HugeCucturLogBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:huge_cuctur_log")
	public static final Block block = null;

	public HugeCucturLogBlock(TimeModElements instance) {
		super(instance, 312);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("huge_cuctur_log");
		}
