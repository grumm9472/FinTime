...
public class HugeCucturPlanksBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:huge_cuctur_planks")
	public static final Block block = null;

	public HugeCucturPlanksBlock(TimeModElements instance) {
		super(instance, 531);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("huge_cuctur_planks");
		}
