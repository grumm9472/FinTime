...
public class HugeCucturPressurePlateBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:huge_cuctur_pressure_plate")
	public static final Block block = null;

	public HugeCucturPressurePlateBlock(TimeModElements instance) {
		super(instance, 535);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("huge_cuctur_pressure_plate");
		}
