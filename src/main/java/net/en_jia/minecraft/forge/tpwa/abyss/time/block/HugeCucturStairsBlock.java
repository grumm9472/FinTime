...
public class HugeCucturStairsBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:huge_cuctur_stairs")
	public static final Block block = null;

	public HugeCucturStairsBlock(TimeModElements instance) {
		super(instance, 530);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("huge_cuctur_stairs");
		}
