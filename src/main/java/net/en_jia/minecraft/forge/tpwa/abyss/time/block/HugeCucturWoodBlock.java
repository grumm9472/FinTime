...
public class HugeCucturWoodBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:huge_cuctur_wood")
	public static final Block block = null;

	public HugeCucturWoodBlock(TimeModElements instance) {
		super(instance, 309);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("huge_cuctur_wood");
		}
