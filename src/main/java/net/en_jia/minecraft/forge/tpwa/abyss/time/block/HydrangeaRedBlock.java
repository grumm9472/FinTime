...
public class HydrangeaRedBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:hydrangea_red")
	public static final Block block = null;

	public HydrangeaRedBlock(TimeModElements instance) {
		super(instance, 603);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("hydrangea_red"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:hydrangea_red"), configuredFeature);
		}
	}
