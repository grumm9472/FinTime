...
public class IceBricksBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:ice_bricks")
	public static final Block block = null;

	public IceBricksBlock(TimeModElements instance) {
		super(instance, 458);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.GLASS).hardnessAndResistance(-1, 3600000).setLightLevel(s -> 0)
