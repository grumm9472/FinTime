...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.MagicrBlockDestroyedByPlayerProcedure;
...
public class IceCrystalBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:ice_crystal")
	public static final Block block = null;

	public IceCrystalBlock(TimeModElements instance) {
		super(instance, 366);
	...
	public static class CustomBlock extends Block {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			MagicrBlockDestroyedByPlayerProcedure.executeProcedure(Stream
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("time:ice_crystal_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("ice_crystal"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:ice_crystal"), configuredFeature);
		}
	}
