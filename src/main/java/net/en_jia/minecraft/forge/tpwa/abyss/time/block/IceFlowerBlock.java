...
public class IceFlowerBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:ice_flower")
	public static final Block block = null;

	public IceFlowerBlock(TimeModElements instance) {
		super(instance, 583);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ice_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:ice_flower"), configuredFeature);
		}
	}
