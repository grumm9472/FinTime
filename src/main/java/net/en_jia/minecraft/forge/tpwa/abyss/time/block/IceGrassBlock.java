...
public class IceGrassBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:ice_grass")
	public static final Block block = null;

	public IceGrassBlock(TimeModElements instance) {
		super(instance, 573);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ice_grass"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:ice_grass"), configuredFeature);
		}
	}
