...
public class IcePlanksButtonBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:ice_planks_button")
	public static final Block block = null;

	public IcePlanksButtonBlock(TimeModElements instance) {
		super(instance, 828);
	}
