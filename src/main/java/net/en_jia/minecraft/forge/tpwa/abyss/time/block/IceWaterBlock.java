...
public class IceWaterBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:ice_water")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("time:ice_water_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;

	public IceWaterBlock(TimeModElements instance) {
		super(instance, 509);
	...
	public void initElements() {
		...
		still = (FlowingFluid) new ForgeFlowingFluid.Source(fluidproperties).setRegistryName("ice_water");
		flowing = (FlowingFluid) new ForgeFlowingFluid.Flowing(fluidproperties).setRegistryName("ice_water_flowing");
		elements.blocks
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ice_water_lakes"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:ice_water_lakes"), configuredFeature);
		}
	}
