...
public class IchorBlockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:ichor_block")
	public static final Block block = null;

	public IchorBlockBlock(TimeModElements instance) {
		super(instance, 391);
	}
