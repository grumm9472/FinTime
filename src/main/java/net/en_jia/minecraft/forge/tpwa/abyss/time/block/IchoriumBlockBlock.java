...
public class IchoriumBlockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:ichorium_block")
	public static final Block block = null;

	public IchoriumBlockBlock(TimeModElements instance) {
		super(instance, 374);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ichorium_block");
		}
