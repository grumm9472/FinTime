...
import net.en_jia.minecraft.forge.tpwa.abyss.time.item.IchoriumItem;
...
public class IchoriumOreBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:ichorium_ore")
	public static final Block block = null;

	public IchoriumOreBlock(TimeModElements instance) {
		super(instance, 213);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(IchoriumItem.block));
		}
	}
}
