...
public class ItemBlockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:item_block")
	public static final Block block = null;

	public ItemBlockBlock(TimeModElements instance) {
		super(instance, 1951);
	}
