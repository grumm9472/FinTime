...
import net.en_jia.minecraft.forge.tpwa.abyss.time.item.JadeGemItem;
...
public class JadeOreBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:jade_ore")
	public static final Block block = null;

	public JadeOreBlock(TimeModElements instance) {
		super(instance, 204);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(JadeGemItem.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("time:jade_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:jade_ore"), configuredFeature);
		}
	}
