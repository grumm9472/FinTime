...
public class LightBlueGlassDoorBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:light_blue_glass_door")
	public static final Block block = null;

	public LightBlueGlassDoorBlock(TimeModElements instance) {
		super(instance, 697);
	}
