...
public class LightGrayGlassDoorBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:light_gray_glass_door")
	public static final Block block = null;

	public LightGrayGlassDoorBlock(TimeModElements instance) {
		super(instance, 706);
	}
