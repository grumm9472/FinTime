...
public class LightGreenGlassDoorBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:light_green_glass_door")
	public static final Block block = null;

	public LightGreenGlassDoorBlock(TimeModElements instance) {
		super(instance, 699);
	}
