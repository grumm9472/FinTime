...
public class MC400PlanksFenceBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:mc_400_planks_fence")
	public static final Block block = null;

	public MC400PlanksFenceBlock(TimeModElements instance) {
		super(instance, 541);
	}
