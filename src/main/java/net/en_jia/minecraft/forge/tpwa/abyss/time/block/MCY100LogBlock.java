...
public class MCY100LogBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:mcy_100_log")
	public static final Block block = null;

	public MCY100LogBlock(TimeModElements instance) {
		super(instance, 315);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(0.85f, 10f).setLightLevel(s -> 0).harvestLevel(1)
					.harvestTool(ToolType.AXE).setRequiresTool());
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("mcy_100_log");
		}
