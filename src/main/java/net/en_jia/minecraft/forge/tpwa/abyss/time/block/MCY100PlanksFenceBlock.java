...
public class MCY100PlanksFenceBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:mcy_100_planks_fence")
	public static final Block block = null;

	public MCY100PlanksFenceBlock(TimeModElements instance) {
		super(instance, 538);
	}
