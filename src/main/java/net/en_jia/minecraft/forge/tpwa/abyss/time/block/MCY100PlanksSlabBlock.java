...
public class MCY100PlanksSlabBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:mcy_100_planks_slab")
	public static final Block block = null;

	public MCY100PlanksSlabBlock(TimeModElements instance) {
		super(instance, 537);
	}
