...
public class MCY102400GrassBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:mcy_102400_grass")
	public static final Block block = null;

	public MCY102400GrassBlock(TimeModElements instance) {
		super(instance, 252);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ORGANIC).sound(SoundType.GROUND).hardnessAndResistance(0.25f, 10f).setLightLevel(s -> 0)
					.harvestLevel(1).harvestTool(ToolType.SHOVEL).setRequiresTool());
			setRegistryName("mcy_102400_grass");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MCY102400DirtBlock.block));
		}
	}
}
