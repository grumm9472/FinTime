...
public class MCY102400SmoothStoneBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:mcy_102400_smooth_stone")
	public static final Block block = null;

	public MCY102400SmoothStoneBlock(TimeModElements instance) {
		super(instance, 338);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mcy_102400_smooth_stone");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MCY102400StoneBlock.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("time:mcy_102400_smooth_stone_match"),
			...
			event.getRegistry().register(feature.setRegistryName("mcy_102400_smooth_stone"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:mcy_102400_smooth_stone"), configuredFeature);
		}
	}
