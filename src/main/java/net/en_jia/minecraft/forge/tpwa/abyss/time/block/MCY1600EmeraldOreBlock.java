...
public class MCY1600EmeraldOreBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:mcy_1600_emerald_ore")
	public static final Block block = null;

	public MCY1600EmeraldOreBlock(TimeModElements instance) {
		super(instance, 220);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mcy_1600_emerald_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("time:mcy_1600_emerald_ore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("mcy_1600_emerald_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:mcy_1600_emerald_ore"), configuredFeature);
		}
	}
