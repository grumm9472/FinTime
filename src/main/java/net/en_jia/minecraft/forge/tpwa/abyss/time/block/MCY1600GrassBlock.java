...
public class MCY1600GrassBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:mcy_1600_grass")
	public static final Block block = null;

	public MCY1600GrassBlock(TimeModElements instance) {
		super(instance, 254);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mcy_1600_grass");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MCY1600DirtBlock.block));
		}
	}
}
