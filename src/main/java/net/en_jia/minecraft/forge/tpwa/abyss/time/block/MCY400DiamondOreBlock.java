...
public class MCY400DiamondOreBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:mcy_400_diamond_ore")
	public static final Block block = null;

	public MCY400DiamondOreBlock(TimeModElements instance) {
		super(instance, 208);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mcy_400_diamond_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("time:mcy_400_diamond_ore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("mcy_400_diamond_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:mcy_400_diamond_ore"), configuredFeature);
		}
	}
