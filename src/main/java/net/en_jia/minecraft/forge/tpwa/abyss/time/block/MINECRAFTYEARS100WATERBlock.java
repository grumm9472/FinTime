...
public class MINECRAFTYEARS100WATERBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:minecraftyears_100_water")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("time:minecraftyears_100_water_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;

	public MINECRAFTYEARS100WATERBlock(TimeModElements instance) {
		super(instance, 508);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("time:blocks/newwater100"), new ResourceLocation("time:blocks/newwater100"))
						.luminosity(0).density(1115).viscosity(988).temperature(300)
		...
		still = (FlowingFluid) new ForgeFlowingFluid.Source(fluidproperties).setRegistryName("minecraftyears_100_water");
		flowing = (FlowingFluid) new ForgeFlowingFluid.Flowing(fluidproperties).setRegistryName("minecraftyears_100_water_flowing");
		elements.blocks
		...
		elements.items.add(() -> new BucketItem(still,
				new Item.Properties().containerItem(Items.BUCKET).maxStackSize(1).group(TIMEItemGroup.tab).rarity(Rarity.COMMON))
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("minecraftyears_100_water_lakes"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:minecraftyears_100_water_lakes"), configuredFeature);
		}
	}
