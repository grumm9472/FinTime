...
public class MagentaGlassDoorBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:magenta_glass_door")
	public static final Block block = null;

	public MagentaGlassDoorBlock(TimeModElements instance) {
		super(instance, 702);
	}
