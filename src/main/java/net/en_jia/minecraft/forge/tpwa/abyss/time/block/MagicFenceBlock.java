...
public class MagicFenceBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:magic_fence")
	public static final Block block = null;

	public MagicFenceBlock(TimeModElements instance) {
		super(instance, 520);
	}
