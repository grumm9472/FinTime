...
public class MagicFenceGateBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:magic_fence_gate")
	public static final Block block = null;

	public MagicFenceGateBlock(TimeModElements instance) {
		super(instance, 521);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("magic_fence_gate");
		}
