...
public class MagicLeaves3Block extends TimeModElements.ModElement {
	@ObjectHolder("time:magic_leaves_3")
	public static final Block block = null;

	public MagicLeaves3Block(TimeModElements instance) {
		super(instance, 292);
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.LEAVES).sound(SoundType.PLANT).hardnessAndResistance(0.01f, 10f).setLightLevel(s -> 15)
					.notSolid());
			setRegistryName("magic_leaves_3");
		}
