...
public class MagicSlabBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:magic_slab")
	public static final Block block = null;

	public MagicSlabBlock(TimeModElements instance) {
		super(instance, 519);
	}
