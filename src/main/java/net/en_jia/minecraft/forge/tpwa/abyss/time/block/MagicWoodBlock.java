...
public class MagicWoodBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:magic_wood")
	public static final Block block = null;

	public MagicWoodBlock(TimeModElements instance) {
		super(instance, 321);
	}
