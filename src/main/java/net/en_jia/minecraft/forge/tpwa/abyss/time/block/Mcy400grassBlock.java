...
public class Mcy400grassBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:mcy_400grass")
	public static final Block block = null;

	public Mcy400grassBlock(TimeModElements instance) {
		super(instance, 268);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Mcy400dirtBlock.block));
		}
	}
}
