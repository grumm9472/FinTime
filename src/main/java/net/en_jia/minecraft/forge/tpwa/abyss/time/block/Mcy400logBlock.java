...
public class Mcy400logBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:mcy_400log")
	public static final Block block = null;

	public Mcy400logBlock(TimeModElements instance) {
		super(instance, 318);
	}
