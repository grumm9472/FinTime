...
public class MinecraftYears100LogBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:minecraft_years_100_log")
	public static final Block block = null;

	public MinecraftYears100LogBlock(TimeModElements instance) {
		super(instance, 314);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("minecraft_years_100_log");
		}
