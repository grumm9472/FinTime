...
public class Minecraftyears100grassBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:minecraftyears_100grass")
	public static final Block block = null;

	public Minecraftyears100grassBlock(TimeModElements instance) {
		super(instance, 253);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ORGANIC).sound(SoundType.GROUND).hardnessAndResistance(0.75f, 10f).setLightLevel(s -> 0)
					.harvestLevel(1).harvestTool(ToolType.SHOVEL).setRequiresTool());
			setRegistryName("minecraftyears_100grass");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Minecraftyears100dirtBlock.block));
		}
	}
}
