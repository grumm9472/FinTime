...
public class Minecraftyears100leavesBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:minecraftyears_100leaves")
	public static final Block block = null;

	public Minecraftyears100leavesBlock(TimeModElements instance) {
		super(instance, 288);
	}
