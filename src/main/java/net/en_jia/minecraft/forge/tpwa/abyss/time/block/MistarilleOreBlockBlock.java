...
public class MistarilleOreBlockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:mistarille_ore_block")
	public static final Block block = null;

	public MistarilleOreBlockBlock(TimeModElements instance) {
		super(instance, 381);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mistarille_ore_block");
		}
