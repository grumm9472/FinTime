...
public class MoonGrass1Block extends TimeModElements.ModElement {
	@ObjectHolder("time:moon_grass_1")
	public static final Block block = null;

	public MoonGrass1Block(TimeModElements instance) {
		super(instance, 606);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("moon_grass_1"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:moon_grass_1"), configuredFeature);
		}
	}
