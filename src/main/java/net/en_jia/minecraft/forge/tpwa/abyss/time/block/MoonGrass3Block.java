...
public class MoonGrass3Block extends TimeModElements.ModElement {
	@ObjectHolder("time:moon_grass_3")
	public static final Block block = null;

	public MoonGrass3Block(TimeModElements instance) {
		super(instance, 581);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("moon_grass_3"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:moon_grass_3"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.PLANT)
					.hardnessAndResistance(0f, 0f).speedFactor(2f).setLightLevel(s -> 9));
			setRegistryName("moon_grass_3");
		}
