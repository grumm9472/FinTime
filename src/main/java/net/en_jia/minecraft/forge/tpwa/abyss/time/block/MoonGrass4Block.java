...
public class MoonGrass4Block extends TimeModElements.ModElement {
	@ObjectHolder("time:moon_grass_4")
	public static final Block block = null;

	public MoonGrass4Block(TimeModElements instance) {
		super(instance, 607);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("moon_grass_4"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:moon_grass_4"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.PLANT)
					.hardnessAndResistance(0f, 0f).speedFactor(5.6f).jumpFactor(4.3f).setLightLevel(s -> 8));
			setRegistryName("moon_grass_4");
		}
