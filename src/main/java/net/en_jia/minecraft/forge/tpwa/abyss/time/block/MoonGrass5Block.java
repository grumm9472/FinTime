...
public class MoonGrass5Block extends TimeModElements.ModElement {
	@ObjectHolder("time:moon_grass_5")
	public static final Block block = null;

	public MoonGrass5Block(TimeModElements instance) {
		super(instance, 608);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("moon_grass_5"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:moon_grass_5"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.PLANT)
					.hardnessAndResistance(0f, 0f).setLightLevel(s -> 9));
			setRegistryName("moon_grass_5");
		}
