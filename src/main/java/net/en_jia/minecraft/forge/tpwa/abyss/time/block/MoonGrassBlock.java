...
public class MoonGrassBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:moon_grass")
	public static final Block block = null;

	public MoonGrassBlock(TimeModElements instance) {
		super(instance, 582);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("moon_grass"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:moon_grass"), configuredFeature);
		}
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (new ResourceLocation("time:moonlight_forest").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
