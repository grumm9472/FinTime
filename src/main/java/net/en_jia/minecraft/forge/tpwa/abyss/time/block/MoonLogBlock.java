...
public class MoonLogBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:moon_log")
	public static final Block block = null;

	public MoonLogBlock(TimeModElements instance) {
		super(instance, 317);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(1f, 10f).setLightLevel(s -> 5).harvestLevel(1)
					.harvestTool(ToolType.AXE).setRequiresTool());
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("moon_log");
		}
