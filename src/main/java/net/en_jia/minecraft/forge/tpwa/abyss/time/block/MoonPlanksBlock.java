...
public class MoonPlanksBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:moon_planks")
	public static final Block block = null;

	public MoonPlanksBlock(TimeModElements instance) {
		super(instance, 627);
	}
