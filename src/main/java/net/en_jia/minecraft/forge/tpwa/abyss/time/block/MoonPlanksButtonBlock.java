...
public class MoonPlanksButtonBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:moon_planks_button")
	public static final Block block = null;

	public MoonPlanksButtonBlock(TimeModElements instance) {
		super(instance, 832);
	}
