...
public class MoonWarpButtonBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:moon_warp_button")
	public static final Block block = null;

	public MoonWarpButtonBlock(TimeModElements instance) {
		super(instance, 825);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("moon_warp_button");
		}
