...
public class MoonWarpFenceBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:moon_warp_fence")
	public static final Block block = null;

	public MoonWarpFenceBlock(TimeModElements instance) {
		super(instance, 559);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("moon_warp_fence");
		}
