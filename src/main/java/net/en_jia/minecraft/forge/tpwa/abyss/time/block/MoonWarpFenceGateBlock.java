...
public class MoonWarpFenceGateBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:moon_warp_fence_gate")
	public static final Block block = null;

	public MoonWarpFenceGateBlock(TimeModElements instance) {
		super(instance, 558);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("moon_warp_fence_gate");
		}
