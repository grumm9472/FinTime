...
public class MoonWarpLeavesBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:moon_warp_leaves")
	public static final Block block = null;

	public MoonWarpLeavesBlock(TimeModElements instance) {
		super(instance, 283);
	}
