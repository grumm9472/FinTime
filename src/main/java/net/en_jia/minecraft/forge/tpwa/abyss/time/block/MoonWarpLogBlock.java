...
public class MoonWarpLogBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:moon_warp_log")
	public static final Block block = null;

	public MoonWarpLogBlock(TimeModElements instance) {
		super(instance, 305);
	}
