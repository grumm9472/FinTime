...
public class MoonWarpPlanksBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:moon_warp_planks")
	public static final Block block = null;

	public MoonWarpPlanksBlock(TimeModElements instance) {
		super(instance, 631);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("moon_warp_planks");
		}
