...
public class MoonWarpSlabBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:moon_warp_slab")
	public static final Block block = null;

	public MoonWarpSlabBlock(TimeModElements instance) {
		super(instance, 556);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("moon_warp_slab");
		}
