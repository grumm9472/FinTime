...
public class MoonWarpStairsBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:moon_warp_stairs")
	public static final Block block = null;

	public MoonWarpStairsBlock(TimeModElements instance) {
		super(instance, 555);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("moon_warp_stairs");
		}
