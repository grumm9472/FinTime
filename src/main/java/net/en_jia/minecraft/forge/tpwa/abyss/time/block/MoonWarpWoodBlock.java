...
public class MoonWarpWoodBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:moon_warp_wood")
	public static final Block block = null;

	public MoonWarpWoodBlock(TimeModElements instance) {
		super(instance, 311);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("moon_warp_wood");
		}
