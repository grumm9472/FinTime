...
public class MorcantOreBlockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:morcant_ore_block")
	public static final Block block = null;

	public MorcantOreBlockBlock(TimeModElements instance) {
		super(instance, 377);
	}
