...
public class MushroomlogBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:mushroomlog")
	public static final Block block = null;

	public MushroomlogBlock(TimeModElements instance) {
		super(instance, 319);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(0.25f, 10f).setLightLevel(s -> 0).harvestLevel(1)
					.harvestTool(ToolType.AXE).setRequiresTool());
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("mushroomlog");
		}
