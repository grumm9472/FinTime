...
public class NetherDirtBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:nether_dirt")
	public static final Block block = null;

	public NetherDirtBlock(TimeModElements instance) {
		super(instance, 275);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("time:nether_dirt_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("nether_dirt"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:nether_dirt"), configuredFeature);
		}
	}
