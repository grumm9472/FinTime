...
public class OldSandBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:old_sand")
	public static final Block block = null;

	public OldSandBlock(TimeModElements instance) {
		super(instance, 341);
	}
