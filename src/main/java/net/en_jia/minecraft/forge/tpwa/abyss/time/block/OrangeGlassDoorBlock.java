...
public class OrangeGlassDoorBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:orange_glass_door")
	public static final Block block = null;

	public OrangeGlassDoorBlock(TimeModElements instance) {
		super(instance, 709);
	}
