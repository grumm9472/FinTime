...
public class OriginallavaBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:originallava")
	public static final Block block = null;

	public OriginallavaBlock(TimeModElements instance) {
		super(instance, 874);
	}
