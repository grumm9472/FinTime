...
import net.en_jia.minecraft.forge.tpwa.abyss.time.item.PerafriumItem;
...
public class PerafriumOreBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:perafrium_ore")
	public static final Block block = null;

	public PerafriumOreBlock(TimeModElements instance) {
		super(instance, 205);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PerafriumItem.block, (int) (4)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("time:perafrium_ore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("perafrium_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:perafrium_ore"), configuredFeature);
		}
	}
