...
public class PhantomLogBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:phantom_log")
	public static final Block block = null;

	public PhantomLogBlock(TimeModElements instance) {
		super(instance, 320);
	}
