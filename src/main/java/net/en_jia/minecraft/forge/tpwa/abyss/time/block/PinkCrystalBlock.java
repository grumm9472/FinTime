...
public class PinkCrystalBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:pink_crystal")
	public static final Block block = null;

	public PinkCrystalBlock(TimeModElements instance) {
		super(instance, 237);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("time:pink_crystal_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("pink_crystal"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:pink_crystal"), configuredFeature);
		}
	}
