...
public class PinkCutSandstoneBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:pink_cut_sandstone")
	public static final Block block = null;

	public PinkCutSandstoneBlock(TimeModElements instance) {
		super(instance, 811);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pink_cut_sandstone");
		}
