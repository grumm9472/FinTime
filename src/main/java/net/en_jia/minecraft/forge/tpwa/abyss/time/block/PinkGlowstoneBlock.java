...
import net.en_jia.minecraft.forge.tpwa.abyss.time.item.PinkGlowstoneDustItem;
...
public class PinkGlowstoneBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:pink_glowstone")
	public static final Block block = null;

	public PinkGlowstoneBlock(TimeModElements instance) {
		super(instance, 764);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PinkGlowstoneDustItem.block, (int) (4)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("time:pink_glowstone_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("pink_glowstone"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:pink_glowstone"), configuredFeature);
		}
	}
