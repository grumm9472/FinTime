...
public class PrairieSageBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:prairie_sage")
	public static final Block block = null;

	public PrairieSageBlock(TimeModElements instance) {
		super(instance, 604);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("prairie_sage"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:prairie_sage"), configuredFeature);
		}
	}
