...
public class PureWaterBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:pure_water")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("time:pure_water_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;

	public PureWaterBlock(TimeModElements instance) {
		super(instance, 507);
	...
	public void initElements() {
		...
		still = (FlowingFluid) new ForgeFlowingFluid.Source(fluidproperties).setRegistryName("pure_water");
		flowing = (FlowingFluid) new ForgeFlowingFluid.Flowing(fluidproperties).setRegistryName("pure_water_flowing");
		elements.blocks
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("pure_water_lakes"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:pure_water_lakes"), configuredFeature);
		}
	}
