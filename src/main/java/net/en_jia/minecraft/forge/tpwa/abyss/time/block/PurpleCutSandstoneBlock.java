...
public class PurpleCutSandstoneBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:purple_cut_sandstone")
	public static final Block block = null;

	public PurpleCutSandstoneBlock(TimeModElements instance) {
		super(instance, 813);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("purple_cut_sandstone");
		}
