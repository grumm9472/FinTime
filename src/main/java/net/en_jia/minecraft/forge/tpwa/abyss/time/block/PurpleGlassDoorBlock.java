...
public class PurpleGlassDoorBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:purple_glass_door")
	public static final Block block = null;

	public PurpleGlassDoorBlock(TimeModElements instance) {
		super(instance, 710);
	}
