...
public class PurpleSandstoneBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:purple_sandstone")
	public static final Block block = null;

	public PurpleSandstoneBlock(TimeModElements instance) {
		super(instance, 812);
	}
