...
public class Quartz1Block extends TimeModElements.ModElement {
	@ObjectHolder("time:quartz_1")
	public static final Block block = null;

	public Quartz1Block(TimeModElements instance) {
		super(instance, 818);
	}
