...
public class Quartz2Block extends TimeModElements.ModElement {
	@ObjectHolder("time:quartz_2")
	public static final Block block = null;

	public Quartz2Block(TimeModElements instance) {
		super(instance, 819);
	}
