...
public class Quartz3Block extends TimeModElements.ModElement {
	@ObjectHolder("time:quartz_3")
	public static final Block block = null;

	public Quartz3Block(TimeModElements instance) {
		super(instance, 820);
	}
