...
public class Quartz4Block extends TimeModElements.ModElement {
	@ObjectHolder("time:quartz_4")
	public static final Block block = null;

	public Quartz4Block(TimeModElements instance) {
		super(instance, 821);
	}
