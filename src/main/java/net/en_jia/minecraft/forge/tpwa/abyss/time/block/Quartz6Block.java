...
public class Quartz6Block extends TimeModElements.ModElement {
	@ObjectHolder("time:quartz_6")
	public static final Block block = null;

	public Quartz6Block(TimeModElements instance) {
		super(instance, 823);
	}
