...
public class RandomBlockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:random_block")
	public static final Block block = null;

	public RandomBlockBlock(TimeModElements instance) {
		super(instance, 711);
	}
