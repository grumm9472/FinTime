...
public class RedCrystalBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:red_crystal")
	public static final Block block = null;

	public RedCrystalBlock(TimeModElements instance) {
		super(instance, 234);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("time:red_crystal_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("red_crystal"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:red_crystal"), configuredFeature);
		}
	}
