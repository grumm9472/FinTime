...
public class RedMushroomBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:red_mushroom")
	public static final Block block = null;

	public RedMushroomBlock(TimeModElements instance) {
		super(instance, 769);
	}
