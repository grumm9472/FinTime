...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.RiserAltarOnBlockRightClickedProcedure;
...
public class RiserAltarBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:riser_altar")
	public static final Block block = null;

	public RiserAltarBlock(TimeModElements instance) {
		super(instance, 451);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			RiserAltarOnBlockRightClickedProcedure.executeProcedure(Stream
