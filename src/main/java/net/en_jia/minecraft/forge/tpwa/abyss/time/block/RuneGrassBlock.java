...
public class RuneGrassBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:rune_grass")
	public static final Block block = null;

	public RuneGrassBlock(TimeModElements instance) {
		super(instance, 255);
