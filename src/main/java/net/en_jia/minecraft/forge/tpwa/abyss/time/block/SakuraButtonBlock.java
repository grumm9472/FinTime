...
public class SakuraButtonBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:sakura_button")
	public static final Block block = null;

	public SakuraButtonBlock(TimeModElements instance) {
		super(instance, 826);
	}
