...
public class SakuraFenceGateBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:sakura_fence_gate")
	public static final Block block = null;

	public SakuraFenceGateBlock(TimeModElements instance) {
		super(instance, 551);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(4.4f, 6.6000000000000005f)
					.setLightLevel(s -> 0));
			setRegistryName("sakura_fence_gate");
		}
