...
public class SakuraPlanksBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:sakura_planks")
	public static final Block block = null;

	public SakuraPlanksBlock(TimeModElements instance) {
		super(instance, 333);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(4.4f, 5.6371475101573205f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.AXE).setRequiresTool());
			setRegistryName("sakura_planks");
		}
