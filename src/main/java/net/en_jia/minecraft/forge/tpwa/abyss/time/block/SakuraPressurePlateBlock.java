...
public class SakuraPressurePlateBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:sakura_pressure_plate")
	public static final Block block = null;

	public SakuraPressurePlateBlock(TimeModElements instance) {
		super(instance, 549);
	}
