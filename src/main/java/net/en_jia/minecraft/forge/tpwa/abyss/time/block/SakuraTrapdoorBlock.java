...
public class SakuraTrapdoorBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:sakura_trapdoor")
	public static final Block block = null;

	public SakuraTrapdoorBlock(TimeModElements instance) {
		super(instance, 562);
	}
