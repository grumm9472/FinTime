...
public class SakuraWoodBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:sakura_wood")
	public static final Block block = null;

	public SakuraWoodBlock(TimeModElements instance) {
		super(instance, 310);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(4.4f, 3.75809834010488f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.AXE).setRequiresTool());
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("sakura_wood");
		}
