...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.SandAltarZaiFangKuaiShangYouJianProcedure;
...
public class SandAltarBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:sand_altar")
	public static final Block block = null;

	public SandAltarBlock(TimeModElements instance) {
		super(instance, 646);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			SandAltarZaiFangKuaiShangYouJianProcedure.executeProcedure(Stream
