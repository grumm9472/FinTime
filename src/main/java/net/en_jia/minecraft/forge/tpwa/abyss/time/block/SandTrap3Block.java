...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.SandTrap3DangShiTiZaiFangKuaiShangXingZouShiProcedure;
...
public class SandTrap3Block extends TimeModElements.ModElement {
	@ObjectHolder("time:sand_trap_3")
	public static final Block block = null;

	public SandTrap3Block(TimeModElements instance) {
		super(instance, 803);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			SandTrap3DangShiTiZaiFangKuaiShangXingZouShiProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
