...
public class Sandstone10Block extends TimeModElements.ModElement {
	@ObjectHolder("time:sandstone_10")
	public static final Block block = null;

	public Sandstone10Block(TimeModElements instance) {
		super(instance, 808);
	}
