...
public class Sandstone1Block extends TimeModElements.ModElement {
	@ObjectHolder("time:sandstone_1")
	public static final Block block = null;

	public Sandstone1Block(TimeModElements instance) {
		super(instance, 795);
	}
