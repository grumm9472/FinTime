...
public class Sandstone2Block extends TimeModElements.ModElement {
	@ObjectHolder("time:sandstone_2")
	public static final Block block = null;

	public Sandstone2Block(TimeModElements instance) {
		super(instance, 796);
	}
