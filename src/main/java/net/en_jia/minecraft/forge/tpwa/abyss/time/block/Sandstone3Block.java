...
public class Sandstone3Block extends TimeModElements.ModElement {
	@ObjectHolder("time:sandstone_3")
	public static final Block block = null;

	public Sandstone3Block(TimeModElements instance) {
		super(instance, 797);
	}
