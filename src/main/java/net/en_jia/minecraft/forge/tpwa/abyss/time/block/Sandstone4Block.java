...
public class Sandstone4Block extends TimeModElements.ModElement {
	@ObjectHolder("time:sandstone_4")
	public static final Block block = null;

	public Sandstone4Block(TimeModElements instance) {
		super(instance, 798);
	}
