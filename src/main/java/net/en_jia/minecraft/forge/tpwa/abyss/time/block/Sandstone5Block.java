...
public class Sandstone5Block extends TimeModElements.ModElement {
	@ObjectHolder("time:sandstone_5")
	public static final Block block = null;

	public Sandstone5Block(TimeModElements instance) {
		super(instance, 799);
	}
