...
public class Sandstone6Block extends TimeModElements.ModElement {
	@ObjectHolder("time:sandstone_6")
	public static final Block block = null;

	public Sandstone6Block(TimeModElements instance) {
		super(instance, 804);
	}
