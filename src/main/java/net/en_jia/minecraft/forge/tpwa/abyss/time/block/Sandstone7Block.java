...
public class Sandstone7Block extends TimeModElements.ModElement {
	@ObjectHolder("time:sandstone_7")
	public static final Block block = null;

	public Sandstone7Block(TimeModElements instance) {
		super(instance, 805);
	}
