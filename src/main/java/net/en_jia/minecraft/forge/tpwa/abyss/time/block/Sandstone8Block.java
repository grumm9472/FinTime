...
public class Sandstone8Block extends TimeModElements.ModElement {
	@ObjectHolder("time:sandstone_8")
	public static final Block block = null;

	public Sandstone8Block(TimeModElements instance) {
		super(instance, 806);
	}
