...
public class Sandstone9Block extends TimeModElements.ModElement {
	@ObjectHolder("time:sandstone_9")
	public static final Block block = null;

	public Sandstone9Block(TimeModElements instance) {
		super(instance, 807);
	}
