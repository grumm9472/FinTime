...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.ScrollBenchOnBlockRightClickedProcedure;
...
public class ScrollBenchBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:scroll_bench")
	public static final Block block = null;

	public ScrollBenchBlock(TimeModElements instance) {
		super(instance, 449);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			ScrollBenchOnBlockRightClickedProcedure.executeProcedure(Stream
