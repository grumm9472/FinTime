...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.SeaweedsDryerOnBlockRightClickedProcedure;
...
public class SeaweedsDryerBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:seaweeds_dryer")
	public static final Block block = null;

	public SeaweedsDryerBlock(TimeModElements instance) {
		super(instance, 450);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			SeaweedsDryerOnBlockRightClickedProcedure.executeProcedure(Stream
