...
public class ShurbBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:shurb")
	public static final Block block = null;

	public ShurbBlock(TimeModElements instance) {
		super(instance, 574);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("shurb"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:shurb"), configuredFeature);
		}
	}
