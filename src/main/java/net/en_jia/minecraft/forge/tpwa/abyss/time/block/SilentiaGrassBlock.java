...
public class SilentiaGrassBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:silentia_grass")
	public static final Block block = null;

	public SilentiaGrassBlock(TimeModElements instance) {
		super(instance, 269);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("silentia_grass");
		}
