...
public class SmoothBlockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:smooth_block")
	public static final Block block = null;

	public SmoothBlockBlock(TimeModElements instance) {
		super(instance, 770);
	}
