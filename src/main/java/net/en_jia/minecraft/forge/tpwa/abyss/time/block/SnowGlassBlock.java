...
public class SnowGlassBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:snow_glass")
	public static final Block block = null;

	public SnowGlassBlock(TimeModElements instance) {
		super(instance, 713);
	}
