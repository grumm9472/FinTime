...
public class SnowyBlockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:snowy_block")
	public static final Block block = null;

	public SnowyBlockBlock(TimeModElements instance) {
		super(instance, 1930);
	}
