...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.SpringEntityWalksOnTheBlockProcedure;
...
public class SpringBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:spring")
	public static final Block block = null;

	public SpringBlock(TimeModElements instance) {
		super(instance, 465);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			SpringEntityWalksOnTheBlockProcedure.executeProcedure(Stream
