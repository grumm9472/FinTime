...
import net.en_jia.minecraft.forge.tpwa.abyss.time.item.SprluckynewItem;
...
public class SpringOreBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:spring_ore")
	public static final Block block = null;

	public SpringOreBlock(TimeModElements instance) {
		super(instance, 202);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SprluckynewItem.block));
		}
	}
}
