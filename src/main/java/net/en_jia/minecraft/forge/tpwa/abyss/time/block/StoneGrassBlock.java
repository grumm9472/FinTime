...
public class StoneGrassBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:stone_grass")
	public static final Block block = null;

	public StoneGrassBlock(TimeModElements instance) {
		super(instance, 793);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("time:stone_grass_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("stone_grass"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:stone_grass"), configuredFeature);
		}
	}
