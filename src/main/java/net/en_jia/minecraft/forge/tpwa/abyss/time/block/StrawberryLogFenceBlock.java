...
public class StrawberryLogFenceBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:strawberry_log_fence")
	public static final Block block = null;

	public StrawberryLogFenceBlock(TimeModElements instance) {
		super(instance, 1596);
	}
