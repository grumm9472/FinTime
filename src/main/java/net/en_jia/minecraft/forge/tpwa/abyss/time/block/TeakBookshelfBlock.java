...
public class TeakBookshelfBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:teak_bookshelf")
	public static final Block block = null;

	public TeakBookshelfBlock(TimeModElements instance) {
		super(instance, 782);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("teak_bookshelf");
		}
