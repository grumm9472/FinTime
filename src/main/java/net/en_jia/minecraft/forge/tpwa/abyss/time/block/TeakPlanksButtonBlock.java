...
public class TeakPlanksButtonBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:teak_planks_button")
	public static final Block block = null;

	public TeakPlanksButtonBlock(TimeModElements instance) {
		super(instance, 827);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("teak_planks_button");
		}
