...
public class TeakPressurePlateBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:teak_pressure_plate")
	public static final Block block = null;

	public TeakPressurePlateBlock(TimeModElements instance) {
		super(instance, 550);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("teak_pressure_plate");
		}
