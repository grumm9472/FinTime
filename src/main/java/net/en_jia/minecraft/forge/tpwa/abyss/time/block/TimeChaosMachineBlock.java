...
public class TimeChaosMachineBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:time_chaos_machine")
	public static final Block block = null;

	public TimeChaosMachineBlock(TimeModElements instance) {
		super(instance, 642);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("time_chaos_machine");
		}
