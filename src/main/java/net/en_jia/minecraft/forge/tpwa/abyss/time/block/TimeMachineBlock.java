...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.TimeMachineOnBlockRightClickedProcedure;
...
public class TimeMachineBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:time_machine")
	public static final Block block = null;

	public TimeMachineBlock(TimeModElements instance) {
		super(instance, 1);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			TimeMachineOnBlockRightClickedProcedure.executeProcedure(Stream
