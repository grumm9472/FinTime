...
public class TimeMachineBlockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:time_machine_block")
	public static final Block block = null;

	public TimeMachineBlockBlock(TimeModElements instance) {
		super(instance, 817);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("time_machine_block");
		}
