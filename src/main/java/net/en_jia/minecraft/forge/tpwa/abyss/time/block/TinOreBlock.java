...
public class TinOreBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:tin_ore")
	public static final Block block = null;

	public TinOreBlock(TimeModElements instance) {
		super(instance, 634);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("time:tin_ore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("tin_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:tin_ore"), configuredFeature);
		}
	}
