...
public class TinOreBlockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:tin_ore_block")
	public static final Block block = null;

	public TinOreBlockBlock(TimeModElements instance) {
		super(instance, 383);
	}
