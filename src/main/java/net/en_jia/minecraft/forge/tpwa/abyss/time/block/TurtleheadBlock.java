...
public class TurtleheadBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:turtlehead")
	public static final Block block = null;

	public TurtleheadBlock(TimeModElements instance) {
		super(instance, 578);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("turtlehead"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:turtlehead"), configuredFeature);
		}
	}
