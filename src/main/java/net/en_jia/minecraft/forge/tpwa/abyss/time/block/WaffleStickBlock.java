...
import net.en_jia.minecraft.forge.tpwa.abyss.time.item.WaffleItem;
...
public class WaffleStickBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:waffle_stick")
	public static final Block block = null;

	public WaffleStickBlock(TimeModElements instance) {
		super(instance, 316);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(WaffleItem.block, (int) (2)));
		}
	}
}
