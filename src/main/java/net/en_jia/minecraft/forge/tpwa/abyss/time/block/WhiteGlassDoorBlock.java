...
public class WhiteGlassDoorBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:white_glass_door")
	public static final Block block = null;

	public WhiteGlassDoorBlock(TimeModElements instance) {
		super(instance, 700);
	}
