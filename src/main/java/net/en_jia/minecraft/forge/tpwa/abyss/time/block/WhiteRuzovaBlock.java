...
public class WhiteRuzovaBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:white_ruzova")
	public static final Block block = null;

	public WhiteRuzovaBlock(TimeModElements instance) {
		super(instance, 580);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("white_ruzova"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:white_ruzova"), configuredFeature);
		}
	}
