...
public class WhitediamondOreBlockBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:whitediamond_ore_block")
	public static final Block block = null;

	public WhitediamondOreBlockBlock(TimeModElements instance) {
		super(instance, 378);
	}
