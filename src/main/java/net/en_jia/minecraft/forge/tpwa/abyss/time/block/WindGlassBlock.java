...
public class WindGlassBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:wind_glass")
	public static final Block block = null;

	public WindGlassBlock(TimeModElements instance) {
		super(instance, 714);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.GLASS).sound(SoundType.GLASS).hardnessAndResistance(0.2f, 10f).setLightLevel(s -> 3).notSolid()
