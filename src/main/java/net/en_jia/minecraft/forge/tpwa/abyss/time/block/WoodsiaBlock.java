...
public class WoodsiaBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:woodsia")
	public static final Block block = null;

	public WoodsiaBlock(TimeModElements instance) {
		super(instance, 577);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("woodsia"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:woodsia"), configuredFeature);
		}
	}
