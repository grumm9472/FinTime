...
public class XpBlockoBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:xp_blocko")
	public static final Block block = null;

	public XpBlockoBlock(TimeModElements instance) {
		super(instance, 389);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.EXPERIENCE_BOTTLE, (int) (4)));
		}
	}
}
