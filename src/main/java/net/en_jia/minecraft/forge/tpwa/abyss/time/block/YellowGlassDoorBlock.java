...
public class YellowGlassDoorBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:yellow_glass_door")
	public static final Block block = null;

	public YellowGlassDoorBlock(TimeModElements instance) {
		super(instance, 698);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("yellow_glass_door");
		}
