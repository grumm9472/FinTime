...
public class YellowMushroomBlock extends TimeModElements.ModElement {
	@ObjectHolder("time:yellow_mushroom")
	public static final Block block = null;

	public YellowMushroomBlock(TimeModElements instance) {
		super(instance, 768);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("yellow_mushroom");
		}
