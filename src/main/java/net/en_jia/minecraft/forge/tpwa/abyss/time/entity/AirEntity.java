...
import net.en_jia.minecraft.forge.tpwa.abyss.time.entity.renderer.AirRenderer;
import net.en_jia.minecraft.forge.tpwa.abyss.time.TimeModElements;

import java.util.Random;

@TimeModElements.ModElement.Tag
public class AirEntity extends TimeModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.8f)).build("air").setRegistryName("air");

	public AirEntity(TimeModElements instance) {
		super(instance, 671);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AirRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(AirStoneItem.block));
		}
