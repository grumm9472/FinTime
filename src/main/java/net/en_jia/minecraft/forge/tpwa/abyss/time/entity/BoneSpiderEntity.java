...
import net.en_jia.minecraft.forge.tpwa.abyss.time.entity.renderer.BoneSpiderRenderer;
import net.en_jia.minecraft.forge.tpwa.abyss.time.TimeModElements;

@TimeModElements.ModElement.Tag
public class BoneSpiderEntity extends TimeModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(1.4f, 0.9f)).build("bone_spider").setRegistryName("bone_spider");

	public BoneSpiderEntity(TimeModElements instance) {
		super(instance, 684);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BoneSpiderRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -7314332, new Item.Properties().group(TIMEItemGroup.tab))
