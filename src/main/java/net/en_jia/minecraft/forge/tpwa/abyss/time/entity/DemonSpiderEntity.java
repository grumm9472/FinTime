...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.DemonSpiderPlayerCollidesWithThisEntityProcedure;
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.DemonSpiderEntityDiesProcedure;
import net.en_jia.minecraft.forge.tpwa.abyss.time.itemgroup.TIMEItemGroup;
import net.en_jia.minecraft.forge.tpwa.abyss.time.entity.renderer.DemonSpiderRenderer;
...
public class DemonSpiderEntity extends TimeModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(1.4f, 0.9f)).build("demon_spider").setRegistryName("demon_spider");

	public DemonSpiderEntity(TimeModElements instance) {
		super(instance, 656);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DemonSpiderRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -10066330, new Item.Properties().group(TIMEItemGroup.tab))
	...
	public static class CustomEntity extends SpiderEntity {
		...
		public void onDeath(DamageSource source) {
			...
			DemonSpiderEntityDiesProcedure.executeProcedure(Stream
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			DemonSpiderPlayerCollidesWithThisEntityProcedure.executeProcedure(Collections.EMPTY_MAP);
		}
	}
}
