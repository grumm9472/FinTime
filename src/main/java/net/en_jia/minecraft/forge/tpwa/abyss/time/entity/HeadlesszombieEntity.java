...
import net.en_jia.minecraft.forge.tpwa.abyss.time.entity.renderer.HeadlesszombieRenderer;
import net.en_jia.minecraft.forge.tpwa.abyss.time.TimeModElements;

@TimeModElements.ModElement.Tag
public class HeadlesszombieEntity extends TimeModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("headlesszombie").setRegistryName("headlesszombie");

	public HeadlesszombieEntity(TimeModElements instance) {
		super(instance, 666);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HeadlesszombieRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16738048, -10066432, new Item.Properties().group(TIMEItemGroup.tab))
