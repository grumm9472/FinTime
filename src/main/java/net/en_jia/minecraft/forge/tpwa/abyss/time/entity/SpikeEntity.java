...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.SpikeEntityDiesProcedure;
import net.en_jia.minecraft.forge.tpwa.abyss.time.itemgroup.TIMEItemGroup;
import net.en_jia.minecraft.forge.tpwa.abyss.time.entity.renderer.SpikeRenderer;
...
public class SpikeEntity extends TimeModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.7f)).build("spike").setRegistryName("spike");

	public SpikeEntity(TimeModElements instance) {
		super(instance, 654);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16711936, -16724890, new Item.Properties().group(TIMEItemGroup.tab))
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 20, 3, 50));
	}
	...
	public static class CustomEntity extends SpiderEntity {
		...
		public void onDeath(DamageSource source) {
			...
			SpikeEntityDiesProcedure.executeProcedure(Stream
