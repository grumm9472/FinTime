...
import net.en_jia.minecraft.forge.tpwa.abyss.time.entity.CrystalSpiderEntity;
...
public class CrystalSpiderRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(CrystalSpiderEntity.entity,
