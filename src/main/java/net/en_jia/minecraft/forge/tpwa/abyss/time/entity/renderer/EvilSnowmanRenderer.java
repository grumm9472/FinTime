...
import net.en_jia.minecraft.forge.tpwa.abyss.time.entity.EvilSnowmanEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class EvilSnowmanRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(EvilSnowmanEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelsnow_model(), 0.5f) {
	...
	public static class Modelsnow_model extends EntityModel<Entity> {
		...
		public Modelsnow_model() {
			textureWidth = 64;
			textureHeight = 64;
			head = new ModelRenderer(this);
			head.setRotationPoint(0.0F, 4.0F, 0.0F);
			head.setTextureOffset(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, -0.5F, true);
			head.setTextureOffset(0, 0).addBox(-4.0F, -15.0F, -4.0F, 8.0F, 8.0F, 8.0F, -0.5F, true);
