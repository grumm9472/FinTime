...
import net.en_jia.minecraft.forge.tpwa.abyss.time.entity.IcebrumpEntity;

@OnlyIn(Dist.CLIENT)
public class IcebrumpRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(IcebrumpEntity.entity,
