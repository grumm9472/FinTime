...
import net.en_jia.minecraft.forge.tpwa.abyss.time.entity.PumpkinspiderEntity;

@OnlyIn(Dist.CLIENT)
public class PumpkinspiderRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(PumpkinspiderEntity.entity,
