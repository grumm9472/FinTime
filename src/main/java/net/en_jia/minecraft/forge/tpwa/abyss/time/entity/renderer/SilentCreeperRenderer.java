...
import net.en_jia.minecraft.forge.tpwa.abyss.time.entity.SilentCreeperEntity;

@OnlyIn(Dist.CLIENT)
public class SilentCreeperRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(SilentCreeperEntity.entity,
