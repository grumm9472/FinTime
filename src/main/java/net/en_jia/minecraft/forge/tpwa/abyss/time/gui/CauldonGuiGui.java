...
public class CauldonGuiGui extends TimeModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public CauldonGuiGui(TimeModElements instance) {
		super(instance, 1097);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("cauldon_gui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, CauldonGuiGuiWindow::new));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 25, 48) {
			}));
			this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 79, 30) {
			}));
			this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 124, 30) {
				@Override
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote()) {
				TimeMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
