...
public class QuiverguiGui extends TimeModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public QuiverguiGui(TimeModElements instance) {
		super(instance, 1260);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("quivergui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, QuiverguiGuiWindow::new));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 97, 30) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (Items.TIPPED_ARROW == stack.getItem());
				}
			}));
			...
			this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 6, 133, 30) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (Items.SPECTRAL_ARROW == stack.getItem());
				}
			}));
