...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.SanityBar10Procedure;
...
public class GravityWorld10Overlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Post event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (SanityBar10Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
