...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.SanityBar0Procedure;
...
public class Sanity0Overlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Post event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (SanityBar0Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
