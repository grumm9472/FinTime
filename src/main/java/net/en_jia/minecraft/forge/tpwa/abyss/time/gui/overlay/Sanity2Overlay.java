...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.SanityBar2Procedure;
...
public class Sanity2Overlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Post event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (SanityBar2Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
