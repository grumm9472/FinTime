...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.SanityBar3Procedure;
...
public class Sanity3Overlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Post event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (SanityBar3Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
