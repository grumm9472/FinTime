...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.WaterBar1Procedure;
...
public class WaterGUI1Overlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Post event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (WaterBar1Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
