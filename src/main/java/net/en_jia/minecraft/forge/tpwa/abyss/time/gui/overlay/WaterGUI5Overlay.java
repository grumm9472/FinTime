...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.WaterBar5Procedure;
...
public class WaterGUI5Overlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Post event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (WaterBar5Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
