...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.WaterBar7Procedure;
...
public class WaterGUI7Overlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Post event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (WaterBar7Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
