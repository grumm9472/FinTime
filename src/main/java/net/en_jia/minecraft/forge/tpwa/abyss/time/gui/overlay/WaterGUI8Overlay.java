...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.WaterBar8Procedure;
...
public class WaterGUI8Overlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Post event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (WaterBar8Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
