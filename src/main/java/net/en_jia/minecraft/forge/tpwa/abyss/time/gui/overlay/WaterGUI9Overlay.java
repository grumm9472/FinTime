...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.WaterBar9Procedure;
...
public class WaterGUI9Overlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Post event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (WaterBar9Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
