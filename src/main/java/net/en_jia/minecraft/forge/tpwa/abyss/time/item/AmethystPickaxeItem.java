...
public class AmethystPickaxeItem extends TimeModElements.ModElement {
	@ObjectHolder("time:amethyst_pickaxe")
	public static final Item block = null;

	public AmethystPickaxeItem(TimeModElements instance) {
		super(instance, 69);
	}
