...
public class AncientGlowstoneDustItem extends TimeModElements.ModElement {
	@ObjectHolder("time:ancient_glowstone_dust")
	public static final Item block = null;

	public AncientGlowstoneDustItem(TimeModElements instance) {
		super(instance, 367);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("ancient_glowstone_dust");
		}
