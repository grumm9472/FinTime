...
public class AquamarineShovelItem extends TimeModElements.ModElement {
	@ObjectHolder("time:aquamarine_shovel")
	public static final Item block = null;

	public AquamarineShovelItem(TimeModElements instance) {
		super(instance, 134);
	}
