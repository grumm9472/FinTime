...
public class BigSnowItem extends TimeModElements.ModElement {
	@ObjectHolder("time:big_snow")
	public static final Item block = null;

	public BigSnowItem(TimeModElements instance) {
		super(instance, 434);
	}
