...
public class BlackGlowstoneDustItem extends TimeModElements.ModElement {
	@ObjectHolder("time:black_glowstone_dust")
	public static final Item block = null;

	public BlackGlowstoneDustItem(TimeModElements instance) {
		super(instance, 750);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("black_glowstone_dust");
		}
