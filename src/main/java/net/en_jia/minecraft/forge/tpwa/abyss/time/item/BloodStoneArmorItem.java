...
public class BloodStoneArmorItem extends TimeModElements.ModElement {
	@ObjectHolder("time:blood_stone_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("time:blood_stone_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("time:blood_stone_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("time:blood_stone_armor_boots")
	public static final Item boots = null;

	public BloodStoneArmorItem(TimeModElements instance) {
		super(instance, 182);
	}
