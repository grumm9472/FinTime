...
public class BloodStoneShovelItem extends TimeModElements.ModElement {
	@ObjectHolder("time:blood_stone_shovel")
	public static final Item block = null;

	public BloodStoneShovelItem(TimeModElements instance) {
		super(instance, 142);
	}
