...
public class BloodStoneSwordItem extends TimeModElements.ModElement {
	@ObjectHolder("time:blood_stone_sword")
	public static final Item block = null;

	public BloodStoneSwordItem(TimeModElements instance) {
		super(instance, 55);
	}
