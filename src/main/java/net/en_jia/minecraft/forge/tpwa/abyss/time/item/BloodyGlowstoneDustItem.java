...
public class BloodyGlowstoneDustItem extends TimeModElements.ModElement {
	@ObjectHolder("time:bloody_glowstone_dust")
	public static final Item block = null;

	public BloodyGlowstoneDustItem(TimeModElements instance) {
		super(instance, 368);
	}
