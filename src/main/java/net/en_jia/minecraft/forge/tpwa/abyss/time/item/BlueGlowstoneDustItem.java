...
public class BlueGlowstoneDustItem extends TimeModElements.ModElement {
	@ObjectHolder("time:blue_glowstone_dust")
	public static final Item block = null;

	public BlueGlowstoneDustItem(TimeModElements instance) {
		super(instance, 751);
	}
