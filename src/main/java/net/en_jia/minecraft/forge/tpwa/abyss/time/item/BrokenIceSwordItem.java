...
public class BrokenIceSwordItem extends TimeModElements.ModElement {
	@ObjectHolder("time:broken_ice_sword")
	public static final Item block = null;

	public BrokenIceSwordItem(TimeModElements instance) {
		super(instance, 617);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("broken_ice_sword");
		}
