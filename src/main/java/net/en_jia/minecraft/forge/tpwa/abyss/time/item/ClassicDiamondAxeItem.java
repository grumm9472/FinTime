...
public class ClassicDiamondAxeItem extends TimeModElements.ModElement {
	@ObjectHolder("time:classic_diamond_axe")
	public static final Item block = null;

	public ClassicDiamondAxeItem(TimeModElements instance) {
		super(instance, 91);
	}
