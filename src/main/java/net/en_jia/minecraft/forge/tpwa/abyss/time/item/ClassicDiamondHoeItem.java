...
public class ClassicDiamondHoeItem extends TimeModElements.ModElement {
	@ObjectHolder("time:classic_diamond_hoe")
	public static final Item block = null;

	public ClassicDiamondHoeItem(TimeModElements instance) {
		super(instance, 146);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("classic_diamond_hoe"));
	}
}
