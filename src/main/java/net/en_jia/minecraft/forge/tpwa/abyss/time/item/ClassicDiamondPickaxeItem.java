...
public class ClassicDiamondPickaxeItem extends TimeModElements.ModElement {
	@ObjectHolder("time:classic_diamond_pickaxe")
	public static final Item block = null;

	public ClassicDiamondPickaxeItem(TimeModElements instance) {
		super(instance, 62);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("classic_diamond_pickaxe"));
	}
}
