...
public class ClassicDiamondShovelItem extends TimeModElements.ModElement {
	@ObjectHolder("time:classic_diamond_shovel")
	public static final Item block = null;

	public ClassicDiamondShovelItem(TimeModElements instance) {
		super(instance, 119);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("classic_diamond_shovel"));
	}
}
