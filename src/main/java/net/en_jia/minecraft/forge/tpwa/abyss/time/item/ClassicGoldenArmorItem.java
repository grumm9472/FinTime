...
public class ClassicGoldenArmorItem extends TimeModElements.ModElement {
	@ObjectHolder("time:classic_golden_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("time:classic_golden_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("time:classic_golden_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("time:classic_golden_armor_boots")
	public static final Item boots = null;

	public ClassicGoldenArmorItem(TimeModElements instance) {
		super(instance, 184);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(ClassicGoldenItem.block));
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(TIMEItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "time:textures/models/armor/gold__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
