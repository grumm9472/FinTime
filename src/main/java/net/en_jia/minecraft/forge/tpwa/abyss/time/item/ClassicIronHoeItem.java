...
public class ClassicIronHoeItem extends TimeModElements.ModElement {
	@ObjectHolder("time:classic_iron_hoe")
	public static final Item block = null;

	public ClassicIronHoeItem(TimeModElements instance) {
		super(instance, 145);
	}
