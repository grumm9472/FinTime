...
public class ClassicIronPickaxeItem extends TimeModElements.ModElement {
	@ObjectHolder("time:classic_iron_pickaxe")
	public static final Item block = null;

	public ClassicIronPickaxeItem(TimeModElements instance) {
		super(instance, 61);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("classic_iron_pickaxe"));
	}
}
