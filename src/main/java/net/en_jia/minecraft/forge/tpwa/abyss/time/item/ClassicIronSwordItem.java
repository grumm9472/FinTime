...
public class ClassicIronSwordItem extends TimeModElements.ModElement {
	@ObjectHolder("time:classic_iron_sword")
	public static final Item block = null;

	public ClassicIronSwordItem(TimeModElements instance) {
		super(instance, 19);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("classic_iron_sword"));
	}
}
