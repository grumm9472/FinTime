...
public class ClassicWoodenHoeItem extends TimeModElements.ModElement {
	@ObjectHolder("time:classic_wooden_hoe")
	public static final Item block = null;

	public ClassicWoodenHoeItem(TimeModElements instance) {
		super(instance, 149);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("classic_wooden_hoe"));
	}
}
