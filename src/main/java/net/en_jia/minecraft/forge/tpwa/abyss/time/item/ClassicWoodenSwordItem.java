...
public class ClassicWoodenSwordItem extends TimeModElements.ModElement {
	@ObjectHolder("time:classic_wooden_sword")
	public static final Item block = null;

	public ClassicWoodenSwordItem(TimeModElements instance) {
		super(instance, 22);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("classic_wooden_sword"));
	}
}
