...
public class ColdSteelIngotItem extends TimeModElements.ModElement {
	@ObjectHolder("time:cold_steel_ingot")
	public static final Item block = null;

	public ColdSteelIngotItem(TimeModElements instance) {
		super(instance, 420);
	}
