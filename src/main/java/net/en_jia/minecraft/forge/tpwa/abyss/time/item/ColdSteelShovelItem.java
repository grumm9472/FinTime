...
public class ColdSteelShovelItem extends TimeModElements.ModElement {
	@ObjectHolder("time:cold_steel_shovel")
	public static final Item block = null;

	public ColdSteelShovelItem(TimeModElements instance) {
		super(instance, 127);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("cold_steel_shovel"));
	}
}
