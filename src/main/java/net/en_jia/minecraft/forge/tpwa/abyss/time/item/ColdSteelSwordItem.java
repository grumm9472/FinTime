...
public class ColdSteelSwordItem extends TimeModElements.ModElement {
	@ObjectHolder("time:cold_steel_sword")
	public static final Item block = null;

	public ColdSteelSwordItem(TimeModElements instance) {
		super(instance, 54);
	}
