...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.CoordinateLocatorRightClickedOnBlockProcedure;
...
public class CoordinateLocatorItem extends TimeModElements.ModElement {
	@ObjectHolder("time:coordinate_locator")
	public static final Item block = null;

	public CoordinateLocatorItem(TimeModElements instance) {
		super(instance, 482);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			CoordinateLocatorRightClickedOnBlockProcedure.executeProcedure(Stream
