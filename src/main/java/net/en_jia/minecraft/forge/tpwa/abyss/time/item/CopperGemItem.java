...
public class CopperGemItem extends TimeModElements.ModElement {
	@ObjectHolder("time:copper_gem")
	public static final Item block = null;

	public CopperGemItem(TimeModElements instance) {
		super(instance, 418);
	}
