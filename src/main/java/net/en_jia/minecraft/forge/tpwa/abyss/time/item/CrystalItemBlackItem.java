...
public class CrystalItemBlackItem extends TimeModElements.ModElement {
	@ObjectHolder("time:crystal_item_black")
	public static final Item block = null;

	public CrystalItemBlackItem(TimeModElements instance) {
		super(instance, 245);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("crystal_item_black");
		}
