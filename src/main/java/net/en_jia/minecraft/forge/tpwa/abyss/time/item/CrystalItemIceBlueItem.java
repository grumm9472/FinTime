...
public class CrystalItemIceBlueItem extends TimeModElements.ModElement {
	@ObjectHolder("time:crystal_item_ice_blue")
	public static final Item block = null;

	public CrystalItemIceBlueItem(TimeModElements instance) {
		super(instance, 247);
	}
