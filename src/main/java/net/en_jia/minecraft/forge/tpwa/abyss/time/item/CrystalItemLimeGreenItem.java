...
public class CrystalItemLimeGreenItem extends TimeModElements.ModElement {
	@ObjectHolder("time:crystal_item_lime_green")
	public static final Item block = null;

	public CrystalItemLimeGreenItem(TimeModElements instance) {
		super(instance, 244);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("crystal_item_lime_green");
		}
