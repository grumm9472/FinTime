...
public class CrystalItemOrangeItem extends TimeModElements.ModElement {
	@ObjectHolder("time:crystal_item_orange")
	public static final Item block = null;

	public CrystalItemOrangeItem(TimeModElements instance) {
		super(instance, 248);
	}
