...
public class CrystalItemPinkItem extends TimeModElements.ModElement {
	@ObjectHolder("time:crystal_item_pink")
	public static final Item block = null;

	public CrystalItemPinkItem(TimeModElements instance) {
		super(instance, 246);
	}
