...
public class CrystalItemRedItem extends TimeModElements.ModElement {
	@ObjectHolder("time:crystal_item_red")
	public static final Item block = null;

	public CrystalItemRedItem(TimeModElements instance) {
		super(instance, 242);
	}
