...
public class CrystalItemWhiteItem extends TimeModElements.ModElement {
	@ObjectHolder("time:crystal_item_white")
	public static final Item block = null;

	public CrystalItemWhiteItem(TimeModElements instance) {
		super(instance, 243);
	}
