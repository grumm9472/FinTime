...
public class CrystalSharpItem extends TimeModElements.ModElement {
	@ObjectHolder("time:crystal_sharp")
	public static final Item block = null;

	public CrystalSharpItem(TimeModElements instance) {
		super(instance, 780);
	}
