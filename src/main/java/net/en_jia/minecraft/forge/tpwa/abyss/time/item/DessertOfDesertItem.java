...
public class DessertOfDesertItem extends TimeModElements.ModElement {
	@ObjectHolder("time:dessert_of_desert")
	public static final Item block = null;

	public DessertOfDesertItem(TimeModElements instance) {
		super(instance, 731);
	}
