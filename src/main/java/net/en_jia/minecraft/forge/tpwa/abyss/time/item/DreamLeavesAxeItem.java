...
public class DreamLeavesAxeItem extends TimeModElements.ModElement {
	@ObjectHolder("time:dream_leaves_axe")
	public static final Item block = null;

	public DreamLeavesAxeItem(TimeModElements instance) {
		super(instance, 836);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("dream_leaves_axe"));
	}
}
