...
public class FrozenCoalfuelItem extends TimeModElements.ModElement {
	@ObjectHolder("time:frozen_coalfuel")
	public static final Item block = null;

	public FrozenCoalfuelItem(TimeModElements instance) {
		super(instance, 415);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("frozen_coalfuel");
		}
