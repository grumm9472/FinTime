...
public class GingerItemItem extends TimeModElements.ModElement {
	@ObjectHolder("time:ginger_item")
	public static final Item block = null;

	public GingerItemItem(TimeModElements instance) {
		super(instance, 491);
	}
