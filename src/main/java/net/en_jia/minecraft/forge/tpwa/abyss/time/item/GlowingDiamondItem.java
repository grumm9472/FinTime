...
public class GlowingDiamondItem extends TimeModElements.ModElement {
	@ObjectHolder("time:glowing_diamond")
	public static final Item block = null;

	public GlowingDiamondItem(TimeModElements instance) {
		super(instance, 417);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("glowing_diamond");
		}
