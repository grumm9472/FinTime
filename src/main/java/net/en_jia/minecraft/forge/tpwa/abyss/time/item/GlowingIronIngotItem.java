...
public class GlowingIronIngotItem extends TimeModElements.ModElement {
	@ObjectHolder("time:glowing_iron_ingot")
	public static final Item block = null;

	public GlowingIronIngotItem(TimeModElements instance) {
		super(instance, 416);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("glowing_iron_ingot");
		}
