...
public class GlowingObsidianIngotItem extends TimeModElements.ModElement {
	@ObjectHolder("time:glowing_obsidian_ingot")
	public static final Item block = null;

	public GlowingObsidianIngotItem(TimeModElements instance) {
		super(instance, 426);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("glowing_obsidian_ingot");
		}
