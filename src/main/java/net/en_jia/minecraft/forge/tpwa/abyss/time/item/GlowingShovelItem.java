...
public class GlowingShovelItem extends TimeModElements.ModElement {
	@ObjectHolder("time:glowing_shovel")
	public static final Item block = null;

	public GlowingShovelItem(TimeModElements instance) {
		super(instance, 126);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("glowing_shovel"));
	}
}
