...
public class GoldenCoalItem extends TimeModElements.ModElement {
	@ObjectHolder("time:golden_coal")
	public static final Item block = null;

	public GoldenCoalItem(TimeModElements instance) {
		super(instance, 500);
	}
