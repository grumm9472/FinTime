...
public class HappyTeaItem extends TimeModElements.ModElement {
	@ObjectHolder("time:happy_tea")
	public static final Item block = null;

	public HappyTeaItem(TimeModElements instance) {
		super(instance, 488);
	}
