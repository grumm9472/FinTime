...
public class HardboneGemItem extends TimeModElements.ModElement {
	@ObjectHolder("time:hardbone_gem")
	public static final Item block = null;

	public HardboneGemItem(TimeModElements instance) {
		super(instance, 401);
	}
