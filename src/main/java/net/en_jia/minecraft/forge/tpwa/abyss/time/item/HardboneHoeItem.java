...
public class HardboneHoeItem extends TimeModElements.ModElement {
	@ObjectHolder("time:hardbone_hoe")
	public static final Item block = null;

	public HardboneHoeItem(TimeModElements instance) {
		super(instance, 169);
	}
