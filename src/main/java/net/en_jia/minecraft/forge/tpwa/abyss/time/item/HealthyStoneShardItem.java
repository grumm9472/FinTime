...
public class HealthyStoneShardItem extends TimeModElements.ModElement {
	@ObjectHolder("time:healthy_stone_shard")
	public static final Item block = null;

	public HealthyStoneShardItem(TimeModElements instance) {
		super(instance, 397);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("healthy_stone_shard");
		}
