...
public class HeatstonePowderItem extends TimeModElements.ModElement {
	@ObjectHolder("time:heatstone_powder")
	public static final Item block = null;

	public HeatstonePowderItem(TimeModElements instance) {
		super(instance, 749);
	}
