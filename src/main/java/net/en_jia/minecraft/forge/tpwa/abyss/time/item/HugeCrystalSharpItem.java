...
public class HugeCrystalSharpItem extends TimeModElements.ModElement {
	@ObjectHolder("time:huge_crystal_sharp")
	public static final Item block = null;

	public HugeCrystalSharpItem(TimeModElements instance) {
		super(instance, 613);
	}
