...
public class IchorArmorItem extends TimeModElements.ModElement {
	@ObjectHolder("time:ichor_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("time:ichor_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("time:ichor_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("time:ichor_armor_boots")
	public static final Item boots = null;

	public IchorArmorItem(TimeModElements instance) {
		super(instance, 188);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(IchorItem.block));
			}
