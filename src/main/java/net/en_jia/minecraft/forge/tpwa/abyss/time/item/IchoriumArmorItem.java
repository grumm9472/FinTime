...
public class IchoriumArmorItem extends TimeModElements.ModElement {
	@ObjectHolder("time:ichorium_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("time:ichorium_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("time:ichorium_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("time:ichorium_armor_boots")
	public static final Item boots = null;

	public IchoriumArmorItem(TimeModElements instance) {
		super(instance, 189);
	}
