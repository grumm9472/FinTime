...
import net.en_jia.minecraft.forge.tpwa.abyss.time.world.dimension.MCY102400Dimension;
import net.en_jia.minecraft.forge.tpwa.abyss.time.itemgroup.TIMEItemGroup;

public class MCY102400Item extends Item {
	@ObjectHolder("time:mcy_102400")
	public static final Item block = null;

	public MCY102400Item() {
	...
	public ActionResultType onItemUse(ItemUseContext context) {
		...
		if (!entity.canPlayerEdit(pos, context.getFace(), itemstack)) {
			...
			if (world.isAirBlock(pos) && true) {
				MCY102400Dimension.portal.portalSpawn(world, pos);
