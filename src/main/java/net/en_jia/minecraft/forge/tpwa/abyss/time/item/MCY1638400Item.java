...
import net.en_jia.minecraft.forge.tpwa.abyss.time.world.dimension.MCY1638400Dimension;
import net.en_jia.minecraft.forge.tpwa.abyss.time.itemgroup.TIMEItemGroup;

public class MCY1638400Item extends Item {
	@ObjectHolder("time:mcy_1638400")
	public static final Item block = null;

	public MCY1638400Item() {
	...
	public ActionResultType onItemUse(ItemUseContext context) {
		...
		if (!entity.canPlayerEdit(pos, context.getFace(), itemstack)) {
			...
			if (world.isAirBlock(pos) && true) {
				MCY1638400Dimension.portal.portalSpawn(world, pos);
