...
public class MagicBottleItem extends TimeModElements.ModElement {
	@ObjectHolder("time:magic_bottle")
	public static final Item block = null;

	public MagicBottleItem(TimeModElements instance) {
		super(instance, 484);
	}
