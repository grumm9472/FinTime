...
public class MagicPaperItem extends TimeModElements.ModElement {
	@ObjectHolder("time:magic_paper")
	public static final Item block = null;

	public MagicPaperItem(TimeModElements instance) {
		super(instance, 615);
	}
