...
public class MistarilleGemItem extends TimeModElements.ModElement {
	@ObjectHolder("time:mistarille_gem")
	public static final Item block = null;

	public MistarilleGemItem(TimeModElements instance) {
		super(instance, 412);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("mistarille_gem");
		}
