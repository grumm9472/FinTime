...
public class MistarilleSwordItem extends TimeModElements.ModElement {
	@ObjectHolder("time:mistarille_sword")
	public static final Item block = null;

	public MistarilleSwordItem(TimeModElements instance) {
		super(instance, 21);
	}
