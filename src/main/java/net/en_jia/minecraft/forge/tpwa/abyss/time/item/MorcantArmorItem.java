...
public class MorcantArmorItem extends TimeModElements.ModElement {
	@ObjectHolder("time:morcant_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("time:morcant_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("time:morcant_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("time:morcant_armor_boots")
	public static final Item boots = null;

	public MorcantArmorItem(TimeModElements instance) {
		super(instance, 181);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(TIMEItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "time:textures/models/armor/morcant__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
