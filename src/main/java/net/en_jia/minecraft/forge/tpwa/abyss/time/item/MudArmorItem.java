...
public class MudArmorItem extends TimeModElements.ModElement {
	@ObjectHolder("time:mud_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("time:mud_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("time:mud_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("time:mud_armor_boots")
	public static final Item boots = null;

	public MudArmorItem(TimeModElements instance) {
		super(instance, 174);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(TIMEItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "time:textures/models/armor/mud__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
