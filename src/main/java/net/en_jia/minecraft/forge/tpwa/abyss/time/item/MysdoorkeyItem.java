...
public class MysdoorkeyItem extends TimeModElements.ModElement {
	@ObjectHolder("time:mysdoorkey")
	public static final Item block = null;

	public MysdoorkeyItem(TimeModElements instance) {
		super(instance, 649);
	}
