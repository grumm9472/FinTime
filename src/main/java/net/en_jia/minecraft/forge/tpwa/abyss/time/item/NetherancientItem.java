...
import net.en_jia.minecraft.forge.tpwa.abyss.time.world.dimension.NetherancientDimension;
import net.en_jia.minecraft.forge.tpwa.abyss.time.itemgroup.TIMEItemGroup;

public class NetherancientItem extends Item {
	@ObjectHolder("time:netherancient")
	public static final Item block = null;

	public NetherancientItem() {
	...
	public ActionResultType onItemUse(ItemUseContext context) {
		...
		if (!entity.canPlayerEdit(pos, context.getFace(), itemstack)) {
			...
			if (world.isAirBlock(pos) && true) {
				NetherancientDimension.portal.portalSpawn(world, pos);
