...
public class ObsdiamonShovelItem extends TimeModElements.ModElement {
	@ObjectHolder("time:obsdiamon_shovel")
	public static final Item block = null;

	public ObsdiamonShovelItem(TimeModElements instance) {
		super(instance, 133);
	}
