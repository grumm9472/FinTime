...
public class ObsdiamondItem extends TimeModElements.ModElement {
	@ObjectHolder("time:obsdiamond")
	public static final Item block = null;

	public ObsdiamondItem(TimeModElements instance) {
		super(instance, 429);
	}
