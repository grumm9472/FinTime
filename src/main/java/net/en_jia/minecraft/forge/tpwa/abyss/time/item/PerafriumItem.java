...
public class PerafriumItem extends TimeModElements.ModElement {
	@ObjectHolder("time:perafrium")
	public static final Item block = null;

	public PerafriumItem(TimeModElements instance) {
		super(instance, 427);
	}
