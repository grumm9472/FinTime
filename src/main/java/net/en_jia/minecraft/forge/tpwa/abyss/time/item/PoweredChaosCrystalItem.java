...
public class PoweredChaosCrystalItem extends TimeModElements.ModElement {
	@ObjectHolder("time:powered_chaos_crystal")
	public static final Item block = null;

	public PoweredChaosCrystalItem(TimeModElements instance) {
		super(instance, 395);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("powered_chaos_crystal");
		}
