...
public class PurpleGlowstoneDustItem extends TimeModElements.ModElement {
	@ObjectHolder("time:purple_glowstone_dust")
	public static final Item block = null;

	public PurpleGlowstoneDustItem(TimeModElements instance) {
		super(instance, 755);
	}
