...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.QuiverRightClickedInAirProcedure;
import net.en_jia.minecraft.forge.tpwa.abyss.time.itemgroup.TIMEItemGroup;
import net.en_jia.minecraft.forge.tpwa.abyss.time.gui.QuiverguiGuiWindow;
...
public class QuiverItem extends TimeModElements.ModElement {
	@ObjectHolder("time:quiver")
	public static final Item block = null;

	public QuiverItem(TimeModElements instance) {
		super(instance, 616);
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Quiver");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new QuiverguiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
			...
			QuiverRightClickedInAirProcedure.executeProcedure(Stream
