...
public class RedGlowstoneDustItem extends TimeModElements.ModElement {
	@ObjectHolder("time:red_glowstone_dust")
	public static final Item block = null;

	public RedGlowstoneDustItem(TimeModElements instance) {
		super(instance, 756);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("red_glowstone_dust");
		}
