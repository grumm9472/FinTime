...
public class RiseRuneItem extends TimeModElements.ModElement {
	@ObjectHolder("time:rise_rune")
	public static final Item block = null;

	public RiseRuneItem(TimeModElements instance) {
		super(instance, 470);
	}
