...
public class RuneFragmentItem extends TimeModElements.ModElement {
	@ObjectHolder("time:rune_fragment")
	public static final Item block = null;

	public RuneFragmentItem(TimeModElements instance) {
		super(instance, 471);
	}
