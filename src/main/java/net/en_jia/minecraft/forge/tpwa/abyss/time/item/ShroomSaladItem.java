...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.DiamondAppleGaiShiWuBeiShiYongShiProcedure;
...
public class ShroomSaladItem extends TimeModElements.ModElement {
	@ObjectHolder("time:shroom_salad")
	public static final Item block = null;

	public ShroomSaladItem(TimeModElements instance) {
		super(instance, 733);
	}
