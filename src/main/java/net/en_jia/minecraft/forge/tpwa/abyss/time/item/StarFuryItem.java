...
import net.en_jia.minecraft.forge.tpwa.abyss.time.entity.renderer.StarFuryRenderer;
...
public class StarFuryItem extends TimeModElements.ModElement {
	@ObjectHolder("time:star_fury")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletstar_fury").setRegistryName("entitybulletstar_fury");

	public StarFuryItem(TimeModElements instance) {
		super(instance, 48);
		FMLJavaModLoadingContext.get().getModEventBus().register(new StarFuryRenderer.ModelRegisterHandler());
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(SarFuryItemItem.block);
		}
