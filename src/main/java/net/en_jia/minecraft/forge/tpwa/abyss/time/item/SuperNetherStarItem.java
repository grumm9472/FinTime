...
public class SuperNetherStarItem extends TimeModElements.ModElement {
	@ObjectHolder("time:super_nether_star")
	public static final Item block = null;

	public SuperNetherStarItem(TimeModElements instance) {
		super(instance, 647);
	}
