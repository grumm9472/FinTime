...
public class TerameriaiumItem extends TimeModElements.ModElement {
	@ObjectHolder("time:terameriaium")
	public static final Item block = null;

	public TerameriaiumItem(TimeModElements instance) {
		super(instance, 432);
	}
