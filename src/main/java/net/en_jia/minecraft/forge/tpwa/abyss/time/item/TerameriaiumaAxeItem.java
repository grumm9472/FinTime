...
public class TerameriaiumaAxeItem extends TimeModElements.ModElement {
	@ObjectHolder("time:terameriaiuma_axe")
	public static final Item block = null;

	public TerameriaiumaAxeItem(TimeModElements instance) {
		super(instance, 110);
	}
