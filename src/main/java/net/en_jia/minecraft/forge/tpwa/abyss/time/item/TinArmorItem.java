...
public class TinArmorItem extends TimeModElements.ModElement {
	@ObjectHolder("time:tin_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("time:tin_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("time:tin_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("time:tin_armor_boots")
	public static final Item boots = null;

	public TinArmorItem(TimeModElements instance) {
		super(instance, 177);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(TinGemItem.block));
			}
