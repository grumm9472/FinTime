...
public class VitreousArmorItem extends TimeModElements.ModElement {
	@ObjectHolder("time:vitreous_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("time:vitreous_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("time:vitreous_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("time:vitreous_armor_boots")
	public static final Item boots = null;

	public VitreousArmorItem(TimeModElements instance) {
		super(instance, 190);
	}
