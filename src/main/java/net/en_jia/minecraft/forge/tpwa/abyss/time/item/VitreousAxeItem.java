...
public class VitreousAxeItem extends TimeModElements.ModElement {
	@ObjectHolder("time:vitreous_axe")
	public static final Item block = null;

	public VitreousAxeItem(TimeModElements instance) {
		super(instance, 100);
	}
