...
public class VitreousHoeItem extends TimeModElements.ModElement {
	@ObjectHolder("time:vitreous_hoe")
	public static final Item block = null;

	public VitreousHoeItem(TimeModElements instance) {
		super(instance, 166);
	}
