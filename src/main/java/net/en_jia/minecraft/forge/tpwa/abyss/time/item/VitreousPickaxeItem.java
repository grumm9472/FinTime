...
public class VitreousPickaxeItem extends TimeModElements.ModElement {
	@ObjectHolder("time:vitreous_pickaxe")
	public static final Item block = null;

	public VitreousPickaxeItem(TimeModElements instance) {
		super(instance, 76);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("vitreous_pickaxe"));
	}
}
