...
public class WaterstoneItem extends TimeModElements.ModElement {
	@ObjectHolder("time:waterstone")
	public static final Item block = null;

	public WaterstoneItem(TimeModElements instance) {
		super(instance, 476);
	}
