...
public class WhiteGlowstoneDustItem extends TimeModElements.ModElement {
	@ObjectHolder("time:white_glowstone_dust")
	public static final Item block = null;

	public WhiteGlowstoneDustItem(TimeModElements instance) {
		super(instance, 757);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("white_glowstone_dust");
		}
