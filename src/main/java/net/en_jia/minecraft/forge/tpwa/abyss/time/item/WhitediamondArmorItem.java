...
public class WhitediamondArmorItem extends TimeModElements.ModElement {
	@ObjectHolder("time:whitediamond_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("time:whitediamond_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("time:whitediamond_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("time:whitediamond_armor_boots")
	public static final Item boots = null;

	public WhitediamondArmorItem(TimeModElements instance) {
		super(instance, 178);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(TIMEItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "time:textures/models/armor/tim__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
