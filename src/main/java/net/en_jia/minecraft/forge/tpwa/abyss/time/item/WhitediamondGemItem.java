...
public class WhitediamondGemItem extends TimeModElements.ModElement {
	@ObjectHolder("time:whitediamond_gem")
	public static final Item block = null;

	public WhitediamondGemItem(TimeModElements instance) {
		super(instance, 414);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("whitediamond_gem");
		}
