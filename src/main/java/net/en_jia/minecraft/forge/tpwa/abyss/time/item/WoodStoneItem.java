...
public class WoodStoneItem extends TimeModElements.ModElement {
	@ObjectHolder("time:wood_stone")
	public static final Item block = null;

	public WoodStoneItem(TimeModElements instance) {
		super(instance, 472);
	}
