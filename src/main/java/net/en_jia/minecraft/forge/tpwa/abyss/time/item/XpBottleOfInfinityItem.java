...
public class XpBottleOfInfinityItem extends TimeModElements.ModElement {
	@ObjectHolder("time:xp_bottle_of_infinity")
	public static final Item block = null;

	public XpBottleOfInfinityItem(TimeModElements instance) {
		super(instance, 483);
	}
