...
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.MagicLogBlock;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.Fire5Block;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.Fire4Block;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.Fire3Block;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.Fire2Block;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.CompressGoldBlockBlock;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.BambooLogBlock;
