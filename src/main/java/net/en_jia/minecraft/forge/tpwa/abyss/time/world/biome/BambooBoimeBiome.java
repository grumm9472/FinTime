...
public class BambooBoimeBiome extends TimeModElements.ModElement {
	public static Biome biome;

	public BambooBoimeBiome(TimeModElements instance) {
		super(instance, 1298);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("time:bamboo_boime"));
			}
		}
	}
