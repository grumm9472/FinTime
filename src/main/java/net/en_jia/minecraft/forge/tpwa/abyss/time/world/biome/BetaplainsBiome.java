...
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.ClassicLogBlock;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.ClassicGrassBlock;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.ClassicDirtBlock;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.BetaleavesBlock;
...
public class BetaplainsBiome extends TimeModElements.ModElement {
	public static Biome biome;

	public BetaplainsBiome(TimeModElements instance) {
		super(instance, 1226);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(ClassicGrassBlock.block.getDefaultState(),
								ClassicDirtBlock.block.getDefaultState(), ClassicDirtBlock.block.getDefaultState())));
				biomeGenerationSettings.withStructure(StructureFeatures.STRONGHOLD);
				biomeGenerationSettings.withStructure(StructureFeatures.MINESHAFT);
				biomeGenerationSettings.withStructure(StructureFeatures.PILLAGER_OUTPOST);
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(ClassicLogBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(BetaleavesBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("time:betaplains"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("betaplains_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("betaplains_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("betaplains_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
