...
public class CactusForestBiome extends TimeModElements.ModElement {
	public static Biome biome;

	public CactusForestBiome(TimeModElements instance) {
		super(instance, 2153);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
						Feature.DISK
								.withConfiguration(new SphereReplaceConfig(Blocks.SAND.getDefaultState(), FeatureSpread.func_242253_a(2, 4), 2,
										ImmutableList.of(Blocks.RED_SAND.getDefaultState(), Blocks.RED_SAND.getDefaultState())))
				...
				event.getRegistry().register(biome.setRegistryName("time:cactus_forest"));
			}
		}
	}
