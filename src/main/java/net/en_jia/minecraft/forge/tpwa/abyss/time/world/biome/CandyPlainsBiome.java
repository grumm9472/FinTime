...
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.CandyGrassBlock;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.BreadblockBlock;
import net.en_jia.minecraft.forge.tpwa.abyss.time.TimeModElements;

@TimeModElements.ModElement.Tag
public class CandyPlainsBiome extends TimeModElements.ModElement {
	public static Biome biome;

	public CandyPlainsBiome(TimeModElements instance) {
		super(instance, 1384);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("time:candy_plains"));
			}
		}
	}
