...
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.WaffleStickBlock;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.ChocolateLeavesBlock;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.CakeChocolateBlock;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.BreadblockBlock;
...
public class ChocolateLandBiome extends TimeModElements.ModElement {
	public static Biome biome;

	public ChocolateLandBiome(TimeModElements instance) {
		super(instance, 945);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(CakeChocolateBlock.block.getDefaultState(),
								BreadblockBlock.block.getDefaultState(), BreadblockBlock.block.getDefaultState())));
				biomeGenerationSettings.withStructure(StructureFeatures.STRONGHOLD);
				biomeGenerationSettings.withStructure(StructureFeatures.MINESHAFT);
				biomeGenerationSettings.withStructure(StructureFeatures.PILLAGER_OUTPOST);
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(WaffleStickBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(ChocolateLeavesBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("time:chocolate_land"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("chocolate_land_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("chocolate_land_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("chocolate_land_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
