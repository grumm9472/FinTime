...
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.DreamGrassBlock;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.DreamDirtBlock;
...
public class EmptyPhantomBiome extends TimeModElements.ModElement {
	public static Biome biome;

	public EmptyPhantomBiome(TimeModElements instance) {
		super(instance, 1575);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-10092391).setWaterColor(-10092340).setWaterFogColor(-13434829)
						.withSkyColor(-10092391).withFoliageColor(10387789).withGrassColor(-3407668).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(DreamGrassBlock.block.getDefaultState(),
				...
				event.getRegistry().register(biome.setRegistryName("time:empty_phantom"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("empty_phantom_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("empty_phantom_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("empty_phantom_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
