...
public class FORESTmAGICBiome extends TimeModElements.ModElement {
	public static Biome biome;

	public FORESTmAGICBiome(TimeModElements instance) {
		super(instance, 1297);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-3342337).setWaterColor(-6710785).setWaterFogColor(-6710785)
						.withSkyColor(-3342337).withFoliageColor(-16724890).withGrassColor(-16724890)
						.setMusic(new BackgroundMusicSelector(
								(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("time:mcy25600a")), 12000,
								24000, true))
						.build();
				...
				event.getRegistry().register(biome.setRegistryName("time:fores_tm_agic"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("fores_tm_agic_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("fores_tm_agic_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("fores_tm_agic_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
