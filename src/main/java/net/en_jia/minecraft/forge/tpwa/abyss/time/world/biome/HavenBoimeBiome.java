...
public class HavenBoimeBiome extends TimeModElements.ModElement {
	public static Biome biome;

	public HavenBoimeBiome(TimeModElements instance) {
		super(instance, 1610);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("time:haven_boime"));
			}
		}
	}
