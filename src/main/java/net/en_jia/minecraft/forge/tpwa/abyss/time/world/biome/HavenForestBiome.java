...
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.SweetGrassBlock;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.StrawberryLogLogBlock;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.StrawberryLogLeavesBlock;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.StrawberryBlockBlock;
...
public class HavenForestBiome extends TimeModElements.ModElement {
	public static Biome biome;

	public HavenForestBiome(TimeModElements instance) {
		super(instance, 1611);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(SweetGrassBlock.block.getDefaultState(),
								StrawberryBlockBlock.block.getDefaultState(), StrawberryBlockBlock.block.getDefaultState())));
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration(
								(new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(StrawberryLogLogBlock.block.getDefaultState()),
										new SimpleBlockStateProvider(StrawberryLogLeavesBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("time:haven_forest"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("haven_forest_lvtd");
		...
		protected void func_227424_a_(IWorldWriter ww, BlockPos bp, BooleanProperty bpr, Set<BlockPos> sbc, MutableBoundingBox mbb) {
			this.func_227423_a_(ww, bp, StrawberryLogLeavesBlock.block.getDefaultState(), sbc, mbb);
		}
	}
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("haven_forest_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("haven_forest_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
					...
					for (Direction direction : Direction.Plane.HORIZONTAL) {
						if (p_225576_2_.nextFloat() <= 0.25F) {
							...
							if (Feature.isAirAt(p_225576_1_, blockpos)) {
								BlockState blockstate = StrawberryLogLeavesBlock.block.getDefaultState();
