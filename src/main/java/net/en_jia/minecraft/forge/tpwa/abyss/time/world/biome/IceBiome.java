...
public class IceBiome extends TimeModElements.ModElement {
	public static Biome biome;

	public IceBiome(TimeModElements instance) {
		super(instance, 1062);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Blocks.BLUE_ICE.getDefaultState(),
				...
				event.getRegistry().register(biome.setRegistryName("time:ice"));
			}
		}
	}
