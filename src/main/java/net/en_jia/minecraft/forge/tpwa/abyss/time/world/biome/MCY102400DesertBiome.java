...
public class MCY102400DesertBiome extends TimeModElements.ModElement {
	public static Biome biome;

	public MCY102400DesertBiome(TimeModElements instance) {
		super(instance, 1433);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(MCY102400GrassBlock.block.getDefaultState(),
				...
				event.getRegistry().register(biome.setRegistryName("time:mcy_102400_desert"));
			}
		}
	}
