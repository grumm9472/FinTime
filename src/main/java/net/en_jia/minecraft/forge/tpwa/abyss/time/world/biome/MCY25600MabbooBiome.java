...
public class MCY25600MabbooBiome extends TimeModElements.ModElement {
	public static Biome biome;

	public MCY25600MabbooBiome(TimeModElements instance) {
		super(instance, 1134);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("time:mcy_25600_mabboo"));
			}
		}
	}
