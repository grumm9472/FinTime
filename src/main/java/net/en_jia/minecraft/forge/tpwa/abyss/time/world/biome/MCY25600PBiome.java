...
public class MCY25600PBiome extends TimeModElements.ModElement {
	public static Biome biome;

	public MCY25600PBiome(TimeModElements instance) {
		super(instance, 1133);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("time:mcy_25600_p"));
			}
		}
	}
