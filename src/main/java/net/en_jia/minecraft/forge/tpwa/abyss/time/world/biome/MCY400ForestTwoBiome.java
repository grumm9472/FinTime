...
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.Mcy400logBlock;
...
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.MCY400LeavesBlock;
...
public class MCY400ForestTwoBiome extends TimeModElements.ModElement {
	public static Biome biome;

	public MCY400ForestTwoBiome(TimeModElements instance) {
		super(instance, 2161);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-5916161).setWaterColor(-14329397).setWaterFogColor(-14329397)
						.withSkyColor(-5916161).withFoliageColor(-10512895).withGrassColor(-10512895)
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Mcy400grassBlock.block.getDefaultState(),
								MCY400StoneBlock.block.getDefaultState(), MCY400StoneBlock.block.getDefaultState())));
				biomeGenerationSettings.withStructure(StructureFeatures.STRONGHOLD);
				biomeGenerationSettings.withStructure(StructureFeatures.MINESHAFT);
				biomeGenerationSettings.withStructure(StructureFeatures.PILLAGER_OUTPOST);
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(Mcy400logBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(MCY400LeavesBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("time:mcy_400_forest_two"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("mcy_400_forest_two_lvtd");
		...
		protected void func_227424_a_(IWorldWriter ww, BlockPos bp, BooleanProperty bpr, Set<BlockPos> sbc, MutableBoundingBox mbb) {
			this.func_227423_a_(ww, bp, Blocks.CAVE_AIR.getDefaultState(), sbc, mbb);
		}
	}
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("mcy_400_forest_two_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("mcy_400_forest_two_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
