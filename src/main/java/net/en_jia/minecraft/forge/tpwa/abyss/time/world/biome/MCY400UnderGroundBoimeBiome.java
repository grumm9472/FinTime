...
public class MCY400UnderGroundBoimeBiome extends TimeModElements.ModElement {
	public static Biome biome;

	public MCY400UnderGroundBoimeBiome(TimeModElements instance) {
		super(instance, 1843);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(ForzenGrassBlock.block.getDefaultState(),
				...
				event.getRegistry().register(biome.setRegistryName("time:mcy_400_under_ground_boime"));
			}
		}
	}
