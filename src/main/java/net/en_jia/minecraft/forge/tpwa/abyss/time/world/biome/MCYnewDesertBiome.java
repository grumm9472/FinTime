...
public class MCYnewDesertBiome extends TimeModElements.ModElement {
	public static Biome biome;

	public MCYnewDesertBiome(TimeModElements instance) {
		super(instance, 1903);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("time:mc_ynew_desert"));
			}
		}
	}
