...
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.MCY100LogBlock;
...
public class Mcy100PlainsBiome extends TimeModElements.ModElement {
	public static Biome biome;

	public Mcy100PlainsBiome(TimeModElements instance) {
		super(instance, 897);
			...
			if (biome == null) {
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(MCY100LogBlock.block.getDefaultState()),
								...
								new ForkyTrunkPlacer(6, 2, 2), new TwoLayerFeature(1, 0, 2)))
				...
				event.getRegistry().register(biome.setRegistryName("time:mcy_100_plains"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("mcy_100_plains_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("mcy_100_plains_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("mcy_100_plains_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
