...
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.Mcy400grassBlock;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.Mcy400dirtBlock;
...
public class Mcy400fORESTBiome extends TimeModElements.ModElement {
	public static Biome biome;

	public Mcy400fORESTBiome(TimeModElements instance) {
		super(instance, 1031);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-5916161).setWaterColor(-1).setWaterFogColor(-1)
						.withSkyColor(-5916161).withFoliageColor(-1).withGrassColor(-1)
						.setMusic(new BackgroundMusicSelector(
								(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("time:mcy400a")), 12000,
								24000, true))
						.build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Mcy400grassBlock.block.getDefaultState(),
								Mcy400dirtBlock.block.getDefaultState(), Mcy400dirtBlock.block.getDefaultState())));
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.RAIN).category(Biome.Category.NONE).depth(0.1f).scale(0.2f)
						.temperature(0.26f).downfall(1f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("time:mcy_400f_orest"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("mcy_400f_orest_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("mcy_400f_orest_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("mcy_400f_orest_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
