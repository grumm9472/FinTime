...
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.WindSandBlock;
import net.en_jia.minecraft.forge.tpwa.abyss.time.TimeModElements;

@TimeModElements.ModElement.Tag
public class Minecraft100NewDesert3Biome extends TimeModElements.ModElement {
	public static Biome biome;

	public Minecraft100NewDesert3Biome(TimeModElements instance) {
		super(instance, 2165);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("time:minecraft_100_new_desert_3"));
			}
		}
	}
