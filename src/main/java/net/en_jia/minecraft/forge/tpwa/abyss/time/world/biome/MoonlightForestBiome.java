...
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.MoonLogBlock;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.MoonLeavesBlock;
...
public class MoonlightForestBiome extends TimeModElements.ModElement {
	public static Biome biome;

	public MoonlightForestBiome(TimeModElements instance) {
		super(instance, 1929);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-16764109).setWaterColor(4159204).setWaterFogColor(329011)
						.withSkyColor(-16764109).withFoliageColor(10387789).withGrassColor(9470285).build();
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(MoonLogBlock.block.getDefaultState()),
								...
								new ForkyTrunkPlacer(9, 2, 2), new TwoLayerFeature(1, 0, 2)))
						...
						.withPlacement(Placement.COUNT_EXTRA.configure(new AtSurfaceWithExtraConfig(33, 0.1F, 1))));
				...
				event.getRegistry().register(biome.setRegistryName("time:moonlight_forest"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("moonlight_forest_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("moonlight_forest_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("moonlight_forest_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
