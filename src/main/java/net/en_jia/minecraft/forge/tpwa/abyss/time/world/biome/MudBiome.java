...
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.MudBlockBlock;
...
public class MudBiome extends TimeModElements.ModElement {
	public static Biome biome;

	public MudBiome(TimeModElements instance) {
		super(instance, 1185);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(MudBlockBlock.block.getDefaultState(),
								MudBlockBlock.block.getDefaultState(), MudBlockBlock.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("time:mud"));
			}
		}
	}
