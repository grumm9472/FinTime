...
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.RuneGrassBlock;
...
public class RuneLandBiome extends TimeModElements.ModElement {
	public static Biome biome;

	public RuneLandBiome(TimeModElements instance) {
		super(instance, 924);
			...
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-5916161).setWaterColor(-14329397).setWaterFogColor(-14329397)
						...
						.setMusic(new BackgroundMusicSelector(
								(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("time:mcy100c")), 12000,
								24000, true))
						.build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(RuneGrassBlock.block.getDefaultState(),
								RuneGrassBlock.block.getDefaultState(), RuneGrassBlock.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("time:rune_land"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("rune_land_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("rune_land_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("rune_land_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
