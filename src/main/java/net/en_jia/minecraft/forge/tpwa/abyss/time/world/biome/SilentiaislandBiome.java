...
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.SilentiaGrassBlock;
...
public class SilentiaislandBiome extends TimeModElements.ModElement {
	public static Biome biome;

	public SilentiaislandBiome(TimeModElements instance) {
		super(instance, 1083);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(SilentiaGrassBlock.block.getDefaultState(),
								SilentiaDirtBlock.block.getDefaultState(), SilentiaDirtBlock.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("time:silentiaisland"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("silentiaisland_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("silentiaisland_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("silentiaisland_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
