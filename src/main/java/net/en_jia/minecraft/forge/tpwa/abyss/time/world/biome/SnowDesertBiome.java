...
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.SnowSandBlock;
import net.en_jia.minecraft.forge.tpwa.abyss.time.TimeModElements;

@TimeModElements.ModElement.Tag
public class SnowDesertBiome extends TimeModElements.ModElement {
	public static Biome biome;

	public SnowDesertBiome(TimeModElements instance) {
		super(instance, 1900);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(SnowSandBlock.block.getDefaultState(),
								SnowSandBlock.block.getDefaultState(), SnowSandBlock.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("time:snow_desert"));
			}
		}
	}
