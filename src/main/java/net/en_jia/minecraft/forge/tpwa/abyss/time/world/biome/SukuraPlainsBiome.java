...
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.SakuraLogBlock;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.SakuraLeavesBlock;
...
public class SukuraPlainsBiome extends TimeModElements.ModElement {
	public static Biome biome;

	public SukuraPlainsBiome(TimeModElements instance) {
		super(instance, 2162);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(SakuraLogBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(SakuraLeavesBlock.block.getDefaultState()),
				...
				event.getRegistry().register(biome.setRegistryName("time:sukura_plains"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("sukura_plains_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("sukura_plains_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("sukura_plains_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
