...
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.Minecraftyears100leavesBlock;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.Minecraftyears100grassBlock;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.Minecraftyears100dirtBlock;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.MinecraftYears100LogBlock;
...
public class WindForest2Biome extends TimeModElements.ModElement {
	public static Biome biome;

	public WindForest2Biome(TimeModElements instance) {
		super(instance, 2152);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-5916161).setWaterColor(-14329397).setWaterFogColor(-14329397)
						.withSkyColor(-5916161).withFoliageColor(-10512869).withGrassColor(-10512869)
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration(
								(new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(MinecraftYears100LogBlock.block.getDefaultState()),
										new SimpleBlockStateProvider(Minecraftyears100leavesBlock.block.getDefaultState()),
										new JungleFoliagePlacer(FeatureSpread.func_242252_a(2), FeatureSpread.func_242252_a(0), 2),
										new MegaJungleTrunkPlacer(21, 2, 19), new TwoLayerFeature(1, 1, 2)))
				...
				event.getRegistry().register(biome.setRegistryName("time:wind_forest_2"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("wind_forest_2_lvtd");
		...
		protected void func_227424_a_(IWorldWriter ww, BlockPos bp, BooleanProperty bpr, Set<BlockPos> sbc, MutableBoundingBox mbb) {
			this.func_227423_a_(ww, bp, Minecraftyears100leavesBlock.block.getDefaultState(), sbc, mbb);
		}
	}
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("wind_forest_2_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("wind_forest_2_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
