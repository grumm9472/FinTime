...
import net.en_jia.minecraft.forge.tpwa.abyss.time.item.MCY0Item;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.TimeMachineWallBlock;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.FireRockBlock;
...
public class MCY0Dimension extends TimeModElements.ModElement {
	@ObjectHolder("time:mcy_0_portal")
	public static final CustomPortalBlock portal = null;

	public MCY0Dimension(TimeModElements instance) {
		super(instance, 1756);
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(FireRockBlock.block);
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("time:mcy_0_forest")).getGenerationSettings().getSurfaceBuilder()
	...
	public void clientLoad(FMLClientSetupEvent event) {
		DimensionRenderInfo customEffect = new DimensionRenderInfo(128, true, DimensionRenderInfo.FogType.NORMAL, false, false) {
			...
			public Vector3d func_230494_a_(Vector3d color, float sunHeight) {
				return new Vector3d(0.552941176471, 0, 0.2);
			}
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("time:mcy_0"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("mcy_0_portal", Vector3i::compareTo, 300);
	...
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("mcy_0_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0, 1)
					.setRegistryName("mcy_0_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new MCY0Item().setRegistryName("mcy_0"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		...
		public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				...
				} else if (entity.world.getDimensionKey() != RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("time:mcy_0"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos, RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("time:mcy_0")));
				} else {
					entity.func_242279_ag();
