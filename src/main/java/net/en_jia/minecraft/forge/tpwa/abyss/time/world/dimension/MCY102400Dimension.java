...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.MCY102400PlayerEntersDimensionProcedure;
import net.en_jia.minecraft.forge.tpwa.abyss.time.item.MCY102400Item;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.TimeMachineWallBlock;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.MCY102400StoneBlock;
...
public class MCY102400Dimension extends TimeModElements.ModElement {
	@ObjectHolder("time:mcy_102400_portal")
	public static final CustomPortalBlock portal = null;

	public MCY102400Dimension(TimeModElements instance) {
		super(instance, 8);
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(MCY102400StoneBlock.block);
		...
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("time:cactus_forest")).getGenerationSettings().getSurfaceBuilder()
				.get().getConfig().getTop().getBlock());
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("time:cactus_forest")).getGenerationSettings().getSurfaceBuilder()
				.get().getConfig().getUnder().getBlock());
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("time:mcy_102400"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("mcy_102400_portal", Vector3i::compareTo, 300);
	...
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("mcy_102400_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0,
					1).setRegistryName("mcy_102400_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new MCY102400Item().setRegistryName("mcy_102400"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("mcy_102400_portal");
		}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("time:mcy_102400"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos, RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("time:mcy_102400")));
				} else {
					entity.func_242279_ag();
	...
	public void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getTo() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("time:mcy_102400"))) {

			MCY102400PlayerEntersDimensionProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
