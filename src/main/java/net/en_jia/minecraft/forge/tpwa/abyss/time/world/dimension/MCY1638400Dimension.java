...
import net.en_jia.minecraft.forge.tpwa.abyss.time.item.MCY1638400Item;
...
public class MCY1638400Dimension extends TimeModElements.ModElement {
	@ObjectHolder("time:mcy_1638400_portal")
	public static final CustomPortalBlock portal = null;

	public MCY1638400Dimension(TimeModElements instance) {
		super(instance, 10);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("time:mcy_1638400"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("mcy_1638400_portal", Vector3i::compareTo, 300);
	...
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("mcy_1638400_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0,
					1).setRegistryName("mcy_1638400_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new MCY1638400Item().setRegistryName("mcy_1638400"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("mcy_1638400_portal");
		}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("time:mcy_1638400"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos, RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("time:mcy_1638400")));
				} else {
					entity.func_242279_ag();
