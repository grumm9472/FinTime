...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.MCY409600PlayerEntersDimensionProcedure;
import net.en_jia.minecraft.forge.tpwa.abyss.time.particle.Leavesfall100Particle;
import net.en_jia.minecraft.forge.tpwa.abyss.time.item.MCY409600Item;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.TimeMachineWallBlock;
import net.en_jia.minecraft.forge.tpwa.abyss.time.block.IceWaterBlock;
...
public class MCY409600Dimension extends TimeModElements.ModElement {
	@ObjectHolder("time:mcy_409600_portal")
	public static final CustomPortalBlock portal = null;

	public MCY409600Dimension(TimeModElements instance) {
		super(instance, 9);
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(IceWaterBlock.block);
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("time:ghost_boime")).getGenerationSettings().getSurfaceBuilder()
	...
	public void clientLoad(FMLClientSetupEvent event) {
		DimensionRenderInfo customEffect = new DimensionRenderInfo(128, true, DimensionRenderInfo.FogType.NORMAL, false, false) {
			...
			public Vector3d func_230494_a_(Vector3d color, float sunHeight) {
				return new Vector3d(0.450980392157, 0.639215686275, 0.925490196078);
			}
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("time:mcy_409600"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("mcy_409600_portal", Vector3i::compareTo, 300);
	...
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("mcy_409600_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0,
					1).setRegistryName("mcy_409600_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new MCY409600Item().setRegistryName("mcy_409600"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("mcy_409600_portal");
		}
		...
		public void animateTick(BlockState state, World world, BlockPos pos, Random random) {
			for (int i = 0; i < 4; i++) {
				...
				world.addParticle(Leavesfall100Particle.particle, px, py, pz, vx, vy, vz);
			}
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("time:mcy_409600"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos, RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("time:mcy_409600")));
				} else {
					entity.func_242279_ag();
	...
	public void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getTo() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("time:mcy_409600"))) {

			MCY409600PlayerEntersDimensionProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
