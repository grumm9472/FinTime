...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.Mcy25600PlayerEntersDimensionProcedure;
import net.en_jia.minecraft.forge.tpwa.abyss.time.item.Mcy25600Item;
...
public class Mcy25600Dimension extends TimeModElements.ModElement {
	@ObjectHolder("time:mcy_25600_portal")
	public static final CustomPortalBlock portal = null;

	public Mcy25600Dimension(TimeModElements instance) {
		super(instance, 7);
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("time:mcy_25600_p")).getGenerationSettings().getSurfaceBuilder()
		...
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("time:fores_tm_agic")).getGenerationSettings().getSurfaceBuilder()
				.get().getConfig().getTop().getBlock());
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("time:fores_tm_agic")).getGenerationSettings().getSurfaceBuilder()
				.get().getConfig().getUnder().getBlock());
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("time:mcy_25600_t_1")).getGenerationSettings().getSurfaceBuilder()
				.get().getConfig().getTop().getBlock());
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("time:mcy_25600_t_1")).getGenerationSettings().getSurfaceBuilder()
				.get().getConfig().getUnder().getBlock());
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("time:mcy_25600"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("mcy_25600_portal", Vector3i::compareTo, 300);
	...
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("mcy_25600_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0, 1)
					.setRegistryName("mcy_25600_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new Mcy25600Item().setRegistryName("mcy_25600"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		...
		public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				...
				} else if (entity.world.getDimensionKey() != RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("time:mcy_25600"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos, RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("time:mcy_25600")));
				} else {
					entity.func_242279_ag();
	...
	public void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getTo() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("time:mcy_25600"))) {

			Mcy25600PlayerEntersDimensionProcedure.executeProcedure(Stream
