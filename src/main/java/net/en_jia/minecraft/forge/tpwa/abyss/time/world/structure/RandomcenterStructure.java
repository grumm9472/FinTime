...
import net.en_jia.minecraft.forge.tpwa.abyss.time.procedures.RandomcenterOnStructureInstanceGeneratedProcedure;
...
public class RandomcenterStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 5000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("time", "spawn_center"));
							if (template == null)
								return false;
							...
							RandomcenterOnStructureInstanceGeneratedProcedure.executeProcedure(Stream
			...
			event.getRegistry().register(feature.setRegistryName("randomcenter"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("time:randomcenter"), configuredFeature);
		}
	}
